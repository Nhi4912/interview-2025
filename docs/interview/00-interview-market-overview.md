...
|---|---|---|---|
| Scope, hoisting, TDZ, lexical environment | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Closures and practical memory leak prevention | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| `this` binding across call/apply/bind/arrow functions | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Prototype chain and object model internals | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Event loop ordering and starvation scenarios | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Async patterns: Promise.all/allSettled/race/any trade-offs | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Error handling and retry strategies in UI workflows | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Module systems (ESM/CJS), tree-shaking implications | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Immutability, structural sharing, and performance | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Debounce/throttle/cancellation with AbortController | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Deep cloning pitfalls and serialization constraints | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
| Time-space complexity for common data transformations | Can explain concept and solve practical bug | Can reason about trade-offs and edge cases under load | `docs/interview/fe-track/01-javascript/`, `docs/interview/shared/01-cs-fundamentals/` |
...
| Topic | Baseline | Senior Expectation | Related Docs |
|---|---|---|---|
| Value vs pointer semantics and escape analysis basics | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Interface design and implicit implementation pitfalls | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Channel patterns (fan-in/fan-out, worker pools, cancellation) | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Context propagation and timeout discipline | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Error handling patterns and wrapped errors | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Goroutine leak detection and prevention | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Synchronization primitives (mutex/RWMutex/atomic) selection | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Memory profiling and CPU profiling with pprof | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Testing patterns (table-driven, integration, race detector) | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| API and package design for maintainability | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Backpressure and queue management under burst traffic | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
| Observability instrumentation (logs/metrics/traces) | Explain and implement cleanly | Quantify impact and reason under production constraints | `docs/interview/be-track/01-golang/`, `docs/interview/shared/01-cs-fundamentals/` |
...
|---|---|---|
| Algorithms and complexity | Baseline problem-solving and optimization literacy | `docs/interview/shared/01-cs-fundamentals/algorithms-theory.md` |
| Data structures | Correctness and runtime trade-off decisions | `docs/interview/shared/01-cs-fundamentals/complexity-analysis.md` |
| Networking | Real-world distributed system behavior and failure modes | `docs/interview/shared/01-cs-fundamentals/networking-theory.md` |
| Operating systems | Concurrency, scheduling, memory, and process model understanding | `docs/interview/shared/01-cs-fundamentals/os-theory.md` |
| Databases | Query path, indexing, transactions, and consistency trade-offs | `docs/interview/shared/03-database/database-theory.md` |
...
|---|---|---|---|
| Phase A: Fundamentals refresh | Rebuild algorithm + systems baseline | `docs/interview/shared/01-cs-fundamentals/`, `docs/interview/shared/03-database/` | Daily problem log + error patterns |
| Phase B: Design foundations | Build reusable architecture framework | `docs/interview/shared/02-system-design/`, `docs/interview/be-track/04-be-system-design/` | Design template for any prompt |
| Phase C: Role depth | FE or BE specialization | `docs/interview/fe-track/`, `docs/interview/be-track/` | Company-specific weak-point tracker |
| Phase D: AI/process adaptation | Match tool policy and workflow expectations | `docs/interview/shared/06-ai-and-agents/` | AI-policy checklist per target company |
| Phase E: Company simulation | Build loop-level readiness | `docs/interview/shared/07-company-guides/`, `docs/interview/fe-track/10-company-guide.md`, `docs/interview/be-track/05-company-guide.md` | Mock loop scorecards |
...
|---|---|---|
| Algorithms and Data Structures | `docs/interview/shared/01-cs-fundamentals/` | Rebuild core reasoning for coding rounds across all companies |
| System Design Theory | `docs/interview/shared/02-system-design/` | Build reusable design framework before company-specific domain drills |
| AI and Agents Knowledge | `docs/interview/shared/06-ai-and-agents/` | Prepare for policy-divergent AI interview environments and modern workflows |
| Company Guides | `docs/interview/shared/07-company-guides/` | Map loop-specific expectations and behavioral rubrics |
| Backend system design problems | `docs/interview/be-track/04-be-system-design/` | Practice Go/backend architecture prompts with realistic constraints |
| Frontend specialization track | `docs/interview/fe-track/` | Deepen React/TypeScript/browser/system design topics |

### 7.2 Additional practical references in this repository

| Practical Guide | Link | Purpose |
|---|---|---|
| FE company guide | `docs/interview/fe-track/10-company-guide.md` | Concrete FE interview expectations by company |
| BE company guide | `docs/interview/be-track/05-company-guide.md` | Concrete BE (Go) interview expectations by company |
| FE roadmap | `docs/interview/fe-track/00-study-roadmap.md` | Sequenced FE learning path |
| BE roadmap | `docs/interview/be-track/00-study-roadmap.md` | Sequenced BE learning path |
| Shared theory index | `docs/interview/shared/THEORY-KNOWLEDGE-INDEX.md` | Central navigation for theoretical foundations |
