...
### Q: What are the core components of the relational model? 🟢
...
### Q: What are the fundamental relational algebra operations? 🟡
...
### Q: Explain Entity-Relationship (ER) diagram concepts 🟢
...
### Q: Explain 1NF, 2NF, 3NF, BCNF with examples 🟡
...
### Q: Explain all JOIN types with diagrams 🟢
...
### Q: Subqueries vs JOINs — which is faster? 🟡
...
### Q: Explain GROUP BY, HAVING, and aggregation functions 🟢
...
### Q: Explain Window Functions in depth 🟡
...
### Q: What are CTEs and recursive CTEs? 🟡
...
### Q: EXISTS vs IN — performance difference? 🟡
...
### Q: Explain ACID properties in depth 🟢
...
### Q: How does Atomicity work internally? 🟡
...
### Q: How does Durability work? Explain WAL. 🔴
...
### Q: What are the read phenomena in concurrent transactions? 🟡
...
### Q: Explain the four isolation levels 🟡
...
### Q: Explain Shared vs Exclusive locks 🟡
...
### Q: What are Gap Locks and Next-Key Locks? 🔴
...
### Q: When to use JSONB vs separate tables? 🟡
...
### Q: Explain LISTEN/NOTIFY and pg_stat_statements 🟡
...
### Q: Auto_increment with replication issues? 🟡
...
### Q: Character sets and collation? 🟢
...
### Q: Why is connection pooling critical? 🟡
...
### Q: How does Go's database/sql pool work? 🟡
...
### Q: Explain PgBouncer pooling modes 🔴
...
### Q: Connection pool sizing formula? 🔴
...
### Q: Why do schema migrations matter? 🟢
...
### Q: How to do zero-downtime migrations? 🔴
...
### Q: What is the N+1 problem in GORM? 🟡
...
### Q: When to use which? Decision guide 🟡
