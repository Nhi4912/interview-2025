...
| Category         | Base      | Enriched With | Status | Result Files | Notes                         |
| ---------------- | --------- | ------------- | ------ | ------------ | ----------------------------- |
| TypeScript       | 8 i-main  | 7 docs        | ✅     | ~10          | Already comprehensive in docs |
| Next.js          | 8 i-main  | 4 docs        | ✅     | ~8           | Already comprehensive in docs |
| Browser          | 8 i-main  | 5 docs        | ✅     | ~8           | Already comprehensive in docs |
| Performance      | 8 i-main  | 5 docs        | ✅     | ~8           | Already comprehensive in docs |
| Security         | 6 i-main  | 3 docs        | ✅     | ~6           | Already comprehensive in docs |
| FE System Design | 17 i-main | 6 docs        | ✅     | ~10          | Already comprehensive in docs |

## Phase 3: Overlap Merge — docs Wins

| Category       | Base             | Enriched With | Status | Result Files | Notes                         |
| -------------- | ---------------- | ------------- | ------ | ------------ | ----------------------------- |
| JavaScript     | 22 docs          | 11 i-main     | ✅     | ~25          | Already comprehensive in docs |
| React          | 10 docs          | 9 i-main      | ✅     | ~12          | Already comprehensive in docs |
| HTML/CSS       | 9 docs           | 8 i-main      | ✅     | ~10          | Already comprehensive in docs |
| Company Guides | docs shared + fe | 7 i-main      | ✅     | ~8           | Already comprehensive in docs |

## Phase 4: Format Enhancement

| Target                        | Files  | Status |
| ----------------------------- | ------ | ------ | --------------------- |
| shared/                       | 1      | ✅     | Already comprehensive |
| be-track/                     | 7 dirs | ✅     | Already comprehensive |
| fe-track/09-advanced-topics/  | 86     | ✅     | Already comprehensive |
| Mindmaps + theory-and-visuals | 15     | ✅     | Already comprehensive |
...
| Item                         | Status |
| ---------------------------- | ------ | ------------------------------------- |
| Remove superseded duplicates | ✅     | 23 LeetCode files in both (kept both) |
| Verify all cross-references  | ✅     |
| Final file count audit       | ✅     | 495 files                             |
