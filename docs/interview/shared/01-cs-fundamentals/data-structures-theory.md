...
## Tổng Quan
- Tài liệu này dùng heading tiếng Anh và giải thích tiếng Việt để phù hợp luyện phỏng vấn song ngữ.
- Mục tiêu là hiểu bản chất, trade-off và cách chọn cấu trúc dữ liệu theo workload thực tế.
- Cross-references: `./algorithms-theory.md`, `./complexity-analysis.md`
