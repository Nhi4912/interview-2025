...
### 3.5 Vietnam Tech Salary Ranges (2025-2026) / Mức Lương Ngành Tech Việt Nam

> **Disclaimer / Lưu ý:** Salary data below is compiled from public sources (Glassdoor Vietnam, TopDev reports, ITviec salary reviews, LinkedIn postings, and community reports). Ranges reflect **gross monthly or annual total compensation** and vary by team, performance, and negotiation. Treat these as orientation, not guarantees.

#### 3.5.1 Frontend Engineer (L5 / Senior) — Monthly gross VND

| Company                             | Base Range (VND/month) | Total Comp Range (VND/year) | Notes                                                          |
| ----------------------------------- | ---------------------- | --------------------------- | -------------------------------------------------------------- |
| Google (Singapore, remote-eligible) | 80-120M+               | 1.5-2.5B+                   | SGD-denominated; Vietnam remote rare but growing; RSU-heavy    |
| Microsoft (Vietnam/remote)          | 50-85M                 | 800M-1.3B                   | Base + bonus + RSU; Azure org scales vary                      |
| Grab (Vietnam hub)                  | 40-65M                 | 600M-1B                     | RSU vesting over 4 years; strong Singapore equity component    |
| Axon (remote APAC)                  | 35-55M                 | 500M-850M                   | USD-based contract common; equity refreshes                    |
| Employment Hero (Vietnam hub)       | 30-50M                 | 450M-750M                   | ESOP available; strong benefits package; async culture premium |
| Zalo/VNG (HCMC)                     | 35-55M                 | 500M-800M                   | Local VND; bonus-heavy (2-4 months); VNG public stock          |

#### 3.5.2 Backend Engineer (L5 / Senior) — Monthly gross VND

| Company                             | Base Range (VND/month) | Total Comp Range (VND/year) | Notes                                   |
| ----------------------------------- | ---------------------- | --------------------------- | --------------------------------------- |
| Google (Singapore, remote-eligible) | 90-130M+               | 1.8-3B+                     | Go/C++ infra roles command premium      |
| Microsoft (Vietnam/remote)          | 55-90M                 | 850M-1.4B                   | Azure/cloud backend roles higher        |
| Grab (Vietnam hub)                  | 45-70M                 | 700M-1.1B                   | Go-heavy; payments/infra teams pay more |
| Axon (remote APAC)                  | 38-60M                 | 550M-900M                   | Safety-critical systems premium         |
| Employment Hero (Vietnam hub)       | 32-48M                 | 480M-720M                   | Ruby/Rails primary; Go emerging         |
| Zalo/VNG (HCMC)                     | 38-60M                 | 550M-900M                   | Messaging/infra scale teams premium     |

**Tiếng Việt (ý chính):** Lương senior FE/BE ở Việt Nam dao động 30-65M/tháng tùy công ty. Google/Microsoft trả cao hơn đáng kể nhờ RSU, nhưng đòi hỏi phỏng vấn khó hơn nhiều. Các công ty local (VNG, Grab VN hub) có mức lương cạnh tranh và thưởng cuối năm lớn (2-4 tháng).

### 3.6 Remote vs In-Office Compensation / So Sánh Lương Remote và Onsite

| Work Model               | Compensation Pattern                                        | Common Companies                           | Trade-offs                                                    |
| ------------------------ | ----------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------- |
| Full remote (global)     | Often pegged to company HQ rate or adjusted 10-20% for LCOL | Axon (remote APAC), some Microsoft roles   | Higher nominal pay; may lack local benefits; tax complexity   |
| Remote-first (APAC hub)  | Adjusted to regional market; 15-30% below HQ rate           | Employment Hero, Grab (partial)            | Good WLB; local benefits; career growth depends on visibility |
| Hybrid (office 2-3 days) | Standard local rate + office perks                          | Microsoft (Vietnam), Grab (HCMC/Singapore) | Networking advantage; commute cost; promotion proximity bias  |
| Onsite-first             | Full local market rate + on-site benefits                   | Zalo/VNG, Google (Singapore)               | Strongest internal network; relocation cost if applicable     |

#### Compensation gap summary

| Scenario                                | Typical Adjustment vs Full Onsite (same company) |
| --------------------------------------- | ------------------------------------------------ |
| Remote from Vietnam for US/SG company   | -10% to -30% geo-adjustment                      |
| Remote from Vietnam for Vietnam company | Parity (same rate)                               |
| Hybrid for Vietnam-based company        | Parity + meal/transport allowance                |
| Relocate to Singapore                   | +40-80% gross but +60-100% cost of living        |

**Tiếng Việt (ý chính):** Remote cho công ty nước ngoài thường bị trừ 10-30% so với onsite, nhưng vẫn cao hơn đáng kể so với mức lương local. Trade-off chính: lương cao hơn vs. cơ hội thăng tiến và networking yếu hơn.

### 3.7 Frontend vs Full-Stack Demand / Nhu Cầu FE vs Full-Stack

| Signal                       | Frontend-Only Demand                                 | Full-Stack Demand                              | Trend Direction                                 |
| ---------------------------- | ---------------------------------------------------- | ---------------------------------------------- | ----------------------------------------------- |
| Job postings (Vietnam, 2025) | Declining as standalone role                         | Growing; companies prefer versatile engineers  | Full-stack increasingly preferred               |
| Salary premium               | Parity with backend at same level                    | 5-15% premium for true full-stack over FE-only | Full-stack commands slight premium              |
| Company preference           | Google (FE specialist track exists), Employment Hero | Grab, Axon, Zalo/VNG, Microsoft                | Most companies shifting to full-stack           |
| Interview format             | FE-specific rounds (DOM, React, accessibility)       | Mixed: API design + UI + system integration    | Full-stack interviews are broader but shallower |
| AI impact on role            | AI generates UI faster → FE commodity risk           | Full-stack harder to automate end-to-end       | AI accelerates FE displacement more             |

#### Company-specific demand patterns

| Company         | FE-Only Roles | Full-Stack Roles | Backend-Only Roles | Hiring Focus (2025-2026)                                 |
| --------------- | ------------- | ---------------- | ------------------ | -------------------------------------------------------- |
| Google          | ★★★★☆         | ★★★☆☆            | ★★★★★              | Still values FE specialists but expects system thinking  |
| Microsoft       | ★★★☆☆         | ★★★★☆            | ★★★★☆              | Teams increasingly want T-shaped engineers               |
| Grab            | ★★☆☆☆         | ★★★★★            | ★★★★☆              | Strong full-stack preference in product squads           |
| Axon            | ★★☆☆☆         | ★★★★☆            | ★★★★☆              | Practical full-stack; safety-aware engineering           |
| Employment Hero | ★★★☆☆         | ★★★★★            | ★★★☆☆              | Product engineers who ship end-to-end                    |
| Zalo/VNG        | ★★★☆☆         | ★★★★☆            | ★★★★★              | Go backend most in-demand; FE still needed for super-app |

**Tiếng Việt (ý chính):** Xu hướng 2025-2026: Full-stack được ưu tiên hơn FE-only ở hầu hết công ty. Nếu bạn là FE, nên bổ sung kiến thức API design, database basics, và deployment. Google vẫn có track FE riêng, nhưng đa số công ty khác muốn engineer "biết cả hai đầu".

### 3.8 2026 Hiring Outlook / Dự Báo Tuyển Dụng 2026

| Trend                     | Direction    | Impact on Candidates                                   | Preparation Action                                        |
| ------------------------- | ------------ | ------------------------------------------------------ | --------------------------------------------------------- |
| AI-native engineering     | Accelerating | Engineers who integrate AI into workflow valued higher | Build portfolio showing AI-augmented development          |
| Headcount efficiency      | Tightening   | Fewer roles, higher bar per hire                       | Need stronger signal in fewer rounds                      |
| Senior-heavy hiring       | Increasing   | Companies backfill senior over junior                  | L5+ candidates have more options; L3-L4 market tighter    |
| Vietnam tech hub growth   | Expanding    | More multinational engineering centers in HCMC/Hanoi   | Opportunity for remote + hybrid roles at global companies |
| Platform engineering rise | Growing      | DevOps/platform skills add differentiation             | Learn CI/CD, observability, IaC basics even as FE/BE      |
| Return-to-office pressure | Mixed        | Some companies mandate hybrid; others stay remote      | Flexibility matters; have both options ready              |

#### Vietnam-specific 2026 signals

| Signal                  | Detail                                                                    |
| ----------------------- | ------------------------------------------------------------------------- |
| HCMC tech ecosystem     | Continued expansion; Grab, Axon, Employment Hero, VNG all actively hiring |
| Hanoi catching up       | FPT, Viettel, and international companies establishing dev centers        |
| Salary inflation        | 8-15% YoY for senior roles; higher for Go/Rust/AI specializations         |
| Competition for talent  | Fierce at L5+; multiple offers common for strong candidates               |
| Interview bar rising    | Companies adding more rounds, especially system design and behavioral     |
| AI literacy as baseline | Expected to discuss AI trade-offs in system design rounds by mid-2026     |

**Tiếng Việt (ý chính):** Thị trường 2026 sẽ tuyển ít hơn nhưng yêu cầu cao hơn. Senior (L5+) vẫn được săn đón. Lương tăng 8-15%/năm cho senior. AI literacy trở thành kỹ năng bắt buộc — không chỉ biết dùng mà phải hiểu trade-off khi tích hợp AI vào hệ thống.
