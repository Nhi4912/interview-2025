# Modern Platform (2026) / Nền Tảng Hiện Đại

> 2026 cutting-edge frontend platform topics — framework-agnostic, browser-spec-level + AI workflow.
> Chủ đề nền tảng frontend tiên tiến 2026 — không phụ thuộc framework, ở mức browser-spec + workflow AI.
...
These are senior/staff-level topics. Best consumed AFTER completing Phases 1-5 of `../00-study-roadmap.md`.

1. Foundation first: `01-web-components-shadow-dom.md` (the platform layer beneath frameworks) / Nền tảng dưới mọi framework
...
- [../06-browser-performance/](../06-browser-performance) — perf implications of Shadow DOM and CRDT payloads / Hệ quả perf
- [../10-networking/](../10-networking) — WebSocket/WebRTC transport for collab / Transport cho collab
- [../16-career-strategy/](../16-career-strategy) — where these specializations fit in your career arc / Định vị trong sự nghiệp
