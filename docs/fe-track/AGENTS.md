...
├── 04-nextjs/                     # 6 files — Phase 3 (Grab/Axon/EH stack)
├── 05-html-css/                   # 12 files — Phase 4 (often underestimated)
...
├── 15-modern-platform/            # 3 files — Web Components, CRDTs, micro-FE (2026 topics)
...
| 2026 platform (Web Components, CRDTs, MFE)   | `15-modern-platform/`        |
