...
> Navigation index for JavaScript interview preparation materials.
> Mục lục cho tài liệu chuẩn bị phỏng vấn JavaScript.
...
| #   | File                                                           | Topic / Chủ Đề                                                        |
| --- | -------------------------------------------------------------- | --------------------------------------------------------------------- |
| 1   | [01-javascript-basics.md](./01-javascript-basics.md)           | JS fundamentals overview / Tổng quan cơ bản JS                        |
| 2   | [02-variables-types.md](./02-variables-types.md)               | Variables, data types, coercion / Biến, kiểu dữ liệu, ép kiểu         |
| 3   | [03-scope-hoisting.md](./03-scope-hoisting.md)                 | Scope, hoisting, closures / Phạm vi, hoisting, closure                |
| 4   | [04-closures.md](./04-closures.md)                             | Closures in depth / Closure chuyên sâu                                |
| 5   | [05-this-keyword.md](./05-this-keyword.md)                     | `this` binding rules / Quy tắc binding `this`                         |
| 6   | [06-prototypes-inheritance.md](./06-prototypes-inheritance.md) | Prototype chain, inheritance / Chuỗi prototype, kế thừa               |
| 7   | [07-event-loop-async.md](./07-event-loop-async.md)             | Event loop, async model / Vòng lặp sự kiện, mô hình async             |
| 8   | [08-es6-features.md](./08-es6-features.md)                     | ES6+ syntax & features / Cú pháp và tính năng ES6+                    |
| 9   | [09-async-comprehensive.md](./09-async-comprehensive.md)       | Async/await, Promises comprehensive / Async/await & Promise toàn diện |
| 10  | [09-execution-context.md](./09-execution-context.md)           | Execution context, call stack / Ngữ cảnh thực thi, call stack         |
...
1. Start with basics & types: `01` → `02` / Bắt đầu với cơ bản và kiểu dữ liệu
2. Scope, closures, `this`: `03` → `04` → `05` / Phạm vi, closure, `this`
3. Prototypes & async: `06` → `07` → `08` → `09` / Prototype và async
4. Execution context: `09-execution-context.md` / Ngữ cảnh thực thi

### Phase 2 — Deep Dive / Giai Đoạn 2 — Nâng Cao

5. Advanced concepts & patterns: `10` → `11` → `17` / Khái niệm & mẫu nâng cao
6. Functional programming: `11-functional-programming.md` / Lập trình hàm
7. Theory files (`13`–`21`) for whiteboard depth / Các file lý thuyết để phỏng vấn chuyên sâu
...
- [02-typescript/](../02-typescript) - TypeScript builds directly on JS fundamentals / TypeScript xây dựng trên nền JS
- [07-event-loop-async.md](./07-event-loop-async.md) pairs with [06-browser-performance/](../06-browser-performance) - Performance & async / Hiệu suất & async
- [mindmaps/mindmap-javascript.md](../mindmaps/mindmap-javascript.md) - Visual JS concept map / Sơ đồ tư duy JS
