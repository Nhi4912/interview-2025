...
### Q: So sánh Monolith và Microservices architecture? Khi nào chọn kiến trúc nào? 🟢
...
### Q: Giải thích "Monolith First" approach của Martin Fowler? 🟡
...
### Q: Giải thích các khái niệm DDD liên quan đến microservices? 🟡
...
### Q: Làm sao xác định service boundaries từ bounded contexts? 🔴
...
### Q: Anti-patterns trong microservices decomposition? 🟡
...
### Q: So sánh Synchronous vs Asynchronous communication? 🟢
...
### Q: Phân biệt Request-Reply, Event-Driven, và Command patterns? 🟡
...
### Q: So sánh Choreography vs Orchestration? 🔴
...
### Q: Giải thích Service Discovery và các patterns? 🟡
...
### Q: Phân biệt Liveness Probe và Readiness Probe? 🟢
...
### Q: Tại sao ACID transactions không hoạt động trong microservices? 🟡
...
### Q: Two-Phase Commit (2PC) hoạt động thế nào và tại sao không phù hợp? 🟡
...
### Q: Saga Pattern là gì? Giải thích chi tiết Choreography Saga và Orchestration Saga? 🔴
...
### Q: Transactional Outbox Pattern và CDC là gì? 🔴
...
### Q: Phân loại các loại events trong microservices? 🟡
...
### Q: Event Sourcing là gì? Ưu nhược điểm? 🔴
...
### Q: CQRS là gì? Khi nào nên và KHÔNG nên dùng? 🔴
...
### Q: Phân biệt Event-Driven, Event Sourcing, và CQRS? 🔴
...
### Q: Circuit Breaker pattern hoạt động thế nào? 🟡
...
### Q: Giải thích Retry with Exponential Backoff + Jitter? 🟢
...
### Q: Service Mesh là gì? Tại sao cần? 🟡
...
### Q: SLI, SLO, SLA là gì? Error Budget? 🟡
...
### Q: Giải thích 12-Factor App methodology? 🟢
...
### Q: So sánh các deployment strategies? 🟡
...
### Q: Database per Service pattern và các challenges? 🟡
...
### Q: Làm sao query data across services (API Composition)? 🟡
