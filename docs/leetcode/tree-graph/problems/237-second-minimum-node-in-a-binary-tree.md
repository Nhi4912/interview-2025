...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/second-minimum-node-in-a-binary-tree) for full constraints
 ...
 */
function secondMinimumNodeInABinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function secondMinimumNodeInABinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(secondMinimumNodeInABinaryTree(/* example 1 */)); // expected
// console.log(secondMinimumNodeInABinaryTree(/* example 2 */)); // expected
// console.log(secondMinimumNodeInABinaryTree(/* edge case */)); // expected
```
...
- [Second Minimum Node In a Binary Tree — LeetCode](https://leetcode.com/problems/second-minimum-node-in-a-binary-tree) — problem page
