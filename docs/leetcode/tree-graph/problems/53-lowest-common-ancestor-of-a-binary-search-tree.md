...
> **See also**: [Recover Binary Search Tree](https://leetcode.com/problems/recover-binary-search-tree) | [Binary Search Tree to Greater Sum Tree](https://leetcode.com/problems/binary-search-tree-to-greater-sum-tree)
...
**Visual — Lowest Common Ancestor of a Binary Search Tree example:**
...
Difficulty: Medium | Acceptance: 68.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree) for full constraints
 ...
 */
function lowestCommonAncestorOfABinarySearchTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lowestCommonAncestorOfABinarySearchTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lowestCommonAncestorOfABinarySearchTree(/* example 1 */)); // expected
// console.log(lowestCommonAncestorOfABinarySearchTree(/* example 2 */)); // expected
// console.log(lowestCommonAncestorOfABinarySearchTree(/* edge case */)); // expected
```
...
- [Lowest Common Ancestor of a Binary Search Tree — LeetCode](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree) — problem page
