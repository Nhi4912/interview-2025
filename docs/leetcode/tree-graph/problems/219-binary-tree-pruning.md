...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/binary-tree-pruning) for full constraints
 ...
 */
function binaryTreePruningBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function binaryTreePruning(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(binaryTreePruning(/* example 1 */)); // expected
// console.log(binaryTreePruning(/* example 2 */)); // expected
// console.log(binaryTreePruning(/* edge case */)); // expected
```
...
- [Binary Tree Pruning — LeetCode](https://leetcode.com/problems/binary-tree-pruning) — problem page
