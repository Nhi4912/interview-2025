...
Design Graph With Shortest Path Calculator. ([LeetCode](https://leetcode.com/problems/design-graph-with-shortest-path-calculator))

Difficulty: Hard | Acceptance: 64.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-graph-with-shortest-path-calculator) for full constraints
 ...
 */
function designGraphWithShortestPathCalculatorBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designGraphWithShortestPathCalculator(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designGraphWithShortestPathCalculator(/* example 1 */)); // expected
// console.log(designGraphWithShortestPathCalculator(/* example 2 */)); // expected
// console.log(designGraphWithShortestPathCalculator(/* edge case */)); // expected
```
...
- [Design Graph With Shortest Path Calculator — LeetCode](https://leetcode.com/problems/design-graph-with-shortest-path-calculator) — problem page
