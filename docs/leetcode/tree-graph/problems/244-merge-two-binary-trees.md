...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/merge-two-binary-trees) for full constraints
 ...
 */
function mergeTwoBinaryTreesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function mergeTwoBinaryTrees(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(mergeTwoBinaryTrees(/* example 1 */)); // expected
// console.log(mergeTwoBinaryTrees(/* example 2 */)); // expected
// console.log(mergeTwoBinaryTrees(/* edge case */)); // expected
```
...
- [Merge Two Binary Trees — LeetCode](https://leetcode.com/problems/merge-two-binary-trees) — problem page
