...
**Visual — Maximum Candies You Can Get from Boxes example:**
...
Maximum Candies You Can Get from Boxes. ([LeetCode](https://leetcode.com/problems/maximum-candies-you-can-get-from-boxes))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-candies-you-can-get-from-boxes) for full constraints
 ...
 */
function maximumCandiesYouCanGetFromBoxesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumCandiesYouCanGetFromBoxes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumCandiesYouCanGetFromBoxes(/* example 1 */)); // expected
// console.log(maximumCandiesYouCanGetFromBoxes(/* example 2 */)); // expected
// console.log(maximumCandiesYouCanGetFromBoxes(/* edge case */)); // expected
```
...
- [The Time When the Network Becomes Idle](https://leetcode.com/problems/the-time-when-the-network-becomes-idle) — same pattern: BFS
- [Minimize Malware Spread](https://leetcode.com/problems/minimize-malware-spread) — same pattern: Union Find
- [Maximum Candies You Can Get from Boxes — LeetCode](https://leetcode.com/problems/maximum-candies-you-can-get-from-boxes) — problem page
