...
> **See also**: [All Nodes Distance K in Binary Tree](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree) | [Vertical Order Traversal of a Binary Tree](https://leetcode.com/problems/vertical-order-traversal-of-a-binary-tree)
...
**Visual — Amount of Time for Binary Tree to Be Infected example:**
...
Amount of Time for Binary Tree to Be Infected. ([LeetCode](https://leetcode.com/problems/amount-of-time-for-binary-tree-to-be-infected))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/amount-of-time-for-binary-tree-to-be-infected) for full constraints
 ...
 */
function amountOfTimeForBinaryTreeToBeInfectedBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function amountOfTimeForBinaryTreeToBeInfected(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(amountOfTimeForBinaryTreeToBeInfected(/* example 1 */)); // expected
// console.log(amountOfTimeForBinaryTreeToBeInfected(/* example 2 */)); // expected
// console.log(amountOfTimeForBinaryTreeToBeInfected(/* edge case */)); // expected
```
...
- [Amount of Time for Binary Tree to Be Infected — LeetCode](https://leetcode.com/problems/amount-of-time-for-binary-tree-to-be-infected) — problem page
