...
**Visual — Maximum Width of Binary Tree example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-width-of-binary-tree) for full constraints
 ...
 */
function maximumWidthOfBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumWidthOfBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumWidthOfBinaryTree(/* example 1 */)); // expected
// console.log(maximumWidthOfBinaryTree(/* example 2 */)); // expected
// console.log(maximumWidthOfBinaryTree(/* edge case */)); // expected
```
...
- [Maximum Width of Binary Tree — LeetCode](https://leetcode.com/problems/maximum-width-of-binary-tree) — problem page
