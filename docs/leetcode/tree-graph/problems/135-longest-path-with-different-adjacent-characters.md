...
# Longest Path With Different Adjacent Characters / Longest Path With Different Adjacent Characters
...
**Visual — Longest Path With Different Adjacent Characters example:**
...
Longest Path With Different Adjacent Characters. ([LeetCode](https://leetcode.com/problems/longest-path-with-different-adjacent-characters))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-path-with-different-adjacent-characters) for full constraints
 ...
 */
function longestPathWithDifferentAdjacentCharactersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestPathWithDifferentAdjacentCharacters(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestPathWithDifferentAdjacentCharacters(/* example 1 */)); // expected
// console.log(longestPathWithDifferentAdjacentCharacters(/* example 2 */)); // expected
// console.log(longestPathWithDifferentAdjacentCharacters(/* edge case */)); // expected
```
...
- [Longest Path With Different Adjacent Characters — LeetCode](https://leetcode.com/problems/longest-path-with-different-adjacent-characters) — problem page
