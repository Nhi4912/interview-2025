...
**Visual — All Nodes Distance K in Binary Tree example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree) for full constraints
 ...
 */
function allNodesDistanceKInBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function allNodesDistanceKInBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(allNodesDistanceKInBinaryTree(/* example 1 */)); // expected
// console.log(allNodesDistanceKInBinaryTree(/* example 2 */)); // expected
// console.log(allNodesDistanceKInBinaryTree(/* edge case */)); // expected
```
...
- [All Nodes Distance K in Binary Tree — LeetCode](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree) — problem page
