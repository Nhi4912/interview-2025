...
# Find Closest Node to Given Two Nodes / Find Closest Node to Given Two Nodes
...
**Visual — Find Closest Node to Given Two Nodes example:**
...
Find Closest Node to Given Two Nodes. ([LeetCode](https://leetcode.com/problems/find-closest-node-to-given-two-nodes))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-closest-node-to-given-two-nodes) for full constraints
 ...
 */
function findClosestNodeToGivenTwoNodesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findClosestNodeToGivenTwoNodes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findClosestNodeToGivenTwoNodes(/* example 1 */)); // expected
// console.log(findClosestNodeToGivenTwoNodes(/* example 2 */)); // expected
// console.log(findClosestNodeToGivenTwoNodes(/* edge case */)); // expected
```
...
- [Find Closest Node to Given Two Nodes — LeetCode](https://leetcode.com/problems/find-closest-node-to-given-two-nodes) — problem page
