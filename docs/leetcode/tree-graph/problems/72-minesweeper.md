...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minesweeper) for full constraints
 ...
 */
function minesweeperBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minesweeper(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minesweeper(/* example 1 */)); // expected
// console.log(minesweeper(/* example 2 */)); // expected
// console.log(minesweeper(/* edge case */)); // expected
```
...
- [Minesweeper — LeetCode](https://leetcode.com/problems/minesweeper) — problem page
