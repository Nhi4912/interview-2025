...
Count Nodes Equal to Average of Subtree. ([LeetCode](https://leetcode.com/problems/count-nodes-equal-to-average-of-subtree))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-nodes-equal-to-average-of-subtree) for full constraints
 ...
 */
function countNodesEqualToAverageOfSubtreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countNodesEqualToAverageOfSubtree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countNodesEqualToAverageOfSubtree(/* example 1 */)); // expected
// console.log(countNodesEqualToAverageOfSubtree(/* example 2 */)); // expected
// console.log(countNodesEqualToAverageOfSubtree(/* edge case */)); // expected
```
...
- [Count Nodes Equal to Average of Subtree — LeetCode](https://leetcode.com/problems/count-nodes-equal-to-average-of-subtree) — problem page
