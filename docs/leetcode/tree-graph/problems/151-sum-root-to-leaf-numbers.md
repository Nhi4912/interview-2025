...
**Visual — Sum Root to Leaf Numbers example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-root-to-leaf-numbers) for full constraints
 ...
 */
function sumRootToLeafNumbersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumRootToLeafNumbers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumRootToLeafNumbers(/* example 1 */)); // expected
// console.log(sumRootToLeafNumbers(/* example 2 */)); // expected
// console.log(sumRootToLeafNumbers(/* edge case */)); // expected
```
...
- [Sum Root to Leaf Numbers — LeetCode](https://leetcode.com/problems/sum-root-to-leaf-numbers) — problem page
