...
Difficulty: Medium | Acceptance: 77.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/distribute-coins-in-binary-tree) for full constraints
 ...
 */
function distributeCoinsInBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function distributeCoinsInBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(distributeCoinsInBinaryTree(/* example 1 */)); // expected
// console.log(distributeCoinsInBinaryTree(/* example 2 */)); // expected
// console.log(distributeCoinsInBinaryTree(/* edge case */)); // expected
```
...
- [Distribute Coins in Binary Tree — LeetCode](https://leetcode.com/problems/distribute-coins-in-binary-tree) — problem page
