...
**Visual — Diameter of Binary Tree example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/diameter-of-binary-tree) for full constraints
 ...
 */
function diameterOfBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function diameterOfBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(diameterOfBinaryTree(/* example 1 */)); // expected
// console.log(diameterOfBinaryTree(/* example 2 */)); // expected
// console.log(diameterOfBinaryTree(/* edge case */)); // expected
```
...
- [Diameter of Binary Tree — LeetCode](https://leetcode.com/problems/diameter-of-binary-tree) — problem page
