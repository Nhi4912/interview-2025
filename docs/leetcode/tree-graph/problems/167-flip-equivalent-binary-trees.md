...
Flip Equivalent Binary Trees. ([LeetCode](https://leetcode.com/problems/flip-equivalent-binary-trees))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/flip-equivalent-binary-trees) for full constraints
 ...
 */
function flipEquivalentBinaryTreesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function flipEquivalentBinaryTrees(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(flipEquivalentBinaryTrees(/* example 1 */)); // expected
// console.log(flipEquivalentBinaryTrees(/* example 2 */)); // expected
// console.log(flipEquivalentBinaryTrees(/* edge case */)); // expected
```
...
- [Flip Equivalent Binary Trees — LeetCode](https://leetcode.com/problems/flip-equivalent-binary-trees) — problem page
