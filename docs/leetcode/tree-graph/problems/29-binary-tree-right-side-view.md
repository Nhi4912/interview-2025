...
**Visual — Binary Tree Right Side View example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/binary-tree-right-side-view) for full constraints
 ...
 */
function binaryTreeRightSideViewBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function binaryTreeRightSideView(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(binaryTreeRightSideView(/* example 1 */)); // expected
// console.log(binaryTreeRightSideView(/* example 2 */)); // expected
// console.log(binaryTreeRightSideView(/* edge case */)); // expected
```
...
- [Binary Tree Right Side View — LeetCode](https://leetcode.com/problems/binary-tree-right-side-view) — problem page
