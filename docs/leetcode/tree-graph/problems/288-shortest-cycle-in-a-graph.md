...
**Visual — Shortest Cycle in a Graph example:**
...
Shortest Cycle in a Graph. ([LeetCode](https://leetcode.com/problems/shortest-cycle-in-a-graph))

Difficulty: Hard | Acceptance: 37.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-cycle-in-a-graph) for full constraints
 ...
 */
function shortestCycleInAGraphBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestCycleInAGraph(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestCycleInAGraph(/* example 1 */)); // expected
// console.log(shortestCycleInAGraph(/* example 2 */)); // expected
// console.log(shortestCycleInAGraph(/* edge case */)); // expected
```
...
- [Shortest Cycle in a Graph — LeetCode](https://leetcode.com/problems/shortest-cycle-in-a-graph) — problem page
