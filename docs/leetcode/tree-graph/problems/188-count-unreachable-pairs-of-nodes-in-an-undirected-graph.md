...
# Count Unreachable Pairs of Nodes in an Undirected Graph / Count Unreachable Pairs of Nodes in an Undirected Graph
...
**Visual — Count Unreachable Pairs of Nodes in an Undirected Graph example:**
...
Count Unreachable Pairs of Nodes in an Undirected Graph. ([LeetCode](https://leetcode.com/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph) for full constraints
 ...
 */
function countUnreachablePairsOfNodesInAnUndirectedGraphBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countUnreachablePairsOfNodesInAnUndirectedGraph(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countUnreachablePairsOfNodesInAnUndirectedGraph(/* example 1 */)); // expected
// console.log(countUnreachablePairsOfNodesInAnUndirectedGraph(/* example 2 */)); // expected
// console.log(countUnreachablePairsOfNodesInAnUndirectedGraph(/* edge case */)); // expected
```
...
- [Count Unreachable Pairs of Nodes in an Undirected Graph — LeetCode](https://leetcode.com/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph) — problem page
