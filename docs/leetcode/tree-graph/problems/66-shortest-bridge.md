...
**Visual — Shortest Bridge example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-bridge) for full constraints
 ...
 */
function shortestBridgeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestBridge(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestBridge(/* example 1 */)); // expected
// console.log(shortestBridge(/* example 2 */)); // expected
// console.log(shortestBridge(/* edge case */)); // expected
```
...
- [Shortest Bridge — LeetCode](https://leetcode.com/problems/shortest-bridge) — problem page
