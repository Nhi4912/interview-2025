...
**Visual — Closest Leaf in a Binary Tree example:**
...
Closest Leaf in a Binary Tree. ([LeetCode](https://leetcode.com/problems/closest-leaf-in-a-binary-tree))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/closest-leaf-in-a-binary-tree) for full constraints
 ...
 */
function closestLeafInABinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function closestLeafInABinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(closestLeafInABinaryTree(/* example 1 */)); // expected
// console.log(closestLeafInABinaryTree(/* example 2 */)); // expected
// console.log(closestLeafInABinaryTree(/* edge case */)); // expected
```
...
- [Closest Leaf in a Binary Tree — LeetCode](https://leetcode.com/problems/closest-leaf-in-a-binary-tree) — problem page
