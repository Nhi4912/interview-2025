...
**Visual — Possible Bipartition example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/possible-bipartition) for full constraints
 ...
 */
function possibleBipartitionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function possibleBipartition(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(possibleBipartition(/* example 1 */)); // expected
// console.log(possibleBipartition(/* example 2 */)); // expected
// console.log(possibleBipartition(/* edge case */)); // expected
```
...
- [Possible Bipartition — LeetCode](https://leetcode.com/problems/possible-bipartition) — problem page
