...
> **See also**: [Flatten Binary Tree to Linked List](https://leetcode.com/problems/flatten-binary-tree-to-linked-list) | [Populating Next Right Pointers in Each Node II](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii)
...
**Visual — Linked List in Binary Tree example:**
...
Linked List in Binary Tree. ([LeetCode](https://leetcode.com/problems/linked-list-in-binary-tree))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/linked-list-in-binary-tree) for full constraints
 ...
 */
function linkedListInBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function linkedListInBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(linkedListInBinaryTree(/* example 1 */)); // expected
// console.log(linkedListInBinaryTree(/* example 2 */)); // expected
// console.log(linkedListInBinaryTree(/* edge case */)); // expected
```
...
- [Linked List in Binary Tree — LeetCode](https://leetcode.com/problems/linked-list-in-binary-tree) — problem page
