...
The Maze. ([LeetCode](https://leetcode.com/problems/the-maze))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/the-maze) for full constraints
 ...
 */
function theMazeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function theMaze(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(theMaze(/* example 1 */)); // expected
// console.log(theMaze(/* example 2 */)); // expected
// console.log(theMaze(/* edge case */)); // expected
```
...
- [The Maze — LeetCode](https://leetcode.com/problems/the-maze) — problem page
