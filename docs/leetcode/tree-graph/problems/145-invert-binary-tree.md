...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/invert-binary-tree) for full constraints
 ...
 */
function invertBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function invertBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(invertBinaryTree(/* example 1 */)); // expected
// console.log(invertBinaryTree(/* example 2 */)); // expected
// console.log(invertBinaryTree(/* edge case */)); // expected
```
...
- [Invert Binary Tree — LeetCode](https://leetcode.com/problems/invert-binary-tree) — problem page
