...
**Visual — Trapping Rain Water II example:**
...
Trapping Rain Water II. ([LeetCode](https://leetcode.com/problems/trapping-rain-water-ii))

Difficulty: Hard | Acceptance: 58.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/trapping-rain-water-ii) for full constraints
 ...
 */
function trappingRainWaterIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function trappingRainWaterIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(trappingRainWaterIi(/* example 1 */)); // expected
// console.log(trappingRainWaterIi(/* example 2 */)); // expected
// console.log(trappingRainWaterIi(/* edge case */)); // expected
```
...
- [Trapping Rain Water II — LeetCode](https://leetcode.com/problems/trapping-rain-water-ii) — problem page
