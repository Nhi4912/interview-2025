...
# Number of Nodes With Value One / Number of Nodes With Value One
...
**Visual — Number of Nodes With Value One example:**
...
Number of Nodes With Value One. ([LeetCode](https://leetcode.com/problems/number-of-nodes-with-value-one))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-nodes-with-value-one) for full constraints
 ...
 */
function numberOfNodesWithValueOneBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfNodesWithValueOne(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfNodesWithValueOne(/* example 1 */)); // expected
// console.log(numberOfNodesWithValueOne(/* example 2 */)); // expected
// console.log(numberOfNodesWithValueOne(/* edge case */)); // expected
```
...
- [Number of Nodes With Value One — LeetCode](https://leetcode.com/problems/number-of-nodes-with-value-one) — problem page
