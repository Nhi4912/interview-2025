...
> **See also**: [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths) | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/path-sum-ii) for full constraints
 ...
 */
function pathSumIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pathSumIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pathSumIi(/* example 1 */)); // expected
// console.log(pathSumIi(/* example 2 */)); // expected
// console.log(pathSumIi(/* edge case */)); // expected
```
...
- [Path Sum II — LeetCode](https://leetcode.com/problems/path-sum-ii) — problem page
