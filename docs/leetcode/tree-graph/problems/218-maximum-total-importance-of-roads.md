...
> **See also**: [Maximum Star Sum of a Graph](https://leetcode.com/problems/maximum-star-sum-of-a-graph) | [Task Scheduler](https://leetcode.com/problems/task-scheduler)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-total-importance-of-roads) for full constraints
 ...
 */
function maximumTotalImportanceOfRoadsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumTotalImportanceOfRoads(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumTotalImportanceOfRoads(/* example 1 */)); // expected
// console.log(maximumTotalImportanceOfRoads(/* example 2 */)); // expected
// console.log(maximumTotalImportanceOfRoads(/* edge case */)); // expected
```
...
- [Maximum Star Sum of a Graph](https://leetcode.com/problems/maximum-star-sum-of-a-graph) — same pattern: Heap / Priority Queue
...
- [Maximum Total Importance of Roads — LeetCode](https://leetcode.com/problems/maximum-total-importance-of-roads) — problem page
