...
**Visual — Smallest Subtree with all the Deepest Nodes example:**
...
Difficulty: Medium | Acceptance: 72.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes) for full constraints
 ...
 */
function smallestSubtreeWithAllTheDeepestNodesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function smallestSubtreeWithAllTheDeepestNodes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(smallestSubtreeWithAllTheDeepestNodes(/* example 1 */)); // expected
// console.log(smallestSubtreeWithAllTheDeepestNodes(/* example 2 */)); // expected
// console.log(smallestSubtreeWithAllTheDeepestNodes(/* edge case */)); // expected
```
...
- [Smallest Subtree with all the Deepest Nodes — LeetCode](https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes) — problem page
