...
**Visual — Swim in Rising Water example:**
...
Difficulty: Hard | Acceptance: 62.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/swim-in-rising-water) for full constraints
 ...
 */
function swimInRisingWaterBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function swimInRisingWater(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(swimInRisingWater(/* example 1 */)); // expected
// console.log(swimInRisingWater(/* example 2 */)); // expected
// console.log(swimInRisingWater(/* edge case */)); // expected
```
...
- [Swim in Rising Water — LeetCode](https://leetcode.com/problems/swim-in-rising-water) — problem page
