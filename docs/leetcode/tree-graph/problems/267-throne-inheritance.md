...
> **See also**: [Operations on Tree](https://leetcode.com/problems/operations-on-tree) | [Flatten Nested List Iterator](https://leetcode.com/problems/flatten-nested-list-iterator)
...
**Visual — Throne Inheritance example:**
...
Throne Inheritance. ([LeetCode](https://leetcode.com/problems/throne-inheritance))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/throne-inheritance) for full constraints
 ...
 */
function throneInheritanceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function throneInheritance(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(throneInheritance(/* example 1 */)); // expected
// console.log(throneInheritance(/* example 2 */)); // expected
// console.log(throneInheritance(/* edge case */)); // expected
```
...
- [Throne Inheritance — LeetCode](https://leetcode.com/problems/throne-inheritance) — problem page
