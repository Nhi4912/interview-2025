...
Add Edges to Make Degrees of All Nodes Even. ([LeetCode](https://leetcode.com/problems/add-edges-to-make-degrees-of-all-nodes-even))

Difficulty: Hard | Acceptance: 33.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/add-edges-to-make-degrees-of-all-nodes-even) for full constraints
 ...
 */
function addEdgesToMakeDegreesOfAllNodesEvenBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function addEdgesToMakeDegreesOfAllNodesEven(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(addEdgesToMakeDegreesOfAllNodesEven(/* example 1 */)); // expected
// console.log(addEdgesToMakeDegreesOfAllNodesEven(/* example 2 */)); // expected
// console.log(addEdgesToMakeDegreesOfAllNodesEven(/* edge case */)); // expected
```
...
- [Add Edges to Make Degrees of All Nodes Even — LeetCode](https://leetcode.com/problems/add-edges-to-make-degrees-of-all-nodes-even) — problem page
