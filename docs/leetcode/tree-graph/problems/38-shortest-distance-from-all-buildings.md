...
**Visual — Shortest Distance from All Buildings example:**
...
Shortest Distance from All Buildings. ([LeetCode](https://leetcode.com/problems/shortest-distance-from-all-buildings))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-distance-from-all-buildings) for full constraints
 ...
 */
function shortestDistanceFromAllBuildingsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestDistanceFromAllBuildings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestDistanceFromAllBuildings(/* example 1 */)); // expected
// console.log(shortestDistanceFromAllBuildings(/* example 2 */)); // expected
// console.log(shortestDistanceFromAllBuildings(/* edge case */)); // expected
```
...
- [Shortest Distance from All Buildings — LeetCode](https://leetcode.com/problems/shortest-distance-from-all-buildings) — problem page
