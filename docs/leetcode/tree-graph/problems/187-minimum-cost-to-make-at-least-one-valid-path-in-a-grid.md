...
> **See also**: [Minimum Time to Visit a Cell In a Grid](https://leetcode.com/problems/minimum-time-to-visit-a-cell-in-a-grid) | [Evaluate Division](https://leetcode.com/problems/evaluate-division)
...
**Visual — Minimum Cost to Make at Least One Valid Path in a Grid example:**
...
Difficulty: Hard | Acceptance: 70.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid) for full constraints
 ...
 */
function minimumCostToMakeAtLeastOneValidPathInAGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumCostToMakeAtLeastOneValidPathInAGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumCostToMakeAtLeastOneValidPathInAGrid(/* example 1 */)); // expected
// console.log(minimumCostToMakeAtLeastOneValidPathInAGrid(/* example 2 */)); // expected
// console.log(minimumCostToMakeAtLeastOneValidPathInAGrid(/* edge case */)); // expected
```
...
- [Minimum Cost to Make at Least One Valid Path in a Grid — LeetCode](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid) — problem page
