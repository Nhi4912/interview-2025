...
**Visual — Number of Good Leaf Nodes Pairs example:**
...
Number of Good Leaf Nodes Pairs. ([LeetCode](https://leetcode.com/problems/number-of-good-leaf-nodes-pairs))

Difficulty: Medium | Acceptance: 71.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-good-leaf-nodes-pairs) for full constraints
 ...
 */
function numberOfGoodLeafNodesPairsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfGoodLeafNodesPairs(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfGoodLeafNodesPairs(/* example 1 */)); // expected
// console.log(numberOfGoodLeafNodesPairs(/* example 2 */)); // expected
// console.log(numberOfGoodLeafNodesPairs(/* edge case */)); // expected
```
...
- [Number of Good Leaf Nodes Pairs — LeetCode](https://leetcode.com/problems/number-of-good-leaf-nodes-pairs) — problem page
