...
> **See also**: [Minimum Cost to Make at Least One Valid Path in a Grid](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid) | [Evaluate Division](https://leetcode.com/problems/evaluate-division)
...
Minimum Time to Visit a Cell In a Grid. ([LeetCode](https://leetcode.com/problems/minimum-time-to-visit-a-cell-in-a-grid))

Difficulty: Hard | Acceptance: 56.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-to-visit-a-cell-in-a-grid) for full constraints
 ...
 */
function minimumTimeToVisitACellInAGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeToVisitACellInAGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeToVisitACellInAGrid(/* example 1 */)); // expected
// console.log(minimumTimeToVisitACellInAGrid(/* example 2 */)); // expected
// console.log(minimumTimeToVisitACellInAGrid(/* edge case */)); // expected
```
...
- [Minimum Time to Visit a Cell In a Grid — LeetCode](https://leetcode.com/problems/minimum-time-to-visit-a-cell-in-a-grid) — problem page
