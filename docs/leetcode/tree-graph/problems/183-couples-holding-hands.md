...
Difficulty: Hard | Acceptance: 58.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/couples-holding-hands) for full constraints
 ...
 */
function couplesHoldingHandsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function couplesHoldingHands(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(couplesHoldingHands(/* example 1 */)); // expected
// console.log(couplesHoldingHands(/* example 2 */)); // expected
// console.log(couplesHoldingHands(/* edge case */)); // expected
```
...
- [Couples Holding Hands — LeetCode](https://leetcode.com/problems/couples-holding-hands) — problem page
