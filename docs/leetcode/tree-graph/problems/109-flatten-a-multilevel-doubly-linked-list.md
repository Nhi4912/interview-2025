...
> **See also**: [Convert Binary Search Tree to Sorted Doubly Linked List](https://leetcode.com/problems/convert-binary-search-tree-to-sorted-doubly-linked-list) | [LFU Cache](https://leetcode.com/problems/lfu-cache)
...
**Visual — Flatten a Multilevel Doubly Linked List example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list) for full constraints
 ...
 */
function flattenAMultilevelDoublyLinkedListBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function flattenAMultilevelDoublyLinkedList(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(flattenAMultilevelDoublyLinkedList(/* example 1 */)); // expected
// console.log(flattenAMultilevelDoublyLinkedList(/* example 2 */)); // expected
// console.log(flattenAMultilevelDoublyLinkedList(/* edge case */)); // expected
```
...
- [Flatten a Multilevel Doubly Linked List — LeetCode](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list) — problem page
