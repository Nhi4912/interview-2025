...
**Visual — Operations on Tree example:**
...
Operations on Tree. ([LeetCode](https://leetcode.com/problems/operations-on-tree))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/operations-on-tree) for full constraints
 ...
 */
function operationsOnTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function operationsOnTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(operationsOnTree(/* example 1 */)); // expected
// console.log(operationsOnTree(/* example 2 */)); // expected
// console.log(operationsOnTree(/* edge case */)); // expected
```
...
- [Operations on Tree — LeetCode](https://leetcode.com/problems/operations-on-tree) — problem page
