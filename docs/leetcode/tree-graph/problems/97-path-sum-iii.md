...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/path-sum-iii) for full constraints
 ...
 */
function pathSumIiiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pathSumIii(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pathSumIii(/* example 1 */)); // expected
// console.log(pathSumIii(/* example 2 */)); // expected
// console.log(pathSumIii(/* edge case */)); // expected
```
...
- [Path Sum III — LeetCode](https://leetcode.com/problems/path-sum-iii) — problem page
