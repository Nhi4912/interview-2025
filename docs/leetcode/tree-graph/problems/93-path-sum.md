...
Difficulty: Easy | Acceptance: 53.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/path-sum) for full constraints
 ...
 */
function pathSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pathSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pathSum(/* example 1 */)); // expected
// console.log(pathSum(/* example 2 */)); // expected
// console.log(pathSum(/* edge case */)); // expected
```
...
- [Path Sum — LeetCode](https://leetcode.com/problems/path-sum) — problem page
