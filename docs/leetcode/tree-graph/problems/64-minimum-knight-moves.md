...
**Visual — Minimum Knight Moves example:**
...
Minimum Knight Moves. ([LeetCode](https://leetcode.com/problems/minimum-knight-moves))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-knight-moves) for full constraints
 ...
 */
function minimumKnightMovesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumKnightMoves(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumKnightMoves(/* example 1 */)); // expected
// console.log(minimumKnightMoves(/* example 2 */)); // expected
// console.log(minimumKnightMoves(/* edge case */)); // expected
```
...
- [Minimum Knight Moves — LeetCode](https://leetcode.com/problems/minimum-knight-moves) — problem page
