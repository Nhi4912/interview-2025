...
**Visual — Number of Nodes in the Sub-Tree With the Same Label example:**
...
Number of Nodes in the Sub-Tree With the Same Label. ([LeetCode](https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label) for full constraints
 ...
 */
function numberOfNodesInTheSubTreeWithTheSameLabelBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfNodesInTheSubTreeWithTheSameLabel(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfNodesInTheSubTreeWithTheSameLabel(/* example 1 */)); // expected
// console.log(numberOfNodesInTheSubTreeWithTheSameLabel(/* example 2 */)); // expected
// console.log(numberOfNodesInTheSubTreeWithTheSameLabel(/* edge case */)); // expected
```
...
- [Number of Nodes in the Sub-Tree With the Same Label — LeetCode](https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label) — problem page
