...
**Visual — Minimum Height Trees example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-height-trees) for full constraints
 ...
 */
function minimumHeightTreesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumHeightTrees(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumHeightTrees(/* example 1 */)); // expected
// console.log(minimumHeightTrees(/* example 2 */)); // expected
// console.log(minimumHeightTrees(/* edge case */)); // expected
```
...
- [Minimum Height Trees — LeetCode](https://leetcode.com/problems/minimum-height-trees) — problem page
