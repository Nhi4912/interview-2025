...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-largest-value-in-each-tree-row) for full constraints
 ...
 */
function findLargestValueInEachTreeRowBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findLargestValueInEachTreeRow(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findLargestValueInEachTreeRow(/* example 1 */)); // expected
// console.log(findLargestValueInEachTreeRow(/* example 2 */)); // expected
// console.log(findLargestValueInEachTreeRow(/* edge case */)); // expected
```
...
- [Find Largest Value in Each Tree Row — LeetCode](https://leetcode.com/problems/find-largest-value-in-each-tree-row) — problem page
