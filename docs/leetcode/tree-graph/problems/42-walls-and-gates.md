...
**Visual — Walls and Gates example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/walls-and-gates) for full constraints
 ...
 */
function wallsAndGatesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function wallsAndGates(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(wallsAndGates(/* example 1 */)); // expected
// console.log(wallsAndGates(/* example 2 */)); // expected
// console.log(wallsAndGates(/* edge case */)); // expected
```
...
- [Walls and Gates — LeetCode](https://leetcode.com/problems/walls-and-gates) — problem page
