...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/binary-tree-upside-down) for full constraints
 ...
 */
function binaryTreeUpsideDownBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function binaryTreeUpsideDown(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(binaryTreeUpsideDown(/* example 1 */)); // expected
// console.log(binaryTreeUpsideDown(/* example 2 */)); // expected
// console.log(binaryTreeUpsideDown(/* edge case */)); // expected
```
...
- [Binary Tree Upside Down — LeetCode](https://leetcode.com/problems/binary-tree-upside-down) — problem page
