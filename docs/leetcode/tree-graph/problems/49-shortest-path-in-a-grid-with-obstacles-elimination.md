...
**Visual — Shortest Path in a Grid with Obstacles Elimination example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-path-in-a-grid-with-obstacles-elimination) for full constraints
 ...
 */
function shortestPathInAGridWithObstaclesEliminationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestPathInAGridWithObstaclesElimination(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestPathInAGridWithObstaclesElimination(/* example 1 */)); // expected
// console.log(shortestPathInAGridWithObstaclesElimination(/* example 2 */)); // expected
// console.log(shortestPathInAGridWithObstaclesElimination(/* edge case */)); // expected
```
...
- [Shortest Path in a Grid with Obstacles Elimination — LeetCode](https://leetcode.com/problems/shortest-path-in-a-grid-with-obstacles-elimination) — problem page
