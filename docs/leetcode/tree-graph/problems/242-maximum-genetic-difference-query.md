...
Maximum Genetic Difference Query. ([LeetCode](https://leetcode.com/problems/maximum-genetic-difference-query))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-genetic-difference-query) for full constraints
 ...
 */
function maximumGeneticDifferenceQueryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumGeneticDifferenceQuery(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumGeneticDifferenceQuery(/* example 1 */)); // expected
// console.log(maximumGeneticDifferenceQuery(/* example 2 */)); // expected
// console.log(maximumGeneticDifferenceQuery(/* edge case */)); // expected
```
...
- [Maximum Genetic Difference Query — LeetCode](https://leetcode.com/problems/maximum-genetic-difference-query) — problem page
