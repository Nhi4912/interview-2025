...
**Visual — Shortest Path to Get All Keys example:**
...
Shortest Path to Get All Keys. ([LeetCode](https://leetcode.com/problems/shortest-path-to-get-all-keys))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-path-to-get-all-keys) for full constraints
 ...
 */
function shortestPathToGetAllKeysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestPathToGetAllKeys(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestPathToGetAllKeys(/* example 1 */)); // expected
// console.log(shortestPathToGetAllKeys(/* example 2 */)); // expected
// console.log(shortestPathToGetAllKeys(/* edge case */)); // expected
```
...
- [Minimum Number of Flips to Convert Binary Matrix to Zero Matrix](https://leetcode.com/problems/minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix) — same pattern: BFS
...
- [Shortest Path to Get All Keys — LeetCode](https://leetcode.com/problems/shortest-path-to-get-all-keys) — problem page
