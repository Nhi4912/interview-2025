...
**Visual — Number of Provinces example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-provinces) for full constraints
 ...
 */
function numberOfProvincesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfProvinces(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfProvinces(/* example 1 */)); // expected
// console.log(numberOfProvinces(/* example 2 */)); // expected
// console.log(numberOfProvinces(/* edge case */)); // expected
```
...
- [Number of Provinces — LeetCode](https://leetcode.com/problems/number-of-provinces) — problem page
