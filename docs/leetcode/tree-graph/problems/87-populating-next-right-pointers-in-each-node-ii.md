...
**Visual — Populating Next Right Pointers in Each Node II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii) for full constraints
 ...
 */
function populatingNextRightPointersInEachNodeIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function populatingNextRightPointersInEachNodeIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(populatingNextRightPointersInEachNodeIi(/* example 1 */)); // expected
// console.log(populatingNextRightPointersInEachNodeIi(/* example 2 */)); // expected
// console.log(populatingNextRightPointersInEachNodeIi(/* edge case */)); // expected
```
...
- [Populating Next Right Pointers in Each Node II — LeetCode](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii) — problem page
