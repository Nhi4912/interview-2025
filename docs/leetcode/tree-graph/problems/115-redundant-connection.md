...
**Visual — Redundant Connection example:**
...
Redundant Connection. ([LeetCode](https://leetcode.com/problems/redundant-connection))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/redundant-connection) for full constraints
 ...
 */
function redundantConnectionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function redundantConnection(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(redundantConnection(/* example 1 */)); // expected
// console.log(redundantConnection(/* example 2 */)); // expected
// console.log(redundantConnection(/* edge case */)); // expected
```
...
- [Redundant Connection — LeetCode](https://leetcode.com/problems/redundant-connection) — problem page
