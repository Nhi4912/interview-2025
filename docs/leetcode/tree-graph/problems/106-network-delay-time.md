...
> **See also**: [Cheapest Flights Within K Stops](https://leetcode.com/problems/cheapest-flights-within-k-stops) | [Find Edges in Shortest Paths](https://leetcode.com/problems/find-edges-in-shortest-paths)
...
**Visual — Network Delay Time example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/network-delay-time) for full constraints
 ...
 */
function networkDelayTimeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function networkDelayTime(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(networkDelayTime(/* example 1 */)); // expected
// console.log(networkDelayTime(/* example 2 */)); // expected
// console.log(networkDelayTime(/* edge case */)); // expected
```
...
- [Network Delay Time — LeetCode](https://leetcode.com/problems/network-delay-time) — problem page
