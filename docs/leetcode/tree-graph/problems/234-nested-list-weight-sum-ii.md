...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/nested-list-weight-sum-ii) for full constraints
 ...
 */
function nestedListWeightSumIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function nestedListWeightSumIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(nestedListWeightSumIi(/* example 1 */)); // expected
// console.log(nestedListWeightSumIi(/* example 2 */)); // expected
// console.log(nestedListWeightSumIi(/* edge case */)); // expected
```
...
- [Nested List Weight Sum II — LeetCode](https://leetcode.com/problems/nested-list-weight-sum-ii) — problem page
