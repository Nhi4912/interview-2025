...
**Visual — Minimum Genetic Mutation example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-genetic-mutation) for full constraints
 ...
 */
function minimumGeneticMutationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumGeneticMutation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumGeneticMutation(/* example 1 */)); // expected
// console.log(minimumGeneticMutation(/* example 2 */)); // expected
// console.log(minimumGeneticMutation(/* edge case */)); // expected
```
...
- [Minimum Genetic Mutation — LeetCode](https://leetcode.com/problems/minimum-genetic-mutation) — problem page
