...
**Visual — Find Bottom Left Tree Value example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-bottom-left-tree-value) for full constraints
 ...
 */
function findBottomLeftTreeValueBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findBottomLeftTreeValue(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findBottomLeftTreeValue(/* example 1 */)); // expected
// console.log(findBottomLeftTreeValue(/* example 2 */)); // expected
// console.log(findBottomLeftTreeValue(/* edge case */)); // expected
```
...
- [Find Bottom Left Tree Value — LeetCode](https://leetcode.com/problems/find-bottom-left-tree-value) — problem page
