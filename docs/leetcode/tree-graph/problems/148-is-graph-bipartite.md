...
**Visual — Is Graph Bipartite? example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/is-graph-bipartite) for full constraints
 ...
 */
function isGraphBipartiteBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function isGraphBipartite(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(isGraphBipartite(/* example 1 */)); // expected
// console.log(isGraphBipartite(/* example 2 */)); // expected
// console.log(isGraphBipartite(/* edge case */)); // expected
```
...
- [Is Graph Bipartite? — LeetCode](https://leetcode.com/problems/is-graph-bipartite) — problem page
