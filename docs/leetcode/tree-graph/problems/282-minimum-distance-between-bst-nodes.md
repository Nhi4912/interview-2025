...
> **See also**: [Two Sum IV - Input is a BST](https://leetcode.com/problems/two-sum-iv-input-is-a-bst) | [Same Tree](https://leetcode.com/problems/same-tree)
...
**Visual — Minimum Distance Between BST Nodes example:**
...
Minimum Distance Between BST Nodes. ([LeetCode](https://leetcode.com/problems/minimum-distance-between-bst-nodes))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-distance-between-bst-nodes) for full constraints
 ...
 */
function minimumDistanceBetweenBstNodesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumDistanceBetweenBstNodes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumDistanceBetweenBstNodes(/* example 1 */)); // expected
// console.log(minimumDistanceBetweenBstNodes(/* example 2 */)); // expected
// console.log(minimumDistanceBetweenBstNodes(/* edge case */)); // expected
```
...
- [Minimum Distance Between BST Nodes — LeetCode](https://leetcode.com/problems/minimum-distance-between-bst-nodes) — problem page
