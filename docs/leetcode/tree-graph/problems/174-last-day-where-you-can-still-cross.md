...
Last Day Where You Can Still Cross. ([LeetCode](https://leetcode.com/problems/last-day-where-you-can-still-cross))

Difficulty: Hard | Acceptance: 62.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/last-day-where-you-can-still-cross) for full constraints
 ...
 */
function lastDayWhereYouCanStillCrossBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lastDayWhereYouCanStillCross(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lastDayWhereYouCanStillCross(/* example 1 */)); // expected
// console.log(lastDayWhereYouCanStillCross(/* example 2 */)); // expected
// console.log(lastDayWhereYouCanStillCross(/* edge case */)); // expected
```
...
- [Last Day Where You Can Still Cross — LeetCode](https://leetcode.com/problems/last-day-where-you-can-still-cross) — problem page
