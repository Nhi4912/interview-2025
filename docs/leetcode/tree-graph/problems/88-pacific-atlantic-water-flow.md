...
**Visual — Pacific Atlantic Water Flow example:**
...
Difficulty: Medium | Acceptance: 57.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pacific-atlantic-water-flow) for full constraints
 ...
 */
function pacificAtlanticWaterFlowBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pacificAtlanticWaterFlow(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pacificAtlanticWaterFlow(/* example 1 */)); // expected
// console.log(pacificAtlanticWaterFlow(/* example 2 */)); // expected
// console.log(pacificAtlanticWaterFlow(/* edge case */)); // expected
```
...
- [Pacific Atlantic Water Flow — LeetCode](https://leetcode.com/problems/pacific-atlantic-water-flow) — problem page
