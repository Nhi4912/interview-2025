...
**Visual — Check if There is a Valid Path in a Grid example:**
...
Check if There is a Valid Path in a Grid. ([LeetCode](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid) for full constraints
 ...
 */
function checkIfThereIsAValidPathInAGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfThereIsAValidPathInAGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfThereIsAValidPathInAGrid(/* example 1 */)); // expected
// console.log(checkIfThereIsAValidPathInAGrid(/* example 2 */)); // expected
// console.log(checkIfThereIsAValidPathInAGrid(/* edge case */)); // expected
```
...
- [Check if There is a Valid Path in a Grid — LeetCode](https://leetcode.com/problems/check-if-there-is-a-valid-path-in-a-grid) — problem page
