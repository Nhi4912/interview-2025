...
> **See also**: [Accounts Merge](https://leetcode.com/problems/accounts-merge) | [Smallest Common Region](https://leetcode.com/problems/smallest-common-region)
...
Difficulty: Medium | Acceptance: 60.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/open-the-lock) for full constraints
 ...
 */
function openTheLockBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function openTheLock(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(openTheLock(/* example 1 */)); // expected
// console.log(openTheLock(/* example 2 */)); // expected
// console.log(openTheLock(/* edge case */)); // expected
```
...
- [Open the Lock — LeetCode](https://leetcode.com/problems/open-the-lock) — problem page
