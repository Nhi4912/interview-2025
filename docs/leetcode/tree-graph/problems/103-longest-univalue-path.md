...
**Visual — Longest Univalue Path example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-univalue-path) for full constraints
 ...
 */
function longestUnivaluePathBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestUnivaluePath(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestUnivaluePath(/* example 1 */)); // expected
// console.log(longestUnivaluePath(/* example 2 */)); // expected
// console.log(longestUnivaluePath(/* edge case */)); // expected
```
...
- [Longest Univalue Path — LeetCode](https://leetcode.com/problems/longest-univalue-path) — problem page
