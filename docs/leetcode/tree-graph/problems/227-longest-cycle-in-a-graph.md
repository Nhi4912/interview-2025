...
**Visual — Longest Cycle in a Graph example:**
...
Longest Cycle in a Graph. ([LeetCode](https://leetcode.com/problems/longest-cycle-in-a-graph))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-cycle-in-a-graph) for full constraints
 ...
 */
function longestCycleInAGraphBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestCycleInAGraph(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestCycleInAGraph(/* example 1 */)); // expected
// console.log(longestCycleInAGraph(/* example 2 */)); // expected
// console.log(longestCycleInAGraph(/* edge case */)); // expected
```
...
- [Longest Cycle in a Graph — LeetCode](https://leetcode.com/problems/longest-cycle-in-a-graph) — problem page
