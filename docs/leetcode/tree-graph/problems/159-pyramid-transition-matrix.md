...
**Visual — Pyramid Transition Matrix example:**
...
Pyramid Transition Matrix. ([LeetCode](https://leetcode.com/problems/pyramid-transition-matrix))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pyramid-transition-matrix) for full constraints
 ...
 */
function pyramidTransitionMatrixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pyramidTransitionMatrix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pyramidTransitionMatrix(/* example 1 */)); // expected
// console.log(pyramidTransitionMatrix(/* example 2 */)); // expected
// console.log(pyramidTransitionMatrix(/* edge case */)); // expected
```
...
- [Pyramid Transition Matrix — LeetCode](https://leetcode.com/problems/pyramid-transition-matrix) — problem page
