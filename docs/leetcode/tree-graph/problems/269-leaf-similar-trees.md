...
**Visual — Leaf-Similar Trees example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/leaf-similar-trees) for full constraints
 ...
 */
function leafSimilarTreesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function leafSimilarTrees(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(leafSimilarTrees(/* example 1 */)); // expected
// console.log(leafSimilarTrees(/* example 2 */)); // expected
// console.log(leafSimilarTrees(/* edge case */)); // expected
```
...
- [Leaf-Similar Trees — LeetCode](https://leetcode.com/problems/leaf-similar-trees) — problem page
