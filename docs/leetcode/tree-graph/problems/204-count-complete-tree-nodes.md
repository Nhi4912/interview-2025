...
> **See also**: [Closest Binary Search Tree Value](https://leetcode.com/problems/closest-binary-search-tree-value) | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree)
...
**Visual — Count Complete Tree Nodes example:**
...
Difficulty: Easy | Acceptance: 70.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-complete-tree-nodes) for full constraints
 ...
 */
function countCompleteTreeNodesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countCompleteTreeNodes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countCompleteTreeNodes(/* example 1 */)); // expected
// console.log(countCompleteTreeNodes(/* example 2 */)); // expected
// console.log(countCompleteTreeNodes(/* edge case */)); // expected
```
...
- [Closest Binary Search Tree Value](https://leetcode.com/problems/closest-binary-search-tree-value) — same pattern: Binary Search
...
- [Count Complete Tree Nodes — LeetCode](https://leetcode.com/problems/count-complete-tree-nodes) — problem page
