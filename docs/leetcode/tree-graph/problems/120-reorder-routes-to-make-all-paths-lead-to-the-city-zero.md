...
**Visual — Reorder Routes to Make All Paths Lead to the City Zero example:**
...
Difficulty: Medium | Acceptance: 65.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reorder-routes-to-make-all-paths-lead-to-the-city-zero) for full constraints
 ...
 */
function reorderRoutesToMakeAllPathsLeadToTheCityZeroBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reorderRoutesToMakeAllPathsLeadToTheCityZero(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reorderRoutesToMakeAllPathsLeadToTheCityZero(/* example 1 */)); // expected
// console.log(reorderRoutesToMakeAllPathsLeadToTheCityZero(/* example 2 */)); // expected
// console.log(reorderRoutesToMakeAllPathsLeadToTheCityZero(/* edge case */)); // expected
```
...
- [Reorder Routes to Make All Paths Lead to the City Zero — LeetCode](https://leetcode.com/problems/reorder-routes-to-make-all-paths-lead-to-the-city-zero) — problem page
