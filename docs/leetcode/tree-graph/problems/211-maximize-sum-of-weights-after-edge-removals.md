...
# Maximize Sum of Weights after Edge Removals / Maximize Sum of Weights after Edge Removals
...
Maximize Sum of Weights after Edge Removals. ([LeetCode](https://leetcode.com/problems/maximize-sum-of-weights-after-edge-removals))

Difficulty: Hard | Acceptance: 29.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximize-sum-of-weights-after-edge-removals) for full constraints
 ...
 */
function maximizeSumOfWeightsAfterEdgeRemovalsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximizeSumOfWeightsAfterEdgeRemovals(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximizeSumOfWeightsAfterEdgeRemovals(/* example 1 */)); // expected
// console.log(maximizeSumOfWeightsAfterEdgeRemovals(/* example 2 */)); // expected
// console.log(maximizeSumOfWeightsAfterEdgeRemovals(/* edge case */)); // expected
```
...
- [Maximize Sum of Weights after Edge Removals — LeetCode](https://leetcode.com/problems/maximize-sum-of-weights-after-edge-removals) — problem page
