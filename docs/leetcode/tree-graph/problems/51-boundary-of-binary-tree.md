...
**Visual — Boundary of Binary Tree example:**
...
Difficulty: Medium | Acceptance: 47.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/boundary-of-binary-tree) for full constraints
 ...
 */
function boundaryOfBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function boundaryOfBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(boundaryOfBinaryTree(/* example 1 */)); // expected
// console.log(boundaryOfBinaryTree(/* example 2 */)); // expected
// console.log(boundaryOfBinaryTree(/* edge case */)); // expected
```
...
- [Boundary of Binary Tree — LeetCode](https://leetcode.com/problems/boundary-of-binary-tree) — problem page
