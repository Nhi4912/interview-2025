...
**Visual — Snakes and Ladders example:**
...
Snakes and Ladders. ([LeetCode](https://leetcode.com/problems/snakes-and-ladders))

Difficulty: Medium | Acceptance: 47.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/snakes-and-ladders) for full constraints
 ...
 */
function snakesAndLaddersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function snakesAndLadders(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(snakesAndLadders(/* example 1 */)); // expected
// console.log(snakesAndLadders(/* example 2 */)); // expected
// console.log(snakesAndLadders(/* edge case */)); // expected
```
...
- [Snakes and Ladders — LeetCode](https://leetcode.com/problems/snakes-and-ladders) — problem page
