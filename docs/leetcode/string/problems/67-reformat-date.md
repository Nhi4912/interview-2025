...
Reformat Date. ([LeetCode](https://leetcode.com/problems/reformat-date))

Difficulty: Easy | Acceptance: 67.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reformat-date) for full constraints
 ...
 */
function reformatDateBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reformatDate(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reformatDate(/* example 1 */)); // expected
// console.log(reformatDate(/* example 2 */)); // expected
// console.log(reformatDate(/* edge case */)); // expected
```
...
- [Reformat Date — LeetCode](https://leetcode.com/problems/reformat-date) — problem page
