...
# Find the Longest Balanced Substring of a Binary String / Find the Longest Balanced Substring of a Binary String
...
**Visual — Find the Longest Balanced Substring of a Binary String example:**
...
Find the Longest Balanced Substring of a Binary String. ([LeetCode](https://leetcode.com/problems/find-the-longest-balanced-substring-of-a-binary-string))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-longest-balanced-substring-of-a-binary-string) for full constraints
 ...
 */
function findTheLongestBalancedSubstringOfABinaryStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheLongestBalancedSubstringOfABinaryString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheLongestBalancedSubstringOfABinaryString(/* example 1 */)); // expected
// console.log(findTheLongestBalancedSubstringOfABinaryString(/* example 2 */)); // expected
// console.log(findTheLongestBalancedSubstringOfABinaryString(/* edge case */)); // expected
```
...
- [Find the Longest Balanced Substring of a Binary String — LeetCode](https://leetcode.com/problems/find-the-longest-balanced-substring-of-a-binary-string) — problem page
