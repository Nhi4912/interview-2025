...
**Visual — Longest Palindrome example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-palindrome) for full constraints
 ...
 */
function longestPalindromeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestPalindrome(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestPalindrome(/* example 1 */)); // expected
// console.log(longestPalindrome(/* example 2 */)); // expected
// console.log(longestPalindrome(/* edge case */)); // expected
```
...
- [Longest Palindrome — LeetCode](https://leetcode.com/problems/longest-palindrome) — problem page
