...
**Visual — Find the Closest Palindrome example:**
...
Difficulty: Hard | Acceptance: 31.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-closest-palindrome) for full constraints
 ...
 */
function findTheClosestPalindromeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheClosestPalindrome(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheClosestPalindrome(/* example 1 */)); // expected
// console.log(findTheClosestPalindrome(/* example 2 */)); // expected
// console.log(findTheClosestPalindrome(/* edge case */)); // expected
```
...
- [Find the Closest Palindrome — LeetCode](https://leetcode.com/problems/find-the-closest-palindrome) — problem page
