...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/decode-string) for full constraints
 ...
 */
function decodeStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function decodeString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(decodeString(/* example 1 */)); // expected
// console.log(decodeString(/* example 2 */)); // expected
// console.log(decodeString(/* edge case */)); // expected
```
...
- [Decode String — LeetCode](https://leetcode.com/problems/decode-string) — problem page
