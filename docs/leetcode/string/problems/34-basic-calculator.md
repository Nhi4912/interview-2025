...
> **See also**: [Basic Calculator III](https://leetcode.com/problems/basic-calculator-iii) | [Basic Calculator IV](https://leetcode.com/problems/basic-calculator-iv)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/basic-calculator) for full constraints
 ...
 */
function basicCalculatorBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function basicCalculator(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(basicCalculator(/* example 1 */)); // expected
// console.log(basicCalculator(/* example 2 */)); // expected
// console.log(basicCalculator(/* edge case */)); // expected
```
...
- [Basic Calculator — LeetCode](https://leetcode.com/problems/basic-calculator) — problem page
