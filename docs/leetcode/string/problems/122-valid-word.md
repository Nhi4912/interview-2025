...
Valid Word. ([LeetCode](https://leetcode.com/problems/valid-word))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/valid-word) for full constraints
 ...
 */
function validWordBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function validWord(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(validWord(/* example 1 */)); // expected
// console.log(validWord(/* example 2 */)); // expected
// console.log(validWord(/* edge case */)); // expected
```
...
- [Valid Word — LeetCode](https://leetcode.com/problems/valid-word) — problem page
