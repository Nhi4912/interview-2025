...
**Visual — Shortest Palindrome example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-palindrome) for full constraints
 ...
 */
function shortestPalindromeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestPalindrome(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestPalindrome(/* example 1 */)); // expected
// console.log(shortestPalindrome(/* example 2 */)); // expected
// console.log(shortestPalindrome(/* edge case */)); // expected
```
...
- [Shortest Palindrome — LeetCode](https://leetcode.com/problems/shortest-palindrome) — problem page
