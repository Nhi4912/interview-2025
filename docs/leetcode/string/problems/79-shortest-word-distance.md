...
**Visual — Shortest Word Distance example:**
...
Shortest Word Distance. ([LeetCode](https://leetcode.com/problems/shortest-word-distance))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-word-distance) for full constraints
 ...
 */
function shortestWordDistanceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestWordDistance(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestWordDistance(/* example 1 */)); // expected
// console.log(shortestWordDistance(/* example 2 */)); // expected
// console.log(shortestWordDistance(/* edge case */)); // expected
```
...
- [Shortest Word Distance — LeetCode](https://leetcode.com/problems/shortest-word-distance) — problem page
