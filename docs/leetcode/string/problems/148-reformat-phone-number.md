...
**Visual — Reformat Phone Number example:**
...
Reformat Phone Number. ([LeetCode](https://leetcode.com/problems/reformat-phone-number))

Difficulty: Easy | Acceptance: 66.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reformat-phone-number) for full constraints
 ...
 */
function reformatPhoneNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reformatPhoneNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reformatPhoneNumber(/* example 1 */)); // expected
// console.log(reformatPhoneNumber(/* example 2 */)); // expected
// console.log(reformatPhoneNumber(/* edge case */)); // expected
```
...
- [Reformat Phone Number — LeetCode](https://leetcode.com/problems/reformat-phone-number) — problem page
