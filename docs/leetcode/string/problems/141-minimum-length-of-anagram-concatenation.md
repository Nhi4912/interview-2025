...
# Minimum Length of Anagram Concatenation / Minimum Length of Anagram Concatenation
...
Minimum Length of Anagram Concatenation. ([LeetCode](https://leetcode.com/problems/minimum-length-of-anagram-concatenation))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-length-of-anagram-concatenation) for full constraints
 ...
 */
function minimumLengthOfAnagramConcatenationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumLengthOfAnagramConcatenation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumLengthOfAnagramConcatenation(/* example 1 */)); // expected
// console.log(minimumLengthOfAnagramConcatenation(/* example 2 */)); // expected
// console.log(minimumLengthOfAnagramConcatenation(/* edge case */)); // expected
```
...
- [Minimum Length of Anagram Concatenation — LeetCode](https://leetcode.com/problems/minimum-length-of-anagram-concatenation) — problem page
