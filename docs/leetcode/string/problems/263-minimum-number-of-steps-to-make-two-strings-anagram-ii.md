...
**Visual — Minimum Number of Steps to Make Two Strings Anagram II example:**
...
Minimum Number of Steps to Make Two Strings Anagram II. ([LeetCode](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram-ii) for full constraints
 ...
 */
function minimumNumberOfStepsToMakeTwoStringsAnagramIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfStepsToMakeTwoStringsAnagramIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagramIi(/* example 1 */)); // expected
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagramIi(/* example 2 */)); // expected
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagramIi(/* edge case */)); // expected
```
...
- [Minimum Number of Steps to Make Two Strings Anagram II — LeetCode](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram-ii) — problem page
