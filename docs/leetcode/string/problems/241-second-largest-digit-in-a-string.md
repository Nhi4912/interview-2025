...
**Visual — Second Largest Digit in a String example:**
...
Second Largest Digit in a String. ([LeetCode](https://leetcode.com/problems/second-largest-digit-in-a-string))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/second-largest-digit-in-a-string) for full constraints
 ...
 */
function secondLargestDigitInAStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function secondLargestDigitInAString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(secondLargestDigitInAString(/* example 1 */)); // expected
// console.log(secondLargestDigitInAString(/* example 2 */)); // expected
// console.log(secondLargestDigitInAString(/* edge case */)); // expected
```
...
- [Second Largest Digit in a String — LeetCode](https://leetcode.com/problems/second-largest-digit-in-a-string) — problem page
