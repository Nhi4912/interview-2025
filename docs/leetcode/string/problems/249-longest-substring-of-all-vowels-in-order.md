...
**Visual — Longest Substring Of All Vowels in Order example:**
...
Longest Substring Of All Vowels in Order. ([LeetCode](https://leetcode.com/problems/longest-substring-of-all-vowels-in-order))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-substring-of-all-vowels-in-order) for full constraints
 ...
 */
function longestSubstringOfAllVowelsInOrderBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestSubstringOfAllVowelsInOrder(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestSubstringOfAllVowelsInOrder(/* example 1 */)); // expected
// console.log(longestSubstringOfAllVowelsInOrder(/* example 2 */)); // expected
// console.log(longestSubstringOfAllVowelsInOrder(/* edge case */)); // expected
```
...
- [Longest Substring Of All Vowels in Order — LeetCode](https://leetcode.com/problems/longest-substring-of-all-vowels-in-order) — problem page
