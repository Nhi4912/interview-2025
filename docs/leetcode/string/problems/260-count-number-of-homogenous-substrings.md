...
Count Number of Homogenous Substrings. ([LeetCode](https://leetcode.com/problems/count-number-of-homogenous-substrings))

Difficulty: Medium | Acceptance: 57.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-number-of-homogenous-substrings) for full constraints
 ...
 */
function countNumberOfHomogenousSubstringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countNumberOfHomogenousSubstrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countNumberOfHomogenousSubstrings(/* example 1 */)); // expected
// console.log(countNumberOfHomogenousSubstrings(/* example 2 */)); // expected
// console.log(countNumberOfHomogenousSubstrings(/* edge case */)); // expected
```
...
- [Count Number of Homogenous Substrings — LeetCode](https://leetcode.com/problems/count-number-of-homogenous-substrings) — problem page
