...
**Visual — Fraction to Recurring Decimal example:**
...
Difficulty: Medium | Acceptance: 26.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/fraction-to-recurring-decimal) for full constraints
 ...
 */
function fractionToRecurringDecimalBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function fractionToRecurringDecimal(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(fractionToRecurringDecimal(/* example 1 */)); // expected
// console.log(fractionToRecurringDecimal(/* example 2 */)); // expected
// console.log(fractionToRecurringDecimal(/* edge case */)); // expected
```
...
- [Fraction to Recurring Decimal — LeetCode](https://leetcode.com/problems/fraction-to-recurring-decimal) — problem page
