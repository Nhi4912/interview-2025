...
**Visual — Group Shifted Strings example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/group-shifted-strings) for full constraints
 ...
 */
function groupShiftedStringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function groupShiftedStrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(groupShiftedStrings(/* example 1 */)); // expected
// console.log(groupShiftedStrings(/* example 2 */)); // expected
// console.log(groupShiftedStrings(/* edge case */)); // expected
```
...
- [Group Shifted Strings — LeetCode](https://leetcode.com/problems/group-shifted-strings) — problem page
