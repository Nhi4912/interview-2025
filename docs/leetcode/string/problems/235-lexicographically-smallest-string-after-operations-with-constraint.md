...
**Visual — Lexicographically Smallest String After Operations With Constraint example:**
...
Lexicographically Smallest String After Operations With Constraint. ([LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-operations-with-constraint))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lexicographically-smallest-string-after-operations-with-constraint) for full constraints
 ...
 */
function lexicographicallySmallestStringAfterOperationsWithConstraintBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lexicographicallySmallestStringAfterOperationsWithConstraint(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lexicographicallySmallestStringAfterOperationsWithConstraint(/* example 1 */)); // expected
// console.log(lexicographicallySmallestStringAfterOperationsWithConstraint(/* example 2 */)); // expected
// console.log(lexicographicallySmallestStringAfterOperationsWithConstraint(/* edge case */)); // expected
```
...
- [Lexicographically Smallest String After Operations With Constraint — LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-operations-with-constraint) — problem page
