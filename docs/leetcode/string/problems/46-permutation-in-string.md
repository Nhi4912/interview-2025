...
**Visual — Permutation in String example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/permutation-in-string) for full constraints
 ...
 */
function permutationInStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function permutationInString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(permutationInString(/* example 1 */)); // expected
// console.log(permutationInString(/* example 2 */)); // expected
// console.log(permutationInString(/* edge case */)); // expected
```
...
- [Permutation in String — LeetCode](https://leetcode.com/problems/permutation-in-string) — problem page
