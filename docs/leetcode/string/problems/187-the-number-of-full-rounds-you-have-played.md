...
**Visual — The Number of Full Rounds You Have Played example:**
...
The Number of Full Rounds You Have Played. ([LeetCode](https://leetcode.com/problems/the-number-of-full-rounds-you-have-played))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/the-number-of-full-rounds-you-have-played) for full constraints
 ...
 */
function theNumberOfFullRoundsYouHavePlayedBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function theNumberOfFullRoundsYouHavePlayed(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(theNumberOfFullRoundsYouHavePlayed(/* example 1 */)); // expected
// console.log(theNumberOfFullRoundsYouHavePlayed(/* example 2 */)); // expected
// console.log(theNumberOfFullRoundsYouHavePlayed(/* edge case */)); // expected
```
...
- [The Number of Full Rounds You Have Played — LeetCode](https://leetcode.com/problems/the-number-of-full-rounds-you-have-played) — problem page
