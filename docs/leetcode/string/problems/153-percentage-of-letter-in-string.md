...
**Visual — Percentage of Letter in String example:**
...
Percentage of Letter in String. ([LeetCode](https://leetcode.com/problems/percentage-of-letter-in-string))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/percentage-of-letter-in-string) for full constraints
 ...
 */
function percentageOfLetterInStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function percentageOfLetterInString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(percentageOfLetterInString(/* example 1 */)); // expected
// console.log(percentageOfLetterInString(/* example 2 */)); // expected
// console.log(percentageOfLetterInString(/* edge case */)); // expected
```
...
- [Percentage of Letter in String — LeetCode](https://leetcode.com/problems/percentage-of-letter-in-string) — problem page
