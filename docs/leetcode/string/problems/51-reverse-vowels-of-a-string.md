...
**Visual — Reverse Vowels of a String example:**
...
Difficulty: Easy | Acceptance: 58.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reverse-vowels-of-a-string) for full constraints
 ...
 */
function reverseVowelsOfAStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reverseVowelsOfAString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reverseVowelsOfAString(/* example 1 */)); // expected
// console.log(reverseVowelsOfAString(/* example 2 */)); // expected
// console.log(reverseVowelsOfAString(/* edge case */)); // expected
```
...
- [Reverse Vowels of a String — LeetCode](https://leetcode.com/problems/reverse-vowels-of-a-string) — problem page
