...
**Visual — Stamping The Sequence example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/stamping-the-sequence) for full constraints
 ...
 */
function stampingTheSequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function stampingTheSequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(stampingTheSequence(/* example 1 */)); // expected
// console.log(stampingTheSequence(/* example 2 */)); // expected
// console.log(stampingTheSequence(/* edge case */)); // expected
```
...
- [Stamping The Sequence — LeetCode](https://leetcode.com/problems/stamping-the-sequence) — problem page
