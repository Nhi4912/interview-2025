...
**Visual — Basic Calculator IV example:**
...
Basic Calculator IV. ([LeetCode](https://leetcode.com/problems/basic-calculator-iv))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/basic-calculator-iv) for full constraints
 ...
 */
function basicCalculatorIvBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function basicCalculatorIv(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(basicCalculatorIv(/* example 1 */)); // expected
// console.log(basicCalculatorIv(/* example 2 */)); // expected
// console.log(basicCalculatorIv(/* edge case */)); // expected
```
...
- [Basic Calculator IV — LeetCode](https://leetcode.com/problems/basic-calculator-iv) — problem page
