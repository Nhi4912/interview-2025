...
Sum Game. ([LeetCode](https://leetcode.com/problems/sum-game))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-game) for full constraints
 ...
 */
function sumGameBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumGame(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumGame(/* example 1 */)); // expected
// console.log(sumGame(/* example 2 */)); // expected
// console.log(sumGame(/* edge case */)); // expected
```
...
- [Sum Game — LeetCode](https://leetcode.com/problems/sum-game) — problem page
