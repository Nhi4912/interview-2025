...
> **See also**: [Evaluate Division](https://leetcode.com/problems/evaluate-division) | [Add Binary](https://leetcode.com/problems/add-binary)
...
**Visual — Groups of Strings example:**
...
Groups of Strings. ([LeetCode](https://leetcode.com/problems/groups-of-strings))

Difficulty: Hard | Acceptance: 26.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/groups-of-strings) for full constraints
 ...
 */
function groupsOfStringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function groupsOfStrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(groupsOfStrings(/* example 1 */)); // expected
// console.log(groupsOfStrings(/* example 2 */)); // expected
// console.log(groupsOfStrings(/* edge case */)); // expected
```
...
- [Groups of Strings — LeetCode](https://leetcode.com/problems/groups-of-strings) — problem page
