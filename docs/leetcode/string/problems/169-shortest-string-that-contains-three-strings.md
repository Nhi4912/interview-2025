...
Shortest String That Contains Three Strings. ([LeetCode](https://leetcode.com/problems/shortest-string-that-contains-three-strings))

Difficulty: Medium | Acceptance: 30.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shortest-string-that-contains-three-strings) for full constraints
 ...
 */
function shortestStringThatContainsThreeStringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shortestStringThatContainsThreeStrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shortestStringThatContainsThreeStrings(/* example 1 */)); // expected
// console.log(shortestStringThatContainsThreeStrings(/* example 2 */)); // expected
// console.log(shortestStringThatContainsThreeStrings(/* edge case */)); // expected
```
...
- [Shortest String That Contains Three Strings — LeetCode](https://leetcode.com/problems/shortest-string-that-contains-three-strings) — problem page
