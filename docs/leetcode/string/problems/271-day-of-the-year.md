...
**Visual — Day of the Year example:**
...
Day of the Year. ([LeetCode](https://leetcode.com/problems/day-of-the-year))

Difficulty: Easy | Acceptance: 48.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/day-of-the-year) for full constraints
 ...
 */
function dayOfTheYearBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function dayOfTheYear(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(dayOfTheYear(/* example 1 */)); // expected
// console.log(dayOfTheYear(/* example 2 */)); // expected
// console.log(dayOfTheYear(/* edge case */)); // expected
```
...
- [Day of the Year — LeetCode](https://leetcode.com/problems/day-of-the-year) — problem page
