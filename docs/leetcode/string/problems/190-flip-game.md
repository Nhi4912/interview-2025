...
Flip Game. ([LeetCode](https://leetcode.com/problems/flip-game))

Difficulty: Easy | Acceptance: 64.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/flip-game) for full constraints
 ...
 */
function flipGameBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function flipGame(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(flipGame(/* example 1 */)); // expected
// console.log(flipGame(/* example 2 */)); // expected
// console.log(flipGame(/* edge case */)); // expected
```
...
- [Flip Game — LeetCode](https://leetcode.com/problems/flip-game) — problem page
