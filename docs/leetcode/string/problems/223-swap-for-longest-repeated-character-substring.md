...
Swap For Longest Repeated Character Substring. ([LeetCode](https://leetcode.com/problems/swap-for-longest-repeated-character-substring))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/swap-for-longest-repeated-character-substring) for full constraints
 ...
 */
function swapForLongestRepeatedCharacterSubstringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function swapForLongestRepeatedCharacterSubstring(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(swapForLongestRepeatedCharacterSubstring(/* example 1 */)); // expected
// console.log(swapForLongestRepeatedCharacterSubstring(/* example 2 */)); // expected
// console.log(swapForLongestRepeatedCharacterSubstring(/* edge case */)); // expected
```
...
- [Swap For Longest Repeated Character Substring — LeetCode](https://leetcode.com/problems/swap-for-longest-repeated-character-substring) — problem page
