...
**Visual — Remove Letter To Equalize Frequency example:**
...
Remove Letter To Equalize Frequency. ([LeetCode](https://leetcode.com/problems/remove-letter-to-equalize-frequency))

Difficulty: Easy | Acceptance: 18.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/remove-letter-to-equalize-frequency) for full constraints
 ...
 */
function removeLetterToEqualizeFrequencyBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function removeLetterToEqualizeFrequency(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(removeLetterToEqualizeFrequency(/* example 1 */)); // expected
// console.log(removeLetterToEqualizeFrequency(/* example 2 */)); // expected
// console.log(removeLetterToEqualizeFrequency(/* edge case */)); // expected
```
...
- [Remove Letter To Equalize Frequency — LeetCode](https://leetcode.com/problems/remove-letter-to-equalize-frequency) — problem page
