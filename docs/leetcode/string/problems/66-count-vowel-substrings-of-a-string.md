...
**Visual — Count Vowel Substrings of a String example:**
...
Count Vowel Substrings of a String. ([LeetCode](https://leetcode.com/problems/count-vowel-substrings-of-a-string))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-vowel-substrings-of-a-string) for full constraints
 ...
 */
function countVowelSubstringsOfAStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countVowelSubstringsOfAString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countVowelSubstringsOfAString(/* example 1 */)); // expected
// console.log(countVowelSubstringsOfAString(/* example 2 */)); // expected
// console.log(countVowelSubstringsOfAString(/* edge case */)); // expected
```
...
- [Count Vowel Substrings of a String — LeetCode](https://leetcode.com/problems/count-vowel-substrings-of-a-string) — problem page
