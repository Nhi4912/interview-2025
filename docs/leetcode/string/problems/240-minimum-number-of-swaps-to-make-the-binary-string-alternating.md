...
**Visual — Minimum Number of Swaps to Make the Binary String Alternating example:**
...
Minimum Number of Swaps to Make the Binary String Alternating. ([LeetCode](https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating))

Difficulty: Medium | Acceptance: 43.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating) for full constraints
 ...
 */
function minimumNumberOfSwapsToMakeTheBinaryStringAlternatingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfSwapsToMakeTheBinaryStringAlternating(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfSwapsToMakeTheBinaryStringAlternating(/* example 1 */)); // expected
// console.log(minimumNumberOfSwapsToMakeTheBinaryStringAlternating(/* example 2 */)); // expected
// console.log(minimumNumberOfSwapsToMakeTheBinaryStringAlternating(/* edge case */)); // expected
```
...
- [Minimum Number of Swaps to Make the Binary String Alternating — LeetCode](https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating) — problem page
