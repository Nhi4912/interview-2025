...
# Determine Color of a Chessboard Square / Determine Color of a Chessboard Square
...
Determine Color of a Chessboard Square. ([LeetCode](https://leetcode.com/problems/determine-color-of-a-chessboard-square))

Difficulty: Easy | Acceptance: 79.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/determine-color-of-a-chessboard-square) for full constraints
 ...
 */
function determineColorOfAChessboardSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function determineColorOfAChessboardSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(determineColorOfAChessboardSquare(/* example 1 */)); // expected
// console.log(determineColorOfAChessboardSquare(/* example 2 */)); // expected
// console.log(determineColorOfAChessboardSquare(/* edge case */)); // expected
```
...
- [Determine Color of a Chessboard Square — LeetCode](https://leetcode.com/problems/determine-color-of-a-chessboard-square) — problem page
