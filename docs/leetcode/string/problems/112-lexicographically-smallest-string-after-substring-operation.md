...
**Visual — Lexicographically Smallest String After Substring Operation example:**
...
Lexicographically Smallest String After Substring Operation. ([LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-substring-operation))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lexicographically-smallest-string-after-substring-operation) for full constraints
 ...
 */
function lexicographicallySmallestStringAfterSubstringOperationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lexicographicallySmallestStringAfterSubstringOperation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lexicographicallySmallestStringAfterSubstringOperation(/* example 1 */)); // expected
// console.log(lexicographicallySmallestStringAfterSubstringOperation(/* example 2 */)); // expected
// console.log(lexicographicallySmallestStringAfterSubstringOperation(/* edge case */)); // expected
```
...
- [Lexicographically Smallest String After Substring Operation — LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-substring-operation) — problem page
