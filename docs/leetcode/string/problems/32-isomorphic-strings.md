...
**Visual — Isomorphic Strings example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/isomorphic-strings) for full constraints
 ...
 */
function isomorphicStringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function isomorphicStrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(isomorphicStrings(/* example 1 */)); // expected
// console.log(isomorphicStrings(/* example 2 */)); // expected
// console.log(isomorphicStrings(/* edge case */)); // expected
```
...
- [Isomorphic Strings — LeetCode](https://leetcode.com/problems/isomorphic-strings) — problem page
