...
**Visual — Break a Palindrome example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/break-a-palindrome) for full constraints
 ...
 */
function breakAPalindromeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function breakAPalindrome(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(breakAPalindrome(/* example 1 */)); // expected
// console.log(breakAPalindrome(/* example 2 */)); // expected
// console.log(breakAPalindrome(/* edge case */)); // expected
```
...
- [Break a Palindrome — LeetCode](https://leetcode.com/problems/break-a-palindrome) — problem page
