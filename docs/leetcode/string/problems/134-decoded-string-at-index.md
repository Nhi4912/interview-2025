...
**Visual — Decoded String at Index example:**
...
Decoded String at Index. ([LeetCode](https://leetcode.com/problems/decoded-string-at-index))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/decoded-string-at-index) for full constraints
 ...
 */
function decodedStringAtIndexBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function decodedStringAtIndex(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(decodedStringAtIndex(/* example 1 */)); // expected
// console.log(decodedStringAtIndex(/* example 2 */)); // expected
// console.log(decodedStringAtIndex(/* edge case */)); // expected
```
...
- [Decoded String at Index — LeetCode](https://leetcode.com/problems/decoded-string-at-index) — problem page
