...
**Visual — Robot Bounded In Circle example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/robot-bounded-in-circle) for full constraints
 ...
 */
function robotBoundedInCircleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function robotBoundedInCircle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(robotBoundedInCircle(/* example 1 */)); // expected
// console.log(robotBoundedInCircle(/* example 2 */)); // expected
// console.log(robotBoundedInCircle(/* edge case */)); // expected
```
...
- [Robot Bounded In Circle — LeetCode](https://leetcode.com/problems/robot-bounded-in-circle) — problem page
