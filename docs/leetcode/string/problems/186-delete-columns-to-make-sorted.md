...
**Visual — Delete Columns to Make Sorted example:**
...
Delete Columns to Make Sorted. ([LeetCode](https://leetcode.com/problems/delete-columns-to-make-sorted))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/delete-columns-to-make-sorted) for full constraints
 ...
 */
function deleteColumnsToMakeSortedBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function deleteColumnsToMakeSorted(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(deleteColumnsToMakeSorted(/* example 1 */)); // expected
// console.log(deleteColumnsToMakeSorted(/* example 2 */)); // expected
// console.log(deleteColumnsToMakeSorted(/* edge case */)); // expected
```
...
- [Delete Columns to Make Sorted — LeetCode](https://leetcode.com/problems/delete-columns-to-make-sorted) — problem page
