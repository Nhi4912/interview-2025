...
**Visual — Minimum Time to Type Word Using Special Typewriter example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-to-type-word-using-special-typewriter) for full constraints
 ...
 */
function minimumTimeToTypeWordUsingSpecialTypewriterBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeToTypeWordUsingSpecialTypewriter(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeToTypeWordUsingSpecialTypewriter(/* example 1 */)); // expected
// console.log(minimumTimeToTypeWordUsingSpecialTypewriter(/* example 2 */)); // expected
// console.log(minimumTimeToTypeWordUsingSpecialTypewriter(/* edge case */)); // expected
```
...
- [Minimum Time to Type Word Using Special Typewriter — LeetCode](https://leetcode.com/problems/minimum-time-to-type-word-using-special-typewriter) — problem page
