...
**Visual — Delete Duplicate Folders in System example:**
...
Delete Duplicate Folders in System. ([LeetCode](https://leetcode.com/problems/delete-duplicate-folders-in-system))

Difficulty: Hard | Acceptance: 53.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/delete-duplicate-folders-in-system) for full constraints
 ...
 */
function deleteDuplicateFoldersInSystemBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function deleteDuplicateFoldersInSystem(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(deleteDuplicateFoldersInSystem(/* example 1 */)); // expected
// console.log(deleteDuplicateFoldersInSystem(/* example 2 */)); // expected
// console.log(deleteDuplicateFoldersInSystem(/* edge case */)); // expected
```
...
- [Delete Duplicate Folders in System — LeetCode](https://leetcode.com/problems/delete-duplicate-folders-in-system) — problem page
