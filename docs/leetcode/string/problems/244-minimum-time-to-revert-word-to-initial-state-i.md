...
**Visual — Minimum Time to Revert Word to Initial State I example:**
...
Minimum Time to Revert Word to Initial State I. ([LeetCode](https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-i))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-i) for full constraints
 ...
 */
function minimumTimeToRevertWordToInitialStateIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeToRevertWordToInitialStateI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeToRevertWordToInitialStateI(/* example 1 */)); // expected
// console.log(minimumTimeToRevertWordToInitialStateI(/* example 2 */)); // expected
// console.log(minimumTimeToRevertWordToInitialStateI(/* edge case */)); // expected
```
...
- [Minimum Time to Revert Word to Initial State I — LeetCode](https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-i) — problem page
