...
Difficulty: Easy | Acceptance: 43.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/excel-sheet-column-title) for full constraints
 ...
 */
function excelSheetColumnTitleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function excelSheetColumnTitle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(excelSheetColumnTitle(/* example 1 */)); // expected
// console.log(excelSheetColumnTitle(/* example 2 */)); // expected
// console.log(excelSheetColumnTitle(/* edge case */)); // expected
```
...
- [Excel Sheet Column Title — LeetCode](https://leetcode.com/problems/excel-sheet-column-title) — problem page
