...
**Visual — Remove All Adjacent Duplicates In String example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string) for full constraints
 ...
 */
function removeAllAdjacentDuplicatesInStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function removeAllAdjacentDuplicatesInString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(removeAllAdjacentDuplicatesInString(/* example 1 */)); // expected
// console.log(removeAllAdjacentDuplicatesInString(/* example 2 */)); // expected
// console.log(removeAllAdjacentDuplicatesInString(/* edge case */)); // expected
```
...
- [Remove All Adjacent Duplicates In String — LeetCode](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string) — problem page
