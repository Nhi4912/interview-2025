...
> **See also**: [Remove Colored Pieces if Both Neighbors are the Same Color](https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color) | [Sum Game](https://leetcode.com/problems/sum-game)
...
**Visual — Minimum Swaps to Make Strings Equal example:**
...
Minimum Swaps to Make Strings Equal. ([LeetCode](https://leetcode.com/problems/minimum-swaps-to-make-strings-equal))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-swaps-to-make-strings-equal) for full constraints
 ...
 */
function minimumSwapsToMakeStringsEqualBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumSwapsToMakeStringsEqual(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumSwapsToMakeStringsEqual(/* example 1 */)); // expected
// console.log(minimumSwapsToMakeStringsEqual(/* example 2 */)); // expected
// console.log(minimumSwapsToMakeStringsEqual(/* edge case */)); // expected
```
...
- [Minimum Swaps to Make Strings Equal — LeetCode](https://leetcode.com/problems/minimum-swaps-to-make-strings-equal) — problem page
