...
**Visual — Largest 3-Same-Digit Number in String example:**
...
Largest 3-Same-Digit Number in String. ([LeetCode](https://leetcode.com/problems/largest-3-same-digit-number-in-string))

Difficulty: Easy | Acceptance: 69.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-3-same-digit-number-in-string) for full constraints
 ...
 */
function largest3SameDigitNumberInStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largest3SameDigitNumberInString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largest3SameDigitNumberInString(/* example 1 */)); // expected
// console.log(largest3SameDigitNumberInString(/* example 2 */)); // expected
// console.log(largest3SameDigitNumberInString(/* edge case */)); // expected
```
...
- [Largest 3-Same-Digit Number in String — LeetCode](https://leetcode.com/problems/largest-3-same-digit-number-in-string) — problem page
