...
**Visual — String Without AAA or BBB example:**
...
String Without AAA or BBB. ([LeetCode](https://leetcode.com/problems/string-without-aaa-or-bbb))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/string-without-aaa-or-bbb) for full constraints
 ...
 */
function stringWithoutAaaOrBbbBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function stringWithoutAaaOrBbb(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(stringWithoutAaaOrBbb(/* example 1 */)); // expected
// console.log(stringWithoutAaaOrBbb(/* example 2 */)); // expected
// console.log(stringWithoutAaaOrBbb(/* edge case */)); // expected
```
...
- [String Without AAA or BBB — LeetCode](https://leetcode.com/problems/string-without-aaa-or-bbb) — problem page
