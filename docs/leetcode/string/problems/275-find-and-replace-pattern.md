...
**Visual — Find and Replace Pattern example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-and-replace-pattern) for full constraints
 ...
 */
function findAndReplacePatternBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findAndReplacePattern(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findAndReplacePattern(/* example 1 */)); // expected
// console.log(findAndReplacePattern(/* example 2 */)); // expected
// console.log(findAndReplacePattern(/* edge case */)); // expected
```
...
- [Find and Replace Pattern — LeetCode](https://leetcode.com/problems/find-and-replace-pattern) — problem page
