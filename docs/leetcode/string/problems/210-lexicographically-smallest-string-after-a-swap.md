...
# Lexicographically Smallest String After a Swap / Lexicographically Smallest String After a Swap
...
**Visual — Lexicographically Smallest String After a Swap example:**
...
Lexicographically Smallest String After a Swap. ([LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-a-swap))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lexicographically-smallest-string-after-a-swap) for full constraints
 ...
 */
function lexicographicallySmallestStringAfterASwapBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lexicographicallySmallestStringAfterASwap(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lexicographicallySmallestStringAfterASwap(/* example 1 */)); // expected
// console.log(lexicographicallySmallestStringAfterASwap(/* example 2 */)); // expected
// console.log(lexicographicallySmallestStringAfterASwap(/* edge case */)); // expected
```
...
- [Lexicographically Smallest String After a Swap — LeetCode](https://leetcode.com/problems/lexicographically-smallest-string-after-a-swap) — problem page
