...
**Visual — Check if the Sentence Is Pangram example:**
...
Check if the Sentence Is Pangram. ([LeetCode](https://leetcode.com/problems/check-if-the-sentence-is-pangram))

Difficulty: Easy | Acceptance: 83.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-the-sentence-is-pangram) for full constraints
 ...
 */
function checkIfTheSentenceIsPangramBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfTheSentenceIsPangram(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfTheSentenceIsPangram(/* example 1 */)); // expected
// console.log(checkIfTheSentenceIsPangram(/* example 2 */)); // expected
// console.log(checkIfTheSentenceIsPangram(/* edge case */)); // expected
```
...
- [Check if the Sentence Is Pangram — LeetCode](https://leetcode.com/problems/check-if-the-sentence-is-pangram) — problem page
