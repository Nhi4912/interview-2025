...
**Visual — Minimum Number of Steps to Make Two Strings Anagram example:**
...
Difficulty: Medium | Acceptance: 82.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram) for full constraints
 ...
 */
function minimumNumberOfStepsToMakeTwoStringsAnagramBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfStepsToMakeTwoStringsAnagram(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagram(/* example 1 */)); // expected
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagram(/* example 2 */)); // expected
// console.log(minimumNumberOfStepsToMakeTwoStringsAnagram(/* edge case */)); // expected
```
...
- [Minimum Number of Steps to Make Two Strings Anagram — LeetCode](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram) — problem page
