...
**Visual — Last Substring in Lexicographical Order example:**
...
Last Substring in Lexicographical Order. ([LeetCode](https://leetcode.com/problems/last-substring-in-lexicographical-order))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/last-substring-in-lexicographical-order) for full constraints
 ...
 */
function lastSubstringInLexicographicalOrderBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lastSubstringInLexicographicalOrder(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lastSubstringInLexicographicalOrder(/* example 1 */)); // expected
// console.log(lastSubstringInLexicographicalOrder(/* example 2 */)); // expected
// console.log(lastSubstringInLexicographicalOrder(/* edge case */)); // expected
```
...
- [Last Substring in Lexicographical Order — LeetCode](https://leetcode.com/problems/last-substring-in-lexicographical-order) — problem page
