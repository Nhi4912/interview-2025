...
# Minimum Number of Operations to Make Word K-Periodic / Minimum Number of Operations to Make Word K-Periodic
...
**Visual — Minimum Number of Operations to Make Word K-Periodic example:**
...
Minimum Number of Operations to Make Word K-Periodic. ([LeetCode](https://leetcode.com/problems/minimum-number-of-operations-to-make-word-k-periodic))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-operations-to-make-word-k-periodic) for full constraints
 ...
 */
function minimumNumberOfOperationsToMakeWordKPeriodicBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfOperationsToMakeWordKPeriodic(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfOperationsToMakeWordKPeriodic(/* example 1 */)); // expected
// console.log(minimumNumberOfOperationsToMakeWordKPeriodic(/* example 2 */)); // expected
// console.log(minimumNumberOfOperationsToMakeWordKPeriodic(/* edge case */)); // expected
```
...
- [Minimum Number of Operations to Make Word K-Periodic — LeetCode](https://leetcode.com/problems/minimum-number-of-operations-to-make-word-k-periodic) — problem page
