...
# Find Mirror Score of a String / Find Mirror Score of a String
...
**Visual — Find Mirror Score of a String example:**
...
Find Mirror Score of a String. ([LeetCode](https://leetcode.com/problems/find-mirror-score-of-a-string))

Difficulty: Medium | Acceptance: 33.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-mirror-score-of-a-string) for full constraints
 ...
 */
function findMirrorScoreOfAStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findMirrorScoreOfAString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findMirrorScoreOfAString(/* example 1 */)); // expected
// console.log(findMirrorScoreOfAString(/* example 2 */)); // expected
// console.log(findMirrorScoreOfAString(/* edge case */)); // expected
```
...
- [Number of Atoms](https://leetcode.com/problems/number-of-atoms) — same pattern: Stack
...
- [Find Mirror Score of a String — LeetCode](https://leetcode.com/problems/find-mirror-score-of-a-string) — problem page
