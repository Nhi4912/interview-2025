...
> **See also**: [Add Binary](https://leetcode.com/problems/add-binary) | [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii)
...
Encode Number. ([LeetCode](https://leetcode.com/problems/encode-number))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/encode-number) for full constraints
 ...
 */
function encodeNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function encodeNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(encodeNumber(/* example 1 */)); // expected
// console.log(encodeNumber(/* example 2 */)); // expected
// console.log(encodeNumber(/* edge case */)); // expected
```
...
- [Encode Number — LeetCode](https://leetcode.com/problems/encode-number) — problem page
