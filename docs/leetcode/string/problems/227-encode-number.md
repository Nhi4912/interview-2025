...
Cho số nguyên không âm `num`, mã hóa nó theo quy tắc:
...
> Như đánh địa chỉ cây trong cây nhị phân: node 0 là root (không địa chỉ), node 1 là con trái root ("0"), node 2 là con phải root ("1"), node 3,4 là con của node 1 ("00","01")... Đây chính là đường đi từ root!
...
### Giải pháp 1: Binary Trick (Tối ưu)
...
### Giải pháp 2: Đệ quy theo công thức gốc
...
### Giải pháp 3: Bitwise iteration (No toString)
