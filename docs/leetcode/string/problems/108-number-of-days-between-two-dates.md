...
**Visual — Number of Days Between Two Dates example:**
...
Number of Days Between Two Dates. ([LeetCode](https://leetcode.com/problems/number-of-days-between-two-dates))

Difficulty: Easy | Acceptance: 51.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-days-between-two-dates) for full constraints
 ...
 */
function numberOfDaysBetweenTwoDatesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfDaysBetweenTwoDates(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfDaysBetweenTwoDates(/* example 1 */)); // expected
// console.log(numberOfDaysBetweenTwoDates(/* example 2 */)); // expected
// console.log(numberOfDaysBetweenTwoDates(/* edge case */)); // expected
```
...
- [Number of Days Between Two Dates — LeetCode](https://leetcode.com/problems/number-of-days-between-two-dates) — problem page
