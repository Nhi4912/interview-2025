...
**Visual — Lexicographically Smallest Generated String example:**
...
Lexicographically Smallest Generated String. ([LeetCode](https://leetcode.com/problems/lexicographically-smallest-generated-string))

Difficulty: Hard | Acceptance: 29.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lexicographically-smallest-generated-string) for full constraints
 ...
 */
function lexicographicallySmallestGeneratedStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lexicographicallySmallestGeneratedString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lexicographicallySmallestGeneratedString(/* example 1 */)); // expected
// console.log(lexicographicallySmallestGeneratedString(/* example 2 */)); // expected
// console.log(lexicographicallySmallestGeneratedString(/* edge case */)); // expected
```
...
- [Lexicographically Smallest Generated String — LeetCode](https://leetcode.com/problems/lexicographically-smallest-generated-string) — problem page
