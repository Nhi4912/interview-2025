...
**Visual — Find the Length of the Longest Common Prefix example:**
...
Find the Length of the Longest Common Prefix. ([LeetCode](https://leetcode.com/problems/find-the-length-of-the-longest-common-prefix))

Difficulty: Medium | Acceptance: 56.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-length-of-the-longest-common-prefix) for full constraints
 ...
 */
function findTheLengthOfTheLongestCommonPrefixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheLengthOfTheLongestCommonPrefix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheLengthOfTheLongestCommonPrefix(/* example 1 */)); // expected
// console.log(findTheLengthOfTheLongestCommonPrefix(/* example 2 */)); // expected
// console.log(findTheLengthOfTheLongestCommonPrefix(/* edge case */)); // expected
```
...
- [Find the Length of the Longest Common Prefix — LeetCode](https://leetcode.com/problems/find-the-length-of-the-longest-common-prefix) — problem page
