...
**Visual — One Edit Distance example:**
...
One Edit Distance. ([LeetCode](https://leetcode.com/problems/one-edit-distance))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/one-edit-distance) for full constraints
 ...
 */
function oneEditDistanceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function oneEditDistance(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(oneEditDistance(/* example 1 */)); // expected
// console.log(oneEditDistance(/* example 2 */)); // expected
// console.log(oneEditDistance(/* edge case */)); // expected
```
...
- [One Edit Distance — LeetCode](https://leetcode.com/problems/one-edit-distance) — problem page
