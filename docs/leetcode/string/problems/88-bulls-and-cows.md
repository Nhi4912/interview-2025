...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bulls-and-cows) for full constraints
 ...
 */
function bullsAndCowsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bullsAndCows(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bullsAndCows(/* example 1 */)); // expected
// console.log(bullsAndCows(/* example 2 */)); // expected
// console.log(bullsAndCows(/* edge case */)); // expected
```
...
- [Bulls and Cows — LeetCode](https://leetcode.com/problems/bulls-and-cows) — problem page
