...
# Check if Number Has Equal Digit Count and Digit Value / Check if Number Has Equal Digit Count and Digit Value
...
**Visual — Check if Number Has Equal Digit Count and Digit Value example:**
...
Check if Number Has Equal Digit Count and Digit Value. ([LeetCode](https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value) for full constraints
 ...
 */
function checkIfNumberHasEqualDigitCountAndDigitValueBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfNumberHasEqualDigitCountAndDigitValue(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfNumberHasEqualDigitCountAndDigitValue(/* example 1 */)); // expected
// console.log(checkIfNumberHasEqualDigitCountAndDigitValue(/* example 2 */)); // expected
// console.log(checkIfNumberHasEqualDigitCountAndDigitValue(/* edge case */)); // expected
```
...
- [Check if Number Has Equal Digit Count and Digit Value — LeetCode](https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value) — problem page
