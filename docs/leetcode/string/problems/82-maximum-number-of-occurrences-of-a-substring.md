...
**Visual — Maximum Number of Occurrences of a Substring example:**
...
Difficulty: Medium | Acceptance: 53.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-occurrences-of-a-substring) for full constraints
 ...
 */
function maximumNumberOfOccurrencesOfASubstringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfOccurrencesOfASubstring(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfOccurrencesOfASubstring(/* example 1 */)); // expected
// console.log(maximumNumberOfOccurrencesOfASubstring(/* example 2 */)); // expected
// console.log(maximumNumberOfOccurrencesOfASubstring(/* edge case */)); // expected
```
...
- [Maximum Number of Occurrences of a Substring — LeetCode](https://leetcode.com/problems/maximum-number-of-occurrences-of-a-substring) — problem page
