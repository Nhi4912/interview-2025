...
Difficulty: Hard | Acceptance: 21.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/valid-number) for full constraints
 ...
 */
function validNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function validNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(validNumber(/* example 1 */)); // expected
// console.log(validNumber(/* example 2 */)); // expected
// console.log(validNumber(/* edge case */)); // expected
```
...
- [Valid Number — LeetCode](https://leetcode.com/problems/valid-number) — problem page
