...
# Check if Strings Can be Made Equal With Operations I / Check if Strings Can be Made Equal With Operations I
...
Check if Strings Can be Made Equal With Operations I. ([LeetCode](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i) for full constraints
 ...
 */
function checkIfStringsCanBeMadeEqualWithOperationsIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfStringsCanBeMadeEqualWithOperationsI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfStringsCanBeMadeEqualWithOperationsI(/* example 1 */)); // expected
// console.log(checkIfStringsCanBeMadeEqualWithOperationsI(/* example 2 */)); // expected
// console.log(checkIfStringsCanBeMadeEqualWithOperationsI(/* edge case */)); // expected
```
...
- [Check if Strings Can be Made Equal With Operations I — LeetCode](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i) — problem page
