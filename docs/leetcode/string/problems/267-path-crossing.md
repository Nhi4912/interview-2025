...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/path-crossing) for full constraints
 ...
 */
function pathCrossingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pathCrossing(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pathCrossing(/* example 1 */)); // expected
// console.log(pathCrossing(/* example 2 */)); // expected
// console.log(pathCrossing(/* edge case */)); // expected
```
...
- [Path Crossing — LeetCode](https://leetcode.com/problems/path-crossing) — problem page
