...
**Visual — Minimum Remove to Make Valid Parentheses example:**
...
Difficulty: Medium | Acceptance: 70.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-remove-to-make-valid-parentheses) for full constraints
 ...
 */
function minimumRemoveToMakeValidParenthesesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumRemoveToMakeValidParentheses(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumRemoveToMakeValidParentheses(/* example 1 */)); // expected
// console.log(minimumRemoveToMakeValidParentheses(/* example 2 */)); // expected
// console.log(minimumRemoveToMakeValidParentheses(/* edge case */)); // expected
```
...
- [Minimum Remove to Make Valid Parentheses — LeetCode](https://leetcode.com/problems/minimum-remove-to-make-valid-parentheses) — problem page
