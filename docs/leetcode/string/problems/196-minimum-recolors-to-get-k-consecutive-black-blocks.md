...
**Visual — Minimum Recolors to Get K Consecutive Black Blocks example:**
...
Minimum Recolors to Get K Consecutive Black Blocks. ([LeetCode](https://leetcode.com/problems/minimum-recolors-to-get-k-consecutive-black-blocks))

Difficulty: Easy | Acceptance: 68.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-recolors-to-get-k-consecutive-black-blocks) for full constraints
 ...
 */
function minimumRecolorsToGetKConsecutiveBlackBlocksBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumRecolorsToGetKConsecutiveBlackBlocks(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumRecolorsToGetKConsecutiveBlackBlocks(/* example 1 */)); // expected
// console.log(minimumRecolorsToGetKConsecutiveBlackBlocks(/* example 2 */)); // expected
// console.log(minimumRecolorsToGetKConsecutiveBlackBlocks(/* edge case */)); // expected
```
...
- [Minimum Recolors to Get K Consecutive Black Blocks — LeetCode](https://leetcode.com/problems/minimum-recolors-to-get-k-consecutive-black-blocks) — problem page
