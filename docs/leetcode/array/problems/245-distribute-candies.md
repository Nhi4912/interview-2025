...
**Visual — Distribute Candies example:**
...
Distribute Candies. ([LeetCode](https://leetcode.com/problems/distribute-candies))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/distribute-candies) for full constraints
 ...
 */
function distributeCandiesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function distributeCandies(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(distributeCandies(/* example 1 */)); // expected
// console.log(distributeCandies(/* example 2 */)); // expected
// console.log(distributeCandies(/* edge case */)); // expected
```
