...
**Visual — Minimum Operations to Make Array Values Equal to K example:**
...
Minimum Operations to Make Array Values Equal to K. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-make-array-values-equal-to-k))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-make-array-values-equal-to-k) for full constraints
 ...
 */
function minimumOperationsToMakeArrayValuesEqualToKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToMakeArrayValuesEqualToK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToMakeArrayValuesEqualToK(/* example 1 */)); // expected
// console.log(minimumOperationsToMakeArrayValuesEqualToK(/* example 2 */)); // expected
// console.log(minimumOperationsToMakeArrayValuesEqualToK(/* edge case */)); // expected
```
