...
**Visual — Bricks Falling When Hit example:**
...
Bricks Falling When Hit. ([LeetCode](https://leetcode.com/problems/bricks-falling-when-hit))

Difficulty: Hard | Acceptance: 35.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bricks-falling-when-hit) for full constraints
 ...
 */
function bricksFallingWhenHitBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bricksFallingWhenHit(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bricksFallingWhenHit(/* example 1 */)); // expected
// console.log(bricksFallingWhenHit(/* example 2 */)); // expected
// console.log(bricksFallingWhenHit(/* edge case */)); // expected
```
...
- [Bricks Falling When Hit — LeetCode](https://leetcode.com/problems/bricks-falling-when-hit) — problem page
