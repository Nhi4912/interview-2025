...
**Visual — Sum of Subarray Ranges example:**
...
Sum of Subarray Ranges. ([LeetCode](https://leetcode.com/problems/sum-of-subarray-ranges))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-of-subarray-ranges) for full constraints
 ...
 */
function sumOfSubarrayRangesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumOfSubarrayRanges(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumOfSubarrayRanges(/* example 1 */)); // expected
// console.log(sumOfSubarrayRanges(/* example 2 */)); // expected
// console.log(sumOfSubarrayRanges(/* edge case */)); // expected
```
...
- [Sum of Subarray Ranges — LeetCode](https://leetcode.com/problems/sum-of-subarray-ranges) — problem page
