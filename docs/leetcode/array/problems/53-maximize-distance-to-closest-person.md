...
**Analogy:** Phân tích bài "Maximize Distance to Closest Person" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Maximize Distance to Closest Person example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximize-distance-to-closest-person) for full constraints
 ...
 */
function maximizeDistanceToClosestPersonBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximizeDistanceToClosestPerson(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximizeDistanceToClosestPerson(/* example 1 */)); // expected
// console.log(maximizeDistanceToClosestPerson(/* example 2 */)); // expected
// console.log(maximizeDistanceToClosestPerson(/* edge case */)); // expected
```
...
- [Maximize Distance to Closest Person — LeetCode](https://leetcode.com/problems/maximize-distance-to-closest-person) — problem page
