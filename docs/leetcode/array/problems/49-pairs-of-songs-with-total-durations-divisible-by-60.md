...
**Visual — Pairs of Songs With Total Durations Divisible by 60 example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pairs-of-songs-with-total-durations-divisible-by-60) for full constraints
 ...
 */
function pairsOfSongsWithTotalDurationsDivisibleBy60BruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pairsOfSongsWithTotalDurationsDivisibleBy60(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pairsOfSongsWithTotalDurationsDivisibleBy60(/* example 1 */)); // expected
// console.log(pairsOfSongsWithTotalDurationsDivisibleBy60(/* example 2 */)); // expected
// console.log(pairsOfSongsWithTotalDurationsDivisibleBy60(/* edge case */)); // expected
```
...
- [Pairs of Songs With Total Durations Divisible by 60 — LeetCode](https://leetcode.com/problems/pairs-of-songs-with-total-durations-divisible-by-60) — problem page
