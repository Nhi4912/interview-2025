...
**Analogy:** Phân tích bài "Maximum Value of an Ordered Triplet II" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Maximum Value of an Ordered Triplet II example:**
...
Maximum Value of an Ordered Triplet II. ([LeetCode](https://leetcode.com/problems/maximum-value-of-an-ordered-triplet-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-value-of-an-ordered-triplet-ii) for full constraints
 ...
 */
function maximumValueOfAnOrderedTripletIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumValueOfAnOrderedTripletIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumValueOfAnOrderedTripletIi(/* example 1 */)); // expected
// console.log(maximumValueOfAnOrderedTripletIi(/* example 2 */)); // expected
// console.log(maximumValueOfAnOrderedTripletIi(/* edge case */)); // expected
```
...
- [Maximum Value of an Ordered Triplet II — LeetCode](https://leetcode.com/problems/maximum-value-of-an-ordered-triplet-ii) — problem page
