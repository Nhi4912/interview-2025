...
**Analogy:** Phân tích bài "Maximum Ascending Subarray Sum" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Maximum Ascending Subarray Sum example:**
...
Maximum Ascending Subarray Sum. ([LeetCode](https://leetcode.com/problems/maximum-ascending-subarray-sum))

Difficulty: Easy | Acceptance: 66.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-ascending-subarray-sum) for full constraints
 ...
 */
function maximumAscendingSubarraySumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumAscendingSubarraySum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumAscendingSubarraySum(/* example 1 */)); // expected
// console.log(maximumAscendingSubarraySum(/* example 2 */)); // expected
// console.log(maximumAscendingSubarraySum(/* edge case */)); // expected
```
...
- [Maximum Ascending Subarray Sum — LeetCode](https://leetcode.com/problems/maximum-ascending-subarray-sum) — problem page
