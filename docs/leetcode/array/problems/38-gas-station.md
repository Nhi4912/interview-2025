...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/gas-station) for full constraints
 ...
 */
function gasStationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gasStation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gasStation(/* example 1 */)); // expected
// console.log(gasStation(/* example 2 */)); // expected
// console.log(gasStation(/* edge case */)); // expected
```
...
- [Gas Station — LeetCode](https://leetcode.com/problems/gas-station) — problem page
