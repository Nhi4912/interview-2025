...
**Visual — Check If It Is a Straight Line example:**
...
Check If It Is a Straight Line. ([LeetCode](https://leetcode.com/problems/check-if-it-is-a-straight-line))

Difficulty: Easy | Acceptance: 39.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-it-is-a-straight-line) for full constraints
 ...
 */
function checkIfItIsAStraightLineBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfItIsAStraightLine(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfItIsAStraightLine(/* example 1 */)); // expected
// console.log(checkIfItIsAStraightLine(/* example 2 */)); // expected
// console.log(checkIfItIsAStraightLine(/* edge case */)); // expected
```
...
- [Check If It Is a Straight Line — LeetCode](https://leetcode.com/problems/check-if-it-is-a-straight-line) — problem page
