...
**Analogy:** Phân tích bài "Find the Winner of an Array Game" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find the Winner of an Array Game example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-winner-of-an-array-game) for full constraints
 ...
 */
function findTheWinnerOfAnArrayGameBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheWinnerOfAnArrayGame(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheWinnerOfAnArrayGame(/* example 1 */)); // expected
// console.log(findTheWinnerOfAnArrayGame(/* example 2 */)); // expected
// console.log(findTheWinnerOfAnArrayGame(/* edge case */)); // expected
```
...
- [Find the Winner of an Array Game — LeetCode](https://leetcode.com/problems/find-the-winner-of-an-array-game) — problem page
