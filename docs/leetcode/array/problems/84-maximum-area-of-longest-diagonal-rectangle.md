...
**Analogy:** Phân tích bài "Maximum Area of Longest Diagonal Rectangle" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Maximum Area of Longest Diagonal Rectangle example:**
...
Maximum Area of Longest Diagonal Rectangle. ([LeetCode](https://leetcode.com/problems/maximum-area-of-longest-diagonal-rectangle))

Difficulty: Easy | Acceptance: 36.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-area-of-longest-diagonal-rectangle) for full constraints
 ...
 */
function maximumAreaOfLongestDiagonalRectangleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumAreaOfLongestDiagonalRectangle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumAreaOfLongestDiagonalRectangle(/* example 1 */)); // expected
// console.log(maximumAreaOfLongestDiagonalRectangle(/* example 2 */)); // expected
// console.log(maximumAreaOfLongestDiagonalRectangle(/* edge case */)); // expected
```
...
- [Maximum Area of Longest Diagonal Rectangle — LeetCode](https://leetcode.com/problems/maximum-area-of-longest-diagonal-rectangle) — problem page
