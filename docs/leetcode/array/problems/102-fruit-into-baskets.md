...
**Visual — Fruit Into Baskets example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/fruit-into-baskets) for full constraints
 ...
 */
function fruitIntoBasketsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function fruitIntoBaskets(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(fruitIntoBaskets(/* example 1 */)); // expected
// console.log(fruitIntoBaskets(/* example 2 */)); // expected
// console.log(fruitIntoBaskets(/* edge case */)); // expected
```
...
- [Fruit Into Baskets — LeetCode](https://leetcode.com/problems/fruit-into-baskets) — problem page
