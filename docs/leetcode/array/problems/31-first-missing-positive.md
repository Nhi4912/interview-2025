...
> **Track**: Shared | **Difficulty**: 🔴 Hard | **Pattern**: Hash Map
...
**Visual — First Missing Positive example:**
...
Difficulty: Hard | Acceptance: 41.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/first-missing-positive) for full constraints
 ...
 */
function firstMissingPositiveBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function firstMissingPositive(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(firstMissingPositive(/* example 1 */)); // expected
// console.log(firstMissingPositive(/* example 2 */)); // expected
// console.log(firstMissingPositive(/* edge case */)); // expected
```
...
- [Degree of an Array](https://leetcode.com/problems/degree-of-an-array) — same pattern: Hash Map
- [First Missing Positive — LeetCode](https://leetcode.com/problems/first-missing-positive) — problem page
