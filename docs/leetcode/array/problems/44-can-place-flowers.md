...
**Visual — Can Place Flowers example:**
...
Difficulty: Easy | Acceptance: 28.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/can-place-flowers) for full constraints
 ...
 */
function canPlaceFlowersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function canPlaceFlowers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(canPlaceFlowers(/* example 1 */)); // expected
// console.log(canPlaceFlowers(/* example 2 */)); // expected
// console.log(canPlaceFlowers(/* edge case */)); // expected
```
...
- [Can Place Flowers — LeetCode](https://leetcode.com/problems/can-place-flowers) — problem page
