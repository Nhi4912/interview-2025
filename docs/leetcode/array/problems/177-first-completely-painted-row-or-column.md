...
# First Completely Painted Row or Column / First Completely Painted Row or Column
...
First Completely Painted Row or Column. ([LeetCode](https://leetcode.com/problems/first-completely-painted-row-or-column))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/first-completely-painted-row-or-column) for full constraints
 ...
 */
function firstCompletelyPaintedRowOrColumnBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function firstCompletelyPaintedRowOrColumn(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(firstCompletelyPaintedRowOrColumn(/* example 1 */)); // expected
// console.log(firstCompletelyPaintedRowOrColumn(/* example 2 */)); // expected
// console.log(firstCompletelyPaintedRowOrColumn(/* edge case */)); // expected
```
...
- [First Completely Painted Row or Column — LeetCode](https://leetcode.com/problems/first-completely-painted-row-or-column) — problem page
