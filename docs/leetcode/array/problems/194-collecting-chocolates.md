...
**Analogy:** Phân tích bài "Collecting Chocolates" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Collecting Chocolates example:**
...
Collecting Chocolates. ([LeetCode](https://leetcode.com/problems/collecting-chocolates))

Difficulty: Medium | Acceptance: 33.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/collecting-chocolates) for full constraints
 ...
 */
function collectingChocolatesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function collectingChocolates(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(collectingChocolates(/* example 1 */)); // expected
// console.log(collectingChocolates(/* example 2 */)); // expected
// console.log(collectingChocolates(/* edge case */)); // expected
```
...
- [Coordinate With Maximum Network Quality](https://leetcode.com/problems/coordinate-with-maximum-network-quality) — same pattern: Array
...
- [Collecting Chocolates — LeetCode](https://leetcode.com/problems/collecting-chocolates) — problem page
