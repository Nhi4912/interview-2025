...
**Visual — Count Number of Pairs With Absolute Difference K example:**
...
Count Number of Pairs With Absolute Difference K. ([LeetCode](https://leetcode.com/problems/count-number-of-pairs-with-absolute-difference-k))

Difficulty: Easy | Acceptance: 84.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-number-of-pairs-with-absolute-difference-k) for full constraints
 ...
 */
function countNumberOfPairsWithAbsoluteDifferenceKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countNumberOfPairsWithAbsoluteDifferenceK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countNumberOfPairsWithAbsoluteDifferenceK(/* example 1 */)); // expected
// console.log(countNumberOfPairsWithAbsoluteDifferenceK(/* example 2 */)); // expected
// console.log(countNumberOfPairsWithAbsoluteDifferenceK(/* edge case */)); // expected
```
...
- [Count Number of Pairs With Absolute Difference K — LeetCode](https://leetcode.com/problems/count-number-of-pairs-with-absolute-difference-k) — problem page
