...
Sum of Distances. ([LeetCode](https://leetcode.com/problems/sum-of-distances))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-of-distances) for full constraints
 ...
 */
function sumOfDistancesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumOfDistances(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumOfDistances(/* example 1 */)); // expected
// console.log(sumOfDistances(/* example 2 */)); // expected
// console.log(sumOfDistances(/* edge case */)); // expected
```
...
- [Sum of Distances — LeetCode](https://leetcode.com/problems/sum-of-distances) — problem page
