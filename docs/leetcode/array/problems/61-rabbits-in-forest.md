...
> **See also**: [Smallest Missing Non-negative Integer After Operations](https://leetcode.com/problems/smallest-missing-non-negative-integer-after-operations) | [Missing Number](https://leetcode.com/problems/missing-number)
...
**Visual — Rabbits in Forest example:**
...
Rabbits in Forest. ([LeetCode](https://leetcode.com/problems/rabbits-in-forest))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rabbits-in-forest) for full constraints
 ...
 */
function rabbitsInForestBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rabbitsInForest(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rabbitsInForest(/* example 1 */)); // expected
// console.log(rabbitsInForest(/* example 2 */)); // expected
// console.log(rabbitsInForest(/* edge case */)); // expected
```
...
- [Rabbits in Forest — LeetCode](https://leetcode.com/problems/rabbits-in-forest) — problem page
