...
# Minimum Operations to Collect Elements / Minimum Operations to Collect Elements
...
**Visual — Minimum Operations to Collect Elements example:**
...
Minimum Operations to Collect Elements. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-collect-elements))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-collect-elements) for full constraints
 ...
 */
function minimumOperationsToCollectElementsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToCollectElements(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToCollectElements(/* example 1 */)); // expected
// console.log(minimumOperationsToCollectElements(/* example 2 */)); // expected
// console.log(minimumOperationsToCollectElements(/* edge case */)); // expected
```
...
- [Minimum Operations to Collect Elements — LeetCode](https://leetcode.com/problems/minimum-operations-to-collect-elements) — problem page
