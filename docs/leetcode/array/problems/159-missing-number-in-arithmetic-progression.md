...
Missing Number In Arithmetic Progression. ([LeetCode](https://leetcode.com/problems/missing-number-in-arithmetic-progression))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/missing-number-in-arithmetic-progression) for full constraints
 ...
 */
function missingNumberInArithmeticProgressionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function missingNumberInArithmeticProgression(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(missingNumberInArithmeticProgression(/* example 1 */)); // expected
// console.log(missingNumberInArithmeticProgression(/* example 2 */)); // expected
// console.log(missingNumberInArithmeticProgression(/* edge case */)); // expected
```
...
- [Missing Number In Arithmetic Progression — LeetCode](https://leetcode.com/problems/missing-number-in-arithmetic-progression) — problem page
