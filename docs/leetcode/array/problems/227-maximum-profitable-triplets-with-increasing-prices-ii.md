...
# Maximum Profitable Triplets With Increasing Prices II / Maximum Profitable Triplets With Increasing Prices II
...
**Visual — Maximum Profitable Triplets With Increasing Prices II example:**
...
Maximum Profitable Triplets With Increasing Prices II. ([LeetCode](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-ii))

Difficulty: Hard | Acceptance: 43.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-ii) for full constraints
 ...
 */
function maximumProfitableTripletsWithIncreasingPricesIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumProfitableTripletsWithIncreasingPricesIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumProfitableTripletsWithIncreasingPricesIi(/* example 1 */)); // expected
// console.log(maximumProfitableTripletsWithIncreasingPricesIi(/* example 2 */)); // expected
// console.log(maximumProfitableTripletsWithIncreasingPricesIi(/* edge case */)); // expected
```
...
- [Maximum Profitable Triplets With Increasing Prices II — LeetCode](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-ii) — problem page
