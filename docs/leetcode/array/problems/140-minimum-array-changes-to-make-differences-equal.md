...
# Minimum Array Changes to Make Differences Equal / Minimum Array Changes to Make Differences Equal
...
Minimum Array Changes to Make Differences Equal. ([LeetCode](https://leetcode.com/problems/minimum-array-changes-to-make-differences-equal))

Difficulty: Medium | Acceptance: 23.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-array-changes-to-make-differences-equal) for full constraints
 ...
 */
function minimumArrayChangesToMakeDifferencesEqualBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumArrayChangesToMakeDifferencesEqual(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumArrayChangesToMakeDifferencesEqual(/* example 1 */)); // expected
// console.log(minimumArrayChangesToMakeDifferencesEqual(/* example 2 */)); // expected
// console.log(minimumArrayChangesToMakeDifferencesEqual(/* edge case */)); // expected
```
...
- [Minimum Array Changes to Make Differences Equal — LeetCode](https://leetcode.com/problems/minimum-array-changes-to-make-differences-equal) — problem page
