...
**Analogy:** Phân tích bài "Reshape the Matrix" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Reshape the Matrix example:**
...
Reshape the Matrix. ([LeetCode](https://leetcode.com/problems/reshape-the-matrix))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reshape-the-matrix) for full constraints
 ...
 */
function reshapeTheMatrixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reshapeTheMatrix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reshapeTheMatrix(/* example 1 */)); // expected
// console.log(reshapeTheMatrix(/* example 2 */)); // expected
// console.log(reshapeTheMatrix(/* edge case */)); // expected
```
...
- [Reshape the Matrix — LeetCode](https://leetcode.com/problems/reshape-the-matrix) — problem page
