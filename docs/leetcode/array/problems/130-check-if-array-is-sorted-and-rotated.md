...
**Analogy:** Phân tích bài "Check if Array Is Sorted and Rotated" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Check if Array Is Sorted and Rotated example:**
...
Check if Array Is Sorted and Rotated. ([LeetCode](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated))

Difficulty: Easy | Acceptance: 55.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated) for full constraints
 ...
 */
function checkIfArrayIsSortedAndRotatedBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfArrayIsSortedAndRotated(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfArrayIsSortedAndRotated(/* example 1 */)); // expected
// console.log(checkIfArrayIsSortedAndRotated(/* example 2 */)); // expected
// console.log(checkIfArrayIsSortedAndRotated(/* edge case */)); // expected
```
...
- [Check if Array Is Sorted and Rotated — LeetCode](https://leetcode.com/problems/check-if-array-is-sorted-and-rotated) — problem page
