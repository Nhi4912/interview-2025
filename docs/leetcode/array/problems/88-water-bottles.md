...
Water Bottles. ([LeetCode](https://leetcode.com/problems/water-bottles))

Difficulty: Easy | Acceptance: 70.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/water-bottles) for full constraints
 ...
 */
function waterBottlesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function waterBottles(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(waterBottles(/* example 1 */)); // expected
// console.log(waterBottles(/* example 2 */)); // expected
// console.log(waterBottles(/* edge case */)); // expected
```
...
- [Water Bottles — LeetCode](https://leetcode.com/problems/water-bottles) — problem page
