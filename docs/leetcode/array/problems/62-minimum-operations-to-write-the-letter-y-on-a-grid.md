...
# Minimum Operations to Write the Letter Y on a Grid / Minimum Operations to Write the Letter Y on a Grid
...
**Visual — Minimum Operations to Write the Letter Y on a Grid example:**
...
Minimum Operations to Write the Letter Y on a Grid. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-write-the-letter-y-on-a-grid))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-write-the-letter-y-on-a-grid) for full constraints
 ...
 */
function minimumOperationsToWriteTheLetterYOnAGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToWriteTheLetterYOnAGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToWriteTheLetterYOnAGrid(/* example 1 */)); // expected
// console.log(minimumOperationsToWriteTheLetterYOnAGrid(/* example 2 */)); // expected
// console.log(minimumOperationsToWriteTheLetterYOnAGrid(/* edge case */)); // expected
```
...
- [Minimum Operations to Write the Letter Y on a Grid — LeetCode](https://leetcode.com/problems/minimum-operations-to-write-the-letter-y-on-a-grid) — problem page
