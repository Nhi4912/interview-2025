...
**Analogy:** Phân tích bài "Image Smoother" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/image-smoother) for full constraints
 ...
 */
function imageSmootherBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function imageSmoother(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(imageSmoother(/* example 1 */)); // expected
// console.log(imageSmoother(/* example 2 */)); // expected
// console.log(imageSmoother(/* edge case */)); // expected
```
...
- [Image Smoother — LeetCode](https://leetcode.com/problems/image-smoother) — problem page
