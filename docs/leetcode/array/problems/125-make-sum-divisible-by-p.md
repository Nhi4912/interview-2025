...
**Visual — Make Sum Divisible by P example:**
...
Make Sum Divisible by P. ([LeetCode](https://leetcode.com/problems/make-sum-divisible-by-p))

Difficulty: Medium | Acceptance: 39.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/make-sum-divisible-by-p) for full constraints
 ...
 */
function makeSumDivisibleByPBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function makeSumDivisibleByP(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(makeSumDivisibleByP(/* example 1 */)); // expected
// console.log(makeSumDivisibleByP(/* example 2 */)); // expected
// console.log(makeSumDivisibleByP(/* edge case */)); // expected
```
...
- [Make Sum Divisible by P — LeetCode](https://leetcode.com/problems/make-sum-divisible-by-p) — problem page
