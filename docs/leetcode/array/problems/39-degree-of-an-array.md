...
**Visual — Degree of an Array example:**
...
Degree of an Array. ([LeetCode](https://leetcode.com/problems/degree-of-an-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/degree-of-an-array) for full constraints
 ...
 */
function degreeOfAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function degreeOfAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(degreeOfAnArray(/* example 1 */)); // expected
// console.log(degreeOfAnArray(/* example 2 */)); // expected
// console.log(degreeOfAnArray(/* edge case */)); // expected
```
...
- [Degree of an Array — LeetCode](https://leetcode.com/problems/degree-of-an-array) — problem page
