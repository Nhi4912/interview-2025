...
> **See also**: [Number of Flowers in Full Bloom](https://leetcode.com/problems/number-of-flowers-in-full-bloom) | [Subarray Sums Divisible by K](https://leetcode.com/problems/subarray-sums-divisible-by-k)
...
**Visual — Subarray Sum Equals K example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/subarray-sum-equals-k) for full constraints
 ...
 */
function subarraySumEqualsKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function subarraySumEqualsK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(subarraySumEqualsK(/* example 1 */)); // expected
// console.log(subarraySumEqualsK(/* example 2 */)); // expected
// console.log(subarraySumEqualsK(/* edge case */)); // expected
```
...
- [Subarray Sum Equals K — LeetCode](https://leetcode.com/problems/subarray-sum-equals-k) — problem page
