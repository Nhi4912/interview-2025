...
**Visual — Minimum Area Rectangle II example:**
...
Minimum Area Rectangle II. ([LeetCode](https://leetcode.com/problems/minimum-area-rectangle-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-area-rectangle-ii) for full constraints
 ...
 */
function minimumAreaRectangleIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumAreaRectangleIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumAreaRectangleIi(/* example 1 */)); // expected
// console.log(minimumAreaRectangleIi(/* example 2 */)); // expected
// console.log(minimumAreaRectangleIi(/* edge case */)); // expected
```
...
- [Minimum Area Rectangle II — LeetCode](https://leetcode.com/problems/minimum-area-rectangle-ii) — problem page
