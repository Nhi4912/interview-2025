...
# Pass the Pillow / Pass the Pillow
...
**Visual — Pass the Pillow example:**
...
Pass the Pillow. ([LeetCode](https://leetcode.com/problems/pass-the-pillow))

Difficulty: Easy | Acceptance: 56.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pass-the-pillow) for full constraints
 ...
 */
function passThePillowBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function passThePillow(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(passThePillow(/* example 1 */)); // expected
// console.log(passThePillow(/* example 2 */)); // expected
// console.log(passThePillow(/* edge case */)); // expected
```
...
- [Pass the Pillow — LeetCode](https://leetcode.com/problems/pass-the-pillow) — problem page
