...
Difficulty: Medium | Acceptance: 85.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-operations-to-make-array-xor-equal-to-k) for full constraints
 ...
 */
function minimumNumberOfOperationsToMakeArrayXorEqualToKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfOperationsToMakeArrayXorEqualToK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfOperationsToMakeArrayXorEqualToK(/* example 1 */)); // expected
// console.log(minimumNumberOfOperationsToMakeArrayXorEqualToK(/* example 2 */)); // expected
// console.log(minimumNumberOfOperationsToMakeArrayXorEqualToK(/* edge case */)); // expected
```
...
- [Minimum Number of Operations to Make Array XOR Equal to K — LeetCode](https://leetcode.com/problems/minimum-number-of-operations-to-make-array-xor-equal-to-k) — problem page
