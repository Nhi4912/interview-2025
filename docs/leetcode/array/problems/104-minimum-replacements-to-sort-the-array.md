...
# Minimum Replacements to Sort the Array / Minimum Replacements to Sort the Array
...
**Visual — Minimum Replacements to Sort the Array example:**
...
Minimum Replacements to Sort the Array. ([LeetCode](https://leetcode.com/problems/minimum-replacements-to-sort-the-array))

Difficulty: Hard | Acceptance: 53.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-replacements-to-sort-the-array) for full constraints
 ...
 */
function minimumReplacementsToSortTheArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumReplacementsToSortTheArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumReplacementsToSortTheArray(/* example 1 */)); // expected
// console.log(minimumReplacementsToSortTheArray(/* example 2 */)); // expected
// console.log(minimumReplacementsToSortTheArray(/* edge case */)); // expected
```
...
- [Minimum Replacements to Sort the Array — LeetCode](https://leetcode.com/problems/minimum-replacements-to-sort-the-array) — problem page
