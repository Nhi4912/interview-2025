...
**Visual — Exclusive Time of Functions example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/exclusive-time-of-functions) for full constraints
 ...
 */
function exclusiveTimeOfFunctionsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function exclusiveTimeOfFunctions(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(exclusiveTimeOfFunctions(/* example 1 */)); // expected
// console.log(exclusiveTimeOfFunctions(/* example 2 */)); // expected
// console.log(exclusiveTimeOfFunctions(/* edge case */)); // expected
```
...
- [Exclusive Time of Functions — LeetCode](https://leetcode.com/problems/exclusive-time-of-functions) — problem page
