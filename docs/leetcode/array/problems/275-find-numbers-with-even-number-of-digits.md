...
**Visual — Find Numbers with Even Number of Digits example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-numbers-with-even-number-of-digits) for full constraints
 ...
 */
function findNumbersWithEvenNumberOfDigitsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findNumbersWithEvenNumberOfDigits(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findNumbersWithEvenNumberOfDigits(/* example 1 */)); // expected
// console.log(findNumbersWithEvenNumberOfDigits(/* example 2 */)); // expected
// console.log(findNumbersWithEvenNumberOfDigits(/* edge case */)); // expected
```
...
- [Find Numbers with Even Number of Digits — LeetCode](https://leetcode.com/problems/find-numbers-with-even-number-of-digits) — problem page
