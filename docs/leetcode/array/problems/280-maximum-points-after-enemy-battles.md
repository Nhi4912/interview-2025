...
category: Array
tags: [Array, Greedy]
leetcode_url: "https://leetcode.com/problems/maximum-points-after-enemy-battles"
---

# Maximum Points After Enemy Battles / Maximum Points After Enemy Battles
...
**Visual — Maximum Points After Enemy Battles example:**
...
Maximum Points After Enemy Battles. ([LeetCode](https://leetcode.com/problems/maximum-points-after-enemy-battles))

Difficulty: Medium | Acceptance: 32.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-points-after-enemy-battles) for full constraints
 ...
 */
function maximumPointsAfterEnemyBattlesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumPointsAfterEnemyBattles(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumPointsAfterEnemyBattles(/* example 1 */)); // expected
// console.log(maximumPointsAfterEnemyBattles(/* example 2 */)); // expected
// console.log(maximumPointsAfterEnemyBattles(/* edge case */)); // expected
```
...
- [Maximum Points After Enemy Battles — LeetCode](https://leetcode.com/problems/maximum-points-after-enemy-battles) — problem page
