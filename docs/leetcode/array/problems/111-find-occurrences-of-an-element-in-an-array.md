...
# Find Occurrences of an Element in an Array / Find Occurrences of an Element in an Array
...
**Visual — Find Occurrences of an Element in an Array example:**
...
Find Occurrences of an Element in an Array. ([LeetCode](https://leetcode.com/problems/find-occurrences-of-an-element-in-an-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-occurrences-of-an-element-in-an-array) for full constraints
 ...
 */
function findOccurrencesOfAnElementInAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findOccurrencesOfAnElementInAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findOccurrencesOfAnElementInAnArray(/* example 1 */)); // expected
// console.log(findOccurrencesOfAnElementInAnArray(/* example 2 */)); // expected
// console.log(findOccurrencesOfAnElementInAnArray(/* edge case */)); // expected
```
...
- [Find Occurrences of an Element in an Array — LeetCode](https://leetcode.com/problems/find-occurrences-of-an-element-in-an-array) — problem page
