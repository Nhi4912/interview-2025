...
# Count Alternating Subarrays / Count Alternating Subarrays
...
Count Alternating Subarrays. ([LeetCode](https://leetcode.com/problems/count-alternating-subarrays))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-alternating-subarrays) for full constraints
 ...
 */
function countAlternatingSubarraysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countAlternatingSubarrays(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countAlternatingSubarrays(/* example 1 */)); // expected
// console.log(countAlternatingSubarrays(/* example 2 */)); // expected
// console.log(countAlternatingSubarrays(/* edge case */)); // expected
```
...
- [Count Alternating Subarrays — LeetCode](https://leetcode.com/problems/count-alternating-subarrays) — problem page
