...
# Maximum Profitable Triplets With Increasing Prices I / Maximum Profitable Triplets With Increasing Prices I
...
**Visual — Maximum Profitable Triplets With Increasing Prices I example:**
...
Maximum Profitable Triplets With Increasing Prices I. ([LeetCode](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-i))

Difficulty: Medium | Acceptance: 54.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-i) for full constraints
 ...
 */
function maximumProfitableTripletsWithIncreasingPricesIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumProfitableTripletsWithIncreasingPricesI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumProfitableTripletsWithIncreasingPricesI(/* example 1 */)); // expected
// console.log(maximumProfitableTripletsWithIncreasingPricesI(/* example 2 */)); // expected
// console.log(maximumProfitableTripletsWithIncreasingPricesI(/* edge case */)); // expected
```
...
- [Maximum Profitable Triplets With Increasing Prices I — LeetCode](https://leetcode.com/problems/maximum-profitable-triplets-with-increasing-prices-i) — problem page
