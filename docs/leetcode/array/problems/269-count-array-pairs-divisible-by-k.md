...
Count Array Pairs Divisible by K. ([LeetCode](https://leetcode.com/problems/count-array-pairs-divisible-by-k))

Difficulty: Hard | Acceptance: 30.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-array-pairs-divisible-by-k) for full constraints
 ...
 */
function countArrayPairsDivisibleByKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countArrayPairsDivisibleByK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countArrayPairsDivisibleByK(/* example 1 */)); // expected
// console.log(countArrayPairsDivisibleByK(/* example 2 */)); // expected
// console.log(countArrayPairsDivisibleByK(/* edge case */)); // expected
```
...
- [Count Array Pairs Divisible by K — LeetCode](https://leetcode.com/problems/count-array-pairs-divisible-by-k) — problem page
