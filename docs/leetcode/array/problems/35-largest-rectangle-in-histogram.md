...
> **See also**: [Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle) | [Next Greater Element I](https://leetcode.com/problems/next-greater-element-i)
...
**Visual — Largest Rectangle in Histogram example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-rectangle-in-histogram) for full constraints
 ...
 */
function largestRectangleInHistogramBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestRectangleInHistogram(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestRectangleInHistogram(/* example 1 */)); // expected
// console.log(largestRectangleInHistogram(/* example 2 */)); // expected
// console.log(largestRectangleInHistogram(/* edge case */)); // expected
```
...
- [Largest Rectangle in Histogram — LeetCode](https://leetcode.com/problems/largest-rectangle-in-histogram) — problem page
