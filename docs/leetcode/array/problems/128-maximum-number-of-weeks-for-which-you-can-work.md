...
**Visual — Maximum Number of Weeks for Which You Can Work example:**
...
Maximum Number of Weeks for Which You Can Work. ([LeetCode](https://leetcode.com/problems/maximum-number-of-weeks-for-which-you-can-work))

Difficulty: Medium | Acceptance: 41.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-weeks-for-which-you-can-work) for full constraints
 ...
 */
function maximumNumberOfWeeksForWhichYouCanWorkBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfWeeksForWhichYouCanWork(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfWeeksForWhichYouCanWork(/* example 1 */)); // expected
// console.log(maximumNumberOfWeeksForWhichYouCanWork(/* example 2 */)); // expected
// console.log(maximumNumberOfWeeksForWhichYouCanWork(/* edge case */)); // expected
```
...
- [Maximum Number of Weeks for Which You Can Work — LeetCode](https://leetcode.com/problems/maximum-number-of-weeks-for-which-you-can-work) — problem page
