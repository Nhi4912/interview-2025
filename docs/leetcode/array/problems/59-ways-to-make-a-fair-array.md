...
**Visual — Ways to Make a Fair Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/ways-to-make-a-fair-array) for full constraints
 ...
 */
function waysToMakeAFairArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function waysToMakeAFairArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(waysToMakeAFairArray(/* example 1 */)); // expected
// console.log(waysToMakeAFairArray(/* example 2 */)); // expected
// console.log(waysToMakeAFairArray(/* edge case */)); // expected
```
...
- [Ways to Make a Fair Array — LeetCode](https://leetcode.com/problems/ways-to-make-a-fair-array) — problem page
