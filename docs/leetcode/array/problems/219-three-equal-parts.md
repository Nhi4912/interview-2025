...
**Visual — Three Equal Parts example:**
...
Three Equal Parts. ([LeetCode](https://leetcode.com/problems/three-equal-parts))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/three-equal-parts) for full constraints
 ...
 */
function threeEqualPartsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function threeEqualParts(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(threeEqualParts(/* example 1 */)); // expected
// console.log(threeEqualParts(/* example 2 */)); // expected
// console.log(threeEqualParts(/* edge case */)); // expected
```
...
- [Three Equal Parts — LeetCode](https://leetcode.com/problems/three-equal-parts) — problem page
