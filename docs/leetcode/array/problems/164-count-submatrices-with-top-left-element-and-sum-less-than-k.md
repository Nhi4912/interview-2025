...
> **See also**: [Range Sum Query 2D - Immutable](https://leetcode.com/problems/range-sum-query-2d-immutable) | [Maximum Sum of an Hourglass](https://leetcode.com/problems/maximum-sum-of-an-hourglass)
...
Count Submatrices with Top-Left Element and Sum Less Than k. ([LeetCode](https://leetcode.com/problems/count-submatrices-with-top-left-element-and-sum-less-than-k))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-submatrices-with-top-left-element-and-sum-less-than-k) for full constraints
 ...
 */
function countSubmatricesWithTopLeftElementAndSumLessThanKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countSubmatricesWithTopLeftElementAndSumLessThanK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countSubmatricesWithTopLeftElementAndSumLessThanK(/* example 1 */)); // expected
// console.log(countSubmatricesWithTopLeftElementAndSumLessThanK(/* example 2 */)); // expected
// console.log(countSubmatricesWithTopLeftElementAndSumLessThanK(/* edge case */)); // expected
```
...
- [Maximum Sum of an Hourglass](https://leetcode.com/problems/maximum-sum-of-an-hourglass) — same pattern: Prefix Sum
...
- [Count Submatrices with Top-Left Element and Sum Less Than k — LeetCode](https://leetcode.com/problems/count-submatrices-with-top-left-element-and-sum-less-than-k) — problem page
