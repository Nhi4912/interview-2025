...
🟡 Medium | 🏷️ Array, Matrix, Prefix Sum | 🔗 [LeetCode](https://leetcode.com/problems/count-submatrices-with-top-left-element-and-sum-less-than-k)

## 🧠 Intuition / Trực Giác

**Tiếng Việt:** Vì tất cả ma trận con đều phải chứa phần tử góc trên trái (0,0), chỉ cần xây dựng prefix sum 2D. Mỗi ô (i,j) trong prefix sum là tổng của hình chữ nhật từ (0,0) đến (i,j). Đếm số ô có prefix[i][j] < k.
...
### Solution 1: 2D Prefix Sum (Optimal)
...
### Solution 2: In-Place Prefix Sum (Space Optimized)
...
### Solution 3: Row-by-Row Prefix (Combined)
