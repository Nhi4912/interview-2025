...
# Maximize Score After Pair Deletions / Maximize Score After Pair Deletions
...
**Visual — Maximize Score After Pair Deletions example:**
...
Maximize Score After Pair Deletions. ([LeetCode](https://leetcode.com/problems/maximize-score-after-pair-deletions))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximize-score-after-pair-deletions) for full constraints
 ...
 */
function maximizeScoreAfterPairDeletionsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximizeScoreAfterPairDeletions(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximizeScoreAfterPairDeletions(/* example 1 */)); // expected
// console.log(maximizeScoreAfterPairDeletions(/* example 2 */)); // expected
// console.log(maximizeScoreAfterPairDeletions(/* edge case */)); // expected
```
...
- [Maximize Score After Pair Deletions — LeetCode](https://leetcode.com/problems/maximize-score-after-pair-deletions) — problem page
