...
Squirrel Simulation. ([LeetCode](https://leetcode.com/problems/squirrel-simulation))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/squirrel-simulation) for full constraints
 ...
 */
function squirrelSimulationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function squirrelSimulation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(squirrelSimulation(/* example 1 */)); // expected
// console.log(squirrelSimulation(/* example 2 */)); // expected
// console.log(squirrelSimulation(/* edge case */)); // expected
```
...
- [Squirrel Simulation — LeetCode](https://leetcode.com/problems/squirrel-simulation) — problem page
