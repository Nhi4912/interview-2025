...
category: Array
tags: [Array, Math]
leetcode_url: "https://leetcode.com/problems/find-palindrome-with-fixed-length"
---
...
**Visual — Find Palindrome With Fixed Length example:**
...
Find Palindrome With Fixed Length. ([LeetCode](https://leetcode.com/problems/find-palindrome-with-fixed-length))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-palindrome-with-fixed-length) for full constraints
 ...
 */
function findPalindromeWithFixedLengthBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findPalindromeWithFixedLength(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findPalindromeWithFixedLength(/* example 1 */)); // expected
// console.log(findPalindromeWithFixedLength(/* example 2 */)); // expected
// console.log(findPalindromeWithFixedLength(/* edge case */)); // expected
```
...
- [Find Palindrome With Fixed Length — LeetCode](https://leetcode.com/problems/find-palindrome-with-fixed-length) — problem page
