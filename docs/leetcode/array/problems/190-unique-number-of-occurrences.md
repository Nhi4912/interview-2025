...
**Visual — Unique Number of Occurrences example:**
...
Unique Number of Occurrences. ([LeetCode](https://leetcode.com/problems/unique-number-of-occurrences))

Difficulty: Easy | Acceptance: 78.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/unique-number-of-occurrences) for full constraints
 ...
 */
function uniqueNumberOfOccurrencesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function uniqueNumberOfOccurrences(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(uniqueNumberOfOccurrences(/* example 1 */)); // expected
// console.log(uniqueNumberOfOccurrences(/* example 2 */)); // expected
// console.log(uniqueNumberOfOccurrences(/* edge case */)); // expected
```
...
- [Unique Number of Occurrences — LeetCode](https://leetcode.com/problems/unique-number-of-occurrences) — problem page
