...
**Analogy:** Phân tích bài "Watering Plants" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Watering Plants. ([LeetCode](https://leetcode.com/problems/watering-plants))

Difficulty: Medium | Acceptance: 80.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/watering-plants) for full constraints
 ...
 */
function wateringPlantsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function wateringPlants(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(wateringPlants(/* example 1 */)); // expected
// console.log(wateringPlants(/* example 2 */)); // expected
// console.log(wateringPlants(/* edge case */)); // expected
```
...
- [Watering Plants — LeetCode](https://leetcode.com/problems/watering-plants) — problem page
