...
# Minimum Equal Sum of Two Arrays After Replacing Zeros / Minimum Equal Sum of Two Arrays After Replacing Zeros
...
**Visual — Minimum Equal Sum of Two Arrays After Replacing Zeros example:**
...
Minimum Equal Sum of Two Arrays After Replacing Zeros. ([LeetCode](https://leetcode.com/problems/minimum-equal-sum-of-two-arrays-after-replacing-zeros))

Difficulty: Medium | Acceptance: 50.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-equal-sum-of-two-arrays-after-replacing-zeros) for full constraints
 ...
 */
function minimumEqualSumOfTwoArraysAfterReplacingZerosBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumEqualSumOfTwoArraysAfterReplacingZeros(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumEqualSumOfTwoArraysAfterReplacingZeros(/* example 1 */)); // expected
// console.log(minimumEqualSumOfTwoArraysAfterReplacingZeros(/* example 2 */)); // expected
// console.log(minimumEqualSumOfTwoArraysAfterReplacingZeros(/* edge case */)); // expected
```
...
- [Minimum Equal Sum of Two Arrays After Replacing Zeros — LeetCode](https://leetcode.com/problems/minimum-equal-sum-of-two-arrays-after-replacing-zeros) — problem page
