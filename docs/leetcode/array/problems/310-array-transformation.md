...
**Analogy:** Phân tích bài "Array Transformation" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Array Transformation example:**
...
Array Transformation. ([LeetCode](https://leetcode.com/problems/array-transformation))

Difficulty: Easy | Acceptance: 53.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/array-transformation) for full constraints
 ...
 */
function arrayTransformationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function arrayTransformation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(arrayTransformation(/* example 1 */)); // expected
// console.log(arrayTransformation(/* example 2 */)); // expected
// console.log(arrayTransformation(/* edge case */)); // expected
```
...
- [Array Transformation — LeetCode](https://leetcode.com/problems/array-transformation) — problem page
