...
**Analogy:** Phân tích bài "Cyclically Rotating a Grid" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/cyclically-rotating-a-grid) for full constraints
 ...
 */
function cyclicallyRotatingAGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function cyclicallyRotatingAGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(cyclicallyRotatingAGrid(/* example 1 */)); // expected
// console.log(cyclicallyRotatingAGrid(/* example 2 */)); // expected
// console.log(cyclicallyRotatingAGrid(/* edge case */)); // expected
```
...
- [Cyclically Rotating a Grid — LeetCode](https://leetcode.com/problems/cyclically-rotating-a-grid) — problem page
