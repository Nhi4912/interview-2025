...
**Visual — Maximum Matrix Sum example:**
...
Maximum Matrix Sum. ([LeetCode](https://leetcode.com/problems/maximum-matrix-sum))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-matrix-sum) for full constraints
 ...
 */
function maximumMatrixSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumMatrixSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumMatrixSum(/* example 1 */)); // expected
// console.log(maximumMatrixSum(/* example 2 */)); // expected
// console.log(maximumMatrixSum(/* edge case */)); // expected
```
...
- [Maximum Matrix Sum — LeetCode](https://leetcode.com/problems/maximum-matrix-sum) — problem page
