...
# Find the Maximum Divisibility Score / Find the Maximum Divisibility Score
...
**Analogy:** Phân tích bài "Find the Maximum Divisibility Score" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find the Maximum Divisibility Score example:**
...
Find the Maximum Divisibility Score. ([LeetCode](https://leetcode.com/problems/find-the-maximum-divisibility-score))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-maximum-divisibility-score) for full constraints
 ...
 */
function findTheMaximumDivisibilityScoreBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheMaximumDivisibilityScore(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheMaximumDivisibilityScore(/* example 1 */)); // expected
// console.log(findTheMaximumDivisibilityScore(/* example 2 */)); // expected
// console.log(findTheMaximumDivisibilityScore(/* edge case */)); // expected
```
...
- [Find the Maximum Divisibility Score — LeetCode](https://leetcode.com/problems/find-the-maximum-divisibility-score) — problem page
