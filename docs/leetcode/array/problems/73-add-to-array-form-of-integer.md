...
**Visual — Add to Array-Form of Integer example:**
...
Add to Array-Form of Integer. ([LeetCode](https://leetcode.com/problems/add-to-array-form-of-integer))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/add-to-array-form-of-integer) for full constraints
 ...
 */
function addToArrayFormOfIntegerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function addToArrayFormOfInteger(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(addToArrayFormOfInteger(/* example 1 */)); // expected
// console.log(addToArrayFormOfInteger(/* example 2 */)); // expected
// console.log(addToArrayFormOfInteger(/* edge case */)); // expected
```
...
- [Add to Array-Form of Integer — LeetCode](https://leetcode.com/problems/add-to-array-form-of-integer) — problem page
