...
Four Divisors. ([LeetCode](https://leetcode.com/problems/four-divisors))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/four-divisors) for full constraints
 ...
 */
function fourDivisorsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function fourDivisors(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(fourDivisors(/* example 1 */)); // expected
// console.log(fourDivisors(/* example 2 */)); // expected
// console.log(fourDivisors(/* edge case */)); // expected
```
...
- [Four Divisors — LeetCode](https://leetcode.com/problems/four-divisors) — problem page
