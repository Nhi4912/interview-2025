...
# Number of Divisible Triplet Sums / Number of Divisible Triplet Sums
...
**Visual — Number of Divisible Triplet Sums example:**
...
Number of Divisible Triplet Sums. ([LeetCode](https://leetcode.com/problems/number-of-divisible-triplet-sums))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-divisible-triplet-sums) for full constraints
 ...
 */
function numberOfDivisibleTripletSumsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfDivisibleTripletSums(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfDivisibleTripletSums(/* example 1 */)); // expected
// console.log(numberOfDivisibleTripletSums(/* example 2 */)); // expected
// console.log(numberOfDivisibleTripletSums(/* edge case */)); // expected
```
...
- [Number of Divisible Triplet Sums — LeetCode](https://leetcode.com/problems/number-of-divisible-triplet-sums) — problem page
