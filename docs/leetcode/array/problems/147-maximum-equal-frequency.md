...
Maximum Equal Frequency. ([LeetCode](https://leetcode.com/problems/maximum-equal-frequency))

Difficulty: Hard | Acceptance: 37.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-equal-frequency) for full constraints
 ...
 */
function maximumEqualFrequencyBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumEqualFrequency(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumEqualFrequency(/* example 1 */)); // expected
// console.log(maximumEqualFrequency(/* example 2 */)); // expected
// console.log(maximumEqualFrequency(/* edge case */)); // expected
```
...
- [Maximum Equal Frequency — LeetCode](https://leetcode.com/problems/maximum-equal-frequency) — problem page
