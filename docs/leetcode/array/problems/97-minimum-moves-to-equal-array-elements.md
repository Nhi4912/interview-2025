...
**Visual — Minimum Moves to Equal Array Elements example:**
...
Difficulty: Medium | Acceptance: 57.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-moves-to-equal-array-elements) for full constraints
 ...
 */
function minimumMovesToEqualArrayElementsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumMovesToEqualArrayElements(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumMovesToEqualArrayElements(/* example 1 */)); // expected
// console.log(minimumMovesToEqualArrayElements(/* example 2 */)); // expected
// console.log(minimumMovesToEqualArrayElements(/* edge case */)); // expected
```
...
- [Minimum Moves to Equal Array Elements — LeetCode](https://leetcode.com/problems/minimum-moves-to-equal-array-elements) — problem page
