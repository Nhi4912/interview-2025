...
# Button with Longest Push Time / Button with Longest Push Time
...
**Analogy:** Phân tích bài "Button with Longest Push Time" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Button with Longest Push Time example:**
...
Button with Longest Push Time. ([LeetCode](https://leetcode.com/problems/button-with-longest-push-time))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/button-with-longest-push-time) for full constraints
 ...
 */
function buttonWithLongestPushTimeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function buttonWithLongestPushTime(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(buttonWithLongestPushTime(/* example 1 */)); // expected
// console.log(buttonWithLongestPushTime(/* example 2 */)); // expected
// console.log(buttonWithLongestPushTime(/* edge case */)); // expected
```
