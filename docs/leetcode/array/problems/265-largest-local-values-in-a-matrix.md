...
**Analogy:** Phân tích bài "Largest Local Values in a Matrix" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Difficulty: Easy | Acceptance: 87.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-local-values-in-a-matrix) for full constraints
 ...
 */
function largestLocalValuesInAMatrixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestLocalValuesInAMatrix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestLocalValuesInAMatrix(/* example 1 */)); // expected
// console.log(largestLocalValuesInAMatrix(/* example 2 */)); // expected
// console.log(largestLocalValuesInAMatrix(/* edge case */)); // expected
```
...
- [Largest Local Values in a Matrix — LeetCode](https://leetcode.com/problems/largest-local-values-in-a-matrix) — problem page
