...
Construct the Minimum Bitwise Array I. ([LeetCode](https://leetcode.com/problems/construct-the-minimum-bitwise-array-i))

Difficulty: Easy | Acceptance: 74.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/construct-the-minimum-bitwise-array-i) for full constraints
 ...
 */
function constructTheMinimumBitwiseArrayIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function constructTheMinimumBitwiseArrayI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(constructTheMinimumBitwiseArrayI(/* example 1 */)); // expected
// console.log(constructTheMinimumBitwiseArrayI(/* example 2 */)); // expected
// console.log(constructTheMinimumBitwiseArrayI(/* edge case */)); // expected
```
...
- [Construct the Minimum Bitwise Array I — LeetCode](https://leetcode.com/problems/construct-the-minimum-bitwise-array-i) — problem page
