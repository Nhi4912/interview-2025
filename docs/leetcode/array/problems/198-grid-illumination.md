...
**Visual — Grid Illumination example:**
...
Grid Illumination. ([LeetCode](https://leetcode.com/problems/grid-illumination))

Difficulty: Hard | Acceptance: 38.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/grid-illumination) for full constraints
 ...
 */
function gridIlluminationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gridIllumination(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gridIllumination(/* example 1 */)); // expected
// console.log(gridIllumination(/* example 2 */)); // expected
// console.log(gridIllumination(/* edge case */)); // expected
```
...
- [Grid Illumination — LeetCode](https://leetcode.com/problems/grid-illumination) — problem page
