...
**Visual — Next Greater Element II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/next-greater-element-ii) for full constraints
 ...
 */
function nextGreaterElementIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function nextGreaterElementIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(nextGreaterElementIi(/* example 1 */)); // expected
// console.log(nextGreaterElementIi(/* example 2 */)); // expected
// console.log(nextGreaterElementIi(/* edge case */)); // expected
```
...
- [Next Greater Element II — LeetCode](https://leetcode.com/problems/next-greater-element-ii) — problem page
