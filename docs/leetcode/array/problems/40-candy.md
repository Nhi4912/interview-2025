...
Difficulty: Hard | Acceptance: 46.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/candy) for full constraints
 ...
 */
function candyBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function candy(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(candy(/* example 1 */)); // expected
// console.log(candy(/* example 2 */)); // expected
// console.log(candy(/* edge case */)); // expected
```
...
- [Candy — LeetCode](https://leetcode.com/problems/candy) — problem page
