...
**Analogy:** Phân tích bài "Distribute Elements Into Two Arrays I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Distribute Elements Into Two Arrays I example:**
...
Distribute Elements Into Two Arrays I. ([LeetCode](https://leetcode.com/problems/distribute-elements-into-two-arrays-i))

Difficulty: Easy | Acceptance: 73.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/distribute-elements-into-two-arrays-i) for full constraints
 ...
 */
function distributeElementsIntoTwoArraysIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function distributeElementsIntoTwoArraysI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(distributeElementsIntoTwoArraysI(/* example 1 */)); // expected
// console.log(distributeElementsIntoTwoArraysI(/* example 2 */)); // expected
// console.log(distributeElementsIntoTwoArraysI(/* edge case */)); // expected
```
...
- [Distribute Elements Into Two Arrays I — LeetCode](https://leetcode.com/problems/distribute-elements-into-two-arrays-i) — problem page
