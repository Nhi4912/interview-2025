...
**Visual — Maximum Number of Events That Can Be Attended example:**
...
Maximum Number of Events That Can Be Attended. ([LeetCode](https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended))

Difficulty: Medium | Acceptance: 32.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended) for full constraints
 ...
 */
function maximumNumberOfEventsThatCanBeAttendedBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfEventsThatCanBeAttended(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfEventsThatCanBeAttended(/* example 1 */)); // expected
// console.log(maximumNumberOfEventsThatCanBeAttended(/* example 2 */)); // expected
// console.log(maximumNumberOfEventsThatCanBeAttended(/* edge case */)); // expected
```
...
- [Maximum Number of Events That Can Be Attended — LeetCode](https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended) — problem page
