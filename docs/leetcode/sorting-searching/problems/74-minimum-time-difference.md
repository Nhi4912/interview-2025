...
**Visual — Minimum Time Difference example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-difference) for full constraints
 ...
 */
function minimumTimeDifferenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeDifference(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeDifference(/* example 1 */)); // expected
// console.log(minimumTimeDifference(/* example 2 */)); // expected
// console.log(minimumTimeDifference(/* edge case */)); // expected
```
...
- [Minimum Time Difference — LeetCode](https://leetcode.com/problems/minimum-time-difference) — problem page
