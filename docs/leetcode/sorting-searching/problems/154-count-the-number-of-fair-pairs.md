...
**Visual — Count the Number of Fair Pairs example:**
...
Count the Number of Fair Pairs. ([LeetCode](https://leetcode.com/problems/count-the-number-of-fair-pairs))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-the-number-of-fair-pairs) for full constraints
 ...
 */
function countTheNumberOfFairPairsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countTheNumberOfFairPairs(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countTheNumberOfFairPairs(/* example 1 */)); // expected
// console.log(countTheNumberOfFairPairs(/* example 2 */)); // expected
// console.log(countTheNumberOfFairPairs(/* edge case */)); // expected
```
...
- [Count the Number of Fair Pairs — LeetCode](https://leetcode.com/problems/count-the-number-of-fair-pairs) — problem page
