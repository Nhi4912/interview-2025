...
**Visual — Maximum Product of Two Elements in an Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-product-of-two-elements-in-an-array) for full constraints
 ...
 */
function maximumProductOfTwoElementsInAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumProductOfTwoElementsInAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumProductOfTwoElementsInAnArray(/* example 1 */)); // expected
// console.log(maximumProductOfTwoElementsInAnArray(/* example 2 */)); // expected
// console.log(maximumProductOfTwoElementsInAnArray(/* edge case */)); // expected
```
...
- [Maximum Product of Two Elements in an Array — LeetCode](https://leetcode.com/problems/maximum-product-of-two-elements-in-an-array) — problem page
