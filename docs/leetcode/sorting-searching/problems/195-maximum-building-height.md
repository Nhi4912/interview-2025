...
**Visual — Maximum Building Height example:**
...
Maximum Building Height. ([LeetCode](https://leetcode.com/problems/maximum-building-height))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-building-height) for full constraints
 ...
 */
function maximumBuildingHeightBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumBuildingHeight(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumBuildingHeight(/* example 1 */)); // expected
// console.log(maximumBuildingHeight(/* example 2 */)); // expected
// console.log(maximumBuildingHeight(/* edge case */)); // expected
```
...
- [Maximum Building Height — LeetCode](https://leetcode.com/problems/maximum-building-height) — problem page
