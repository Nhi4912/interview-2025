...
**Visual — Find Peak Element example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-peak-element) for full constraints
 ...
 */
function findPeakElementBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findPeakElement(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findPeakElement(/* example 1 */)); // expected
// console.log(findPeakElement(/* example 2 */)); // expected
// console.log(findPeakElement(/* edge case */)); // expected
```
...
- [Find Peak Element — LeetCode](https://leetcode.com/problems/find-peak-element) — problem page
