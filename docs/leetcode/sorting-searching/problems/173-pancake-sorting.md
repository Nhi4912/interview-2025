...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pancake-sorting) for full constraints
 ...
 */
function pancakeSortingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pancakeSorting(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pancakeSorting(/* example 1 */)); // expected
// console.log(pancakeSorting(/* example 2 */)); // expected
// console.log(pancakeSorting(/* edge case */)); // expected
```
...
- [Pancake Sorting — LeetCode](https://leetcode.com/problems/pancake-sorting) — problem page
