...
**Visual — Minimum Cost of Buying Candies With Discount example:**
...
Minimum Cost of Buying Candies With Discount. ([LeetCode](https://leetcode.com/problems/minimum-cost-of-buying-candies-with-discount))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-cost-of-buying-candies-with-discount) for full constraints
 ...
 */
function minimumCostOfBuyingCandiesWithDiscountBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumCostOfBuyingCandiesWithDiscount(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumCostOfBuyingCandiesWithDiscount(/* example 1 */)); // expected
// console.log(minimumCostOfBuyingCandiesWithDiscount(/* example 2 */)); // expected
// console.log(minimumCostOfBuyingCandiesWithDiscount(/* edge case */)); // expected
```
...
- [Minimum Cost of Buying Candies With Discount — LeetCode](https://leetcode.com/problems/minimum-cost-of-buying-candies-with-discount) — problem page
