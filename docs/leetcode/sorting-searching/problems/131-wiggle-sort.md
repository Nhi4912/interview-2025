...
Wiggle Sort. ([LeetCode](https://leetcode.com/problems/wiggle-sort))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/wiggle-sort) for full constraints
 ...
 */
function wiggleSortBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function wiggleSort(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(wiggleSort(/* example 1 */)); // expected
// console.log(wiggleSort(/* example 2 */)); // expected
// console.log(wiggleSort(/* edge case */)); // expected
```
...
- [Wiggle Sort — LeetCode](https://leetcode.com/problems/wiggle-sort) — problem page
