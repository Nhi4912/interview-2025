...
**Visual — Maximum Total Beauty of the Gardens example:**
...
Maximum Total Beauty of the Gardens. ([LeetCode](https://leetcode.com/problems/maximum-total-beauty-of-the-gardens))

Difficulty: Hard | Acceptance: 30.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-total-beauty-of-the-gardens) for full constraints
 ...
 */
function maximumTotalBeautyOfTheGardensBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumTotalBeautyOfTheGardens(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumTotalBeautyOfTheGardens(/* example 1 */)); // expected
// console.log(maximumTotalBeautyOfTheGardens(/* example 2 */)); // expected
// console.log(maximumTotalBeautyOfTheGardens(/* edge case */)); // expected
```
...
- [Maximum Total Beauty of the Gardens — LeetCode](https://leetcode.com/problems/maximum-total-beauty-of-the-gardens) — problem page
