...
**Visual — Maximum Number of Alloys example:**
...
Maximum Number of Alloys. ([LeetCode](https://leetcode.com/problems/maximum-number-of-alloys))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-alloys) for full constraints
 ...
 */
function maximumNumberOfAlloysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfAlloys(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfAlloys(/* example 1 */)); // expected
// console.log(maximumNumberOfAlloys(/* example 2 */)); // expected
// console.log(maximumNumberOfAlloys(/* edge case */)); // expected
```
...
- [Maximum Number of Alloys — LeetCode](https://leetcode.com/problems/maximum-number-of-alloys) — problem page
