...
# Earliest Second to Mark Indices I / Earliest Second to Mark Indices I
...
**Visual — Earliest Second to Mark Indices I example:**
...
Earliest Second to Mark Indices I. ([LeetCode](https://leetcode.com/problems/earliest-second-to-mark-indices-i))

Difficulty: Medium | Acceptance: 34.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/earliest-second-to-mark-indices-i) for full constraints
 ...
 */
function earliestSecondToMarkIndicesIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function earliestSecondToMarkIndicesI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(earliestSecondToMarkIndicesI(/* example 1 */)); // expected
// console.log(earliestSecondToMarkIndicesI(/* example 2 */)); // expected
// console.log(earliestSecondToMarkIndicesI(/* edge case */)); // expected
```
...
- [Earliest Second to Mark Indices I — LeetCode](https://leetcode.com/problems/earliest-second-to-mark-indices-i) — problem page
