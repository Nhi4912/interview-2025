...
> **See also**: [Search a 2D Matrix II](https://leetcode.com/problems/search-a-2d-matrix-ii) | [Swim in Rising Water](https://leetcode.com/problems/swim-in-rising-water)
...
**Visual — Search a 2D Matrix example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/search-a-2d-matrix) for full constraints
 ...
 */
function searchA2dMatrixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function searchA2dMatrix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(searchA2dMatrix(/* example 1 */)); // expected
// console.log(searchA2dMatrix(/* example 2 */)); // expected
// console.log(searchA2dMatrix(/* edge case */)); // expected
```
...
- [Search a 2D Matrix — LeetCode](https://leetcode.com/problems/search-a-2d-matrix) — problem page
