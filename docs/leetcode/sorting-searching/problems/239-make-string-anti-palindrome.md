...
# Make String Anti-palindrome / Make String Anti-palindrome
...
**Visual — Make String Anti-palindrome example:**
...
Make String Anti-palindrome. ([LeetCode](https://leetcode.com/problems/make-string-anti-palindrome))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/make-string-anti-palindrome) for full constraints
 ...
 */
function makeStringAntiPalindromeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function makeStringAntiPalindrome(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(makeStringAntiPalindrome(/* example 1 */)); // expected
// console.log(makeStringAntiPalindrome(/* example 2 */)); // expected
// console.log(makeStringAntiPalindrome(/* edge case */)); // expected
```
...
- [Make String Anti-palindrome — LeetCode](https://leetcode.com/problems/make-string-anti-palindrome) — problem page
