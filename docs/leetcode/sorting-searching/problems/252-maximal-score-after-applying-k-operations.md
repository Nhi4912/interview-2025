...
# Maximal Score After Applying K Operations / Maximal Score After Applying K Operations
...
**Visual — Maximal Score After Applying K Operations example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximal-score-after-applying-k-operations) for full constraints
 ...
 */
function maximalScoreAfterApplyingKOperationsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximalScoreAfterApplyingKOperations(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximalScoreAfterApplyingKOperations(/* example 1 */)); // expected
// console.log(maximalScoreAfterApplyingKOperations(/* example 2 */)); // expected
// console.log(maximalScoreAfterApplyingKOperations(/* edge case */)); // expected
```
...
- [Maximal Score After Applying K Operations — LeetCode](https://leetcode.com/problems/maximal-score-after-applying-k-operations) — problem page
