...
**Visual — Minimum Moves to Equal Array Elements II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-moves-to-equal-array-elements-ii) for full constraints
 ...
 */
function minimumMovesToEqualArrayElementsIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumMovesToEqualArrayElementsIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumMovesToEqualArrayElementsIi(/* example 1 */)); // expected
// console.log(minimumMovesToEqualArrayElementsIi(/* example 2 */)); // expected
// console.log(minimumMovesToEqualArrayElementsIi(/* edge case */)); // expected
```
...
- [Minimum Moves to Equal Array Elements II — LeetCode](https://leetcode.com/problems/minimum-moves-to-equal-array-elements-ii) — problem page
