...
leetcode_url: "https://leetcode.com/problems/earliest-possible-day-of-full-bloom"
---
...
**Visual — Earliest Possible Day of Full Bloom example:**
...
Earliest Possible Day of Full Bloom. ([LeetCode](https://leetcode.com/problems/earliest-possible-day-of-full-bloom))

Difficulty: Hard | Acceptance: 71.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/earliest-possible-day-of-full-bloom) for full constraints
 ...
 */
function earliestPossibleDayOfFullBloomBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function earliestPossibleDayOfFullBloom(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(earliestPossibleDayOfFullBloom(/* example 1 */)); // expected
// console.log(earliestPossibleDayOfFullBloom(/* example 2 */)); // expected
// console.log(earliestPossibleDayOfFullBloom(/* edge case */)); // expected
```
...
- [Earliest Possible Day of Full Bloom — LeetCode](https://leetcode.com/problems/earliest-possible-day-of-full-bloom) — problem page
