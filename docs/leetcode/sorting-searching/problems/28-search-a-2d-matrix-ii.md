...
> **See also**: [Search a 2D Matrix](https://leetcode.com/problems/search-a-2d-matrix) | [Swim in Rising Water](https://leetcode.com/problems/swim-in-rising-water)
...
**Visual — Search a 2D Matrix II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/search-a-2d-matrix-ii) for full constraints
 ...
 */
function searchA2dMatrixIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function searchA2dMatrixIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(searchA2dMatrixIi(/* example 1 */)); // expected
// console.log(searchA2dMatrixIi(/* example 2 */)); // expected
// console.log(searchA2dMatrixIi(/* edge case */)); // expected
```
...
- [Search a 2D Matrix II — LeetCode](https://leetcode.com/problems/search-a-2d-matrix-ii) — problem page
