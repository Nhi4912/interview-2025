...
# Number of Unequal Triplets in Array / Number of Unequal Triplets in Array
...
**Visual — Number of Unequal Triplets in Array example:**
...
Number of Unequal Triplets in Array. ([LeetCode](https://leetcode.com/problems/number-of-unequal-triplets-in-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-unequal-triplets-in-array) for full constraints
 ...
 */
function numberOfUnequalTripletsInArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfUnequalTripletsInArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfUnequalTripletsInArray(/* example 1 */)); // expected
// console.log(numberOfUnequalTripletsInArray(/* example 2 */)); // expected
// console.log(numberOfUnequalTripletsInArray(/* edge case */)); // expected
```
...
- [Number of Unequal Triplets in Array — LeetCode](https://leetcode.com/problems/number-of-unequal-triplets-in-array) — problem page
