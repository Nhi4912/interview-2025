...
Alert Using Same Key-Card Three or More Times in a One Hour Period. ([LeetCode](https://leetcode.com/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period))

Difficulty: Medium | Acceptance: 45.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period) for full constraints
 ...
 */
function alertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriodBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function alertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(alertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod(/* example 1 */)); // expected
// console.log(alertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod(/* example 2 */)); // expected
// console.log(alertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod(/* edge case */)); // expected
```
...
- [Alert Using Same Key-Card Three or More Times in a One Hour Period — LeetCode](https://leetcode.com/problems/alert-using-same-key-card-three-or-more-times-in-a-one-hour-period) — problem page
