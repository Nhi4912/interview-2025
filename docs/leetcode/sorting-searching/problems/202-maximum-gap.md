...
> **See also**: [Sort an Array](https://leetcode.com/problems/sort-an-array) | [Top K Frequent Words](https://leetcode.com/problems/top-k-frequent-words)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-gap) for full constraints
 ...
 */
function maximumGapBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumGap(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumGap(/* example 1 */)); // expected
// console.log(maximumGap(/* example 2 */)); // expected
// console.log(maximumGap(/* edge case */)); // expected
```
...
- [Maximum Gap — LeetCode](https://leetcode.com/problems/maximum-gap) — problem page
