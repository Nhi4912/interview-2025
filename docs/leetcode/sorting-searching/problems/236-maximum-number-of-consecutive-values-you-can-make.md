...
**Visual — Maximum Number of Consecutive Values You Can Make example:**
...
Maximum Number of Consecutive Values You Can Make. ([LeetCode](https://leetcode.com/problems/maximum-number-of-consecutive-values-you-can-make))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-consecutive-values-you-can-make) for full constraints
 ...
 */
function maximumNumberOfConsecutiveValuesYouCanMakeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfConsecutiveValuesYouCanMake(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfConsecutiveValuesYouCanMake(/* example 1 */)); // expected
// console.log(maximumNumberOfConsecutiveValuesYouCanMake(/* example 2 */)); // expected
// console.log(maximumNumberOfConsecutiveValuesYouCanMake(/* edge case */)); // expected
```
...
- [Maximum Number of Consecutive Values You Can Make — LeetCode](https://leetcode.com/problems/maximum-number-of-consecutive-values-you-can-make) — problem page
