...
**Visual — Search in Rotated Sorted Array II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/search-in-rotated-sorted-array-ii) for full constraints
 ...
 */
function searchInRotatedSortedArrayIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function searchInRotatedSortedArrayIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(searchInRotatedSortedArrayIi(/* example 1 */)); // expected
// console.log(searchInRotatedSortedArrayIi(/* example 2 */)); // expected
// console.log(searchInRotatedSortedArrayIi(/* edge case */)); // expected
```
...
- [Search in Rotated Sorted Array II — LeetCode](https://leetcode.com/problems/search-in-rotated-sorted-array-ii) — problem page
