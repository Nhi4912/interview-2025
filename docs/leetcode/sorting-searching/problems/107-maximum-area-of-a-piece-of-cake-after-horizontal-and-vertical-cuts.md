...
**Visual — Maximum Area of a Piece of Cake After Horizontal and Vertical Cuts example:**
...
Maximum Area of a Piece of Cake After Horizontal and Vertical Cuts. ([LeetCode](https://leetcode.com/problems/maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts))

Difficulty: Medium | Acceptance: 41.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts) for full constraints
 ...
 */
function maximumAreaOfAPieceOfCakeAfterHorizontalAndVerticalCutsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumAreaOfAPieceOfCakeAfterHorizontalAndVerticalCuts(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumAreaOfAPieceOfCakeAfterHorizontalAndVerticalCuts(/* example 1 */)); // expected
// console.log(maximumAreaOfAPieceOfCakeAfterHorizontalAndVerticalCuts(/* example 2 */)); // expected
// console.log(maximumAreaOfAPieceOfCakeAfterHorizontalAndVerticalCuts(/* edge case */)); // expected
```
...
- [Maximum Area of a Piece of Cake After Horizontal and Vertical Cuts — LeetCode](https://leetcode.com/problems/maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts) — problem page
