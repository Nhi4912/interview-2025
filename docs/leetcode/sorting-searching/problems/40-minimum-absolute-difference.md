...
**Visual — Minimum Absolute Difference example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-absolute-difference) for full constraints
 ...
 */
function minimumAbsoluteDifferenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumAbsoluteDifference(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumAbsoluteDifference(/* example 1 */)); // expected
// console.log(minimumAbsoluteDifference(/* example 2 */)); // expected
// console.log(minimumAbsoluteDifference(/* edge case */)); // expected
```
