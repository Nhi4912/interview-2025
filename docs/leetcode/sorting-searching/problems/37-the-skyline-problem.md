...
**Visual — The Skyline Problem example:**
...
Difficulty: Hard | Acceptance: 44.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/the-skyline-problem) for full constraints
 ...
 */
function theSkylineProblemBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function theSkylineProblem(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(theSkylineProblem(/* example 1 */)); // expected
// console.log(theSkylineProblem(/* example 2 */)); // expected
// console.log(theSkylineProblem(/* edge case */)); // expected
```
...
- [The Skyline Problem — LeetCode](https://leetcode.com/problems/the-skyline-problem) — problem page
