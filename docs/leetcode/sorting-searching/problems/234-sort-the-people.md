...
**Visual — Sort the People example:**
...
Difficulty: Easy | Acceptance: 84.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sort-the-people) for full constraints
 ...
 */
function sortThePeopleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sortThePeople(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sortThePeople(/* example 1 */)); // expected
// console.log(sortThePeople(/* example 2 */)); // expected
// console.log(sortThePeople(/* edge case */)); // expected
```
...
- [Sort the People — LeetCode](https://leetcode.com/problems/sort-the-people) — problem page
