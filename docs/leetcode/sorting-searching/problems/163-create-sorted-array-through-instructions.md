...
> **See also**: [Count of Smaller Numbers After Self](https://leetcode.com/problems/count-of-smaller-numbers-after-self) | [Count of Range Sum](https://leetcode.com/problems/count-of-range-sum)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/create-sorted-array-through-instructions) for full constraints
 ...
 */
function createSortedArrayThroughInstructionsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function createSortedArrayThroughInstructions(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(createSortedArrayThroughInstructions(/* example 1 */)); // expected
// console.log(createSortedArrayThroughInstructions(/* example 2 */)); // expected
// console.log(createSortedArrayThroughInstructions(/* edge case */)); // expected
```
...
- [Create Sorted Array through Instructions — LeetCode](https://leetcode.com/problems/create-sorted-array-through-instructions) — problem page
