...
**Visual — Advantage Shuffle example:**
...
Advantage Shuffle. ([LeetCode](https://leetcode.com/problems/advantage-shuffle))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/advantage-shuffle) for full constraints
 ...
 */
function advantageShuffleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function advantageShuffle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(advantageShuffle(/* example 1 */)); // expected
// console.log(advantageShuffle(/* example 2 */)); // expected
// console.log(advantageShuffle(/* edge case */)); // expected
```
...
- [Advantage Shuffle — LeetCode](https://leetcode.com/problems/advantage-shuffle) — problem page
