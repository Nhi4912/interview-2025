...
# Minimum Operations to Make Numbers Non-positive / Minimum Operations to Make Numbers Non-positive
...
**Visual — Minimum Operations to Make Numbers Non-positive example:**
...
Minimum Operations to Make Numbers Non-positive. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-make-numbers-non-positive))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-make-numbers-non-positive) for full constraints
 ...
 */
function minimumOperationsToMakeNumbersNonPositiveBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToMakeNumbersNonPositive(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToMakeNumbersNonPositive(/* example 1 */)); // expected
// console.log(minimumOperationsToMakeNumbersNonPositive(/* example 2 */)); // expected
// console.log(minimumOperationsToMakeNumbersNonPositive(/* edge case */)); // expected
```
...
- [Minimum Operations to Make Numbers Non-positive — LeetCode](https://leetcode.com/problems/minimum-operations-to-make-numbers-non-positive) — problem page
