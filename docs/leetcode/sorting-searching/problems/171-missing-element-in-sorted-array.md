...
Missing Element in Sorted Array. ([LeetCode](https://leetcode.com/problems/missing-element-in-sorted-array))

Difficulty: Medium | Acceptance: 58.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/missing-element-in-sorted-array) for full constraints
 ...
 */
function missingElementInSortedArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function missingElementInSortedArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(missingElementInSortedArray(/* example 1 */)); // expected
// console.log(missingElementInSortedArray(/* example 2 */)); // expected
// console.log(missingElementInSortedArray(/* edge case */)); // expected
```
...
- [Missing Element in Sorted Array — LeetCode](https://leetcode.com/problems/missing-element-in-sorted-array) — problem page
