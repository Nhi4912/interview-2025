...
Minimum Time to Complete Trips. ([LeetCode](https://leetcode.com/problems/minimum-time-to-complete-trips))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-to-complete-trips) for full constraints
 ...
 */
function minimumTimeToCompleteTripsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeToCompleteTrips(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeToCompleteTrips(/* example 1 */)); // expected
// console.log(minimumTimeToCompleteTrips(/* example 2 */)); // expected
// console.log(minimumTimeToCompleteTrips(/* edge case */)); // expected
```
...
- [Minimum Time to Complete Trips — LeetCode](https://leetcode.com/problems/minimum-time-to-complete-trips) — problem page
