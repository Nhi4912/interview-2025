...
Minimum Initial Energy to Finish Tasks. ([LeetCode](https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks) for full constraints
 ...
 */
function minimumInitialEnergyToFinishTasksBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumInitialEnergyToFinishTasks(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumInitialEnergyToFinishTasks(/* example 1 */)); // expected
// console.log(minimumInitialEnergyToFinishTasks(/* example 2 */)); // expected
// console.log(minimumInitialEnergyToFinishTasks(/* edge case */)); // expected
```
...
- [Minimum Initial Energy to Finish Tasks — LeetCode](https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks) — problem page
