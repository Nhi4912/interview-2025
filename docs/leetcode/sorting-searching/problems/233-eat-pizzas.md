...
Eat Pizzas!. ([LeetCode](https://leetcode.com/problems/eat-pizzas))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/eat-pizzas) for full constraints
 ...
 */
function eatPizzasBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function eatPizzas(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(eatPizzas(/* example 1 */)); // expected
// console.log(eatPizzas(/* example 2 */)); // expected
// console.log(eatPizzas(/* edge case */)); // expected
```
...
- [Eat Pizzas! — LeetCode](https://leetcode.com/problems/eat-pizzas) — problem page
