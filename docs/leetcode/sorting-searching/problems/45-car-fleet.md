...
Car Fleet. ([LeetCode](https://leetcode.com/problems/car-fleet))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/car-fleet) for full constraints
 ...
 */
function carFleetBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function carFleet(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(carFleet(/* example 1 */)); // expected
// console.log(carFleet(/* example 2 */)); // expected
// console.log(carFleet(/* edge case */)); // expected
```
