...
**Visual — Rank Teams by Votes example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rank-teams-by-votes) for full constraints
 ...
 */
function rankTeamsByVotesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rankTeamsByVotes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rankTeamsByVotes(/* example 1 */)); // expected
// console.log(rankTeamsByVotes(/* example 2 */)); // expected
// console.log(rankTeamsByVotes(/* edge case */)); // expected
```
...
- [Rank Teams by Votes — LeetCode](https://leetcode.com/problems/rank-teams-by-votes) — problem page
