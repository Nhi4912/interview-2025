...
> **See also**: [Top K Frequent Words](https://leetcode.com/problems/top-k-frequent-words) | [Search Suggestions System](https://leetcode.com/problems/search-suggestions-system)
...
Reward Top K Students. ([LeetCode](https://leetcode.com/problems/reward-top-k-students))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reward-top-k-students) for full constraints
 ...
 */
function rewardTopKStudentsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rewardTopKStudents(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rewardTopKStudents(/* example 1 */)); // expected
// console.log(rewardTopKStudents(/* example 2 */)); // expected
// console.log(rewardTopKStudents(/* edge case */)); // expected
```
...
- [Reward Top K Students — LeetCode](https://leetcode.com/problems/reward-top-k-students) — problem page
