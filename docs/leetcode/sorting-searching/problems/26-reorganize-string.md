...
**Visual — Reorganize String example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reorganize-string) for full constraints
 ...
 */
function reorganizeStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reorganizeString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reorganizeString(/* example 1 */)); // expected
// console.log(reorganizeString(/* example 2 */)); // expected
// console.log(reorganizeString(/* edge case */)); // expected
```
...
- [Reorganize String — LeetCode](https://leetcode.com/problems/reorganize-string) — problem page
