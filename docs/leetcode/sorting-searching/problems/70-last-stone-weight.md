...
**Visual — Last Stone Weight example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/last-stone-weight) for full constraints
 ...
 */
function lastStoneWeightBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lastStoneWeight(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lastStoneWeight(/* example 1 */)); // expected
// console.log(lastStoneWeight(/* example 2 */)); // expected
// console.log(lastStoneWeight(/* edge case */)); // expected
```
...
- [Last Stone Weight — LeetCode](https://leetcode.com/problems/last-stone-weight) — problem page
