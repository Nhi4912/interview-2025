...
**Visual — Get Equal Substrings Within Budget example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/get-equal-substrings-within-budget) for full constraints
 ...
 */
function getEqualSubstringsWithinBudgetBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function getEqualSubstringsWithinBudget(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(getEqualSubstringsWithinBudget(/* example 1 */)); // expected
// console.log(getEqualSubstringsWithinBudget(/* example 2 */)); // expected
// console.log(getEqualSubstringsWithinBudget(/* edge case */)); // expected
```
...
- [Maximize the Confusion of an Exam](https://leetcode.com/problems/maximize-the-confusion-of-an-exam) — same pattern: Sliding Window
