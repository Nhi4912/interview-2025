...
**Visual — Capacity To Ship Packages Within D Days example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days) for full constraints
 ...
 */
function capacityToShipPackagesWithinDDaysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function capacityToShipPackagesWithinDDays(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(capacityToShipPackagesWithinDDays(/* example 1 */)); // expected
// console.log(capacityToShipPackagesWithinDDays(/* example 2 */)); // expected
// console.log(capacityToShipPackagesWithinDDays(/* edge case */)); // expected
```
...
- [Capacity To Ship Packages Within D Days — LeetCode](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days) — problem page
