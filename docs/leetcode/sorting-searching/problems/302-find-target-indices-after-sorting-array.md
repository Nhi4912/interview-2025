...
**Visual — Find Target Indices After Sorting Array example:**
...
Find Target Indices After Sorting Array. ([LeetCode](https://leetcode.com/problems/find-target-indices-after-sorting-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-target-indices-after-sorting-array) for full constraints
 ...
 */
function findTargetIndicesAfterSortingArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTargetIndicesAfterSortingArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTargetIndicesAfterSortingArray(/* example 1 */)); // expected
// console.log(findTargetIndicesAfterSortingArray(/* example 2 */)); // expected
// console.log(findTargetIndicesAfterSortingArray(/* edge case */)); // expected
```
...
- [Find Target Indices After Sorting Array — LeetCode](https://leetcode.com/problems/find-target-indices-after-sorting-array) — problem page
