...
Find the K-Sum of an Array. ([LeetCode](https://leetcode.com/problems/find-the-k-sum-of-an-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-k-sum-of-an-array) for full constraints
 ...
 */
function findTheKSumOfAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheKSumOfAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheKSumOfAnArray(/* example 1 */)); // expected
// console.log(findTheKSumOfAnArray(/* example 2 */)); // expected
// console.log(findTheKSumOfAnArray(/* edge case */)); // expected
```
