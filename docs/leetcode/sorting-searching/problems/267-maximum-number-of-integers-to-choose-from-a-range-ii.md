...
**Visual — Maximum Number of Integers to Choose From a Range II example:**
...
Maximum Number of Integers to Choose From a Range II. ([LeetCode](https://leetcode.com/problems/maximum-number-of-integers-to-choose-from-a-range-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-integers-to-choose-from-a-range-ii) for full constraints
 ...
 */
function maximumNumberOfIntegersToChooseFromARangeIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfIntegersToChooseFromARangeIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfIntegersToChooseFromARangeIi(/* example 1 */)); // expected
// console.log(maximumNumberOfIntegersToChooseFromARangeIi(/* example 2 */)); // expected
// console.log(maximumNumberOfIntegersToChooseFromARangeIi(/* edge case */)); // expected
```
...
- [Maximum Number of Integers to Choose From a Range II — LeetCode](https://leetcode.com/problems/maximum-number-of-integers-to-choose-from-a-range-ii) — problem page
