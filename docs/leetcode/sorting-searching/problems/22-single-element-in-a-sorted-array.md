...
**Visual — Single Element in a Sorted Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/single-element-in-a-sorted-array) for full constraints
 ...
 */
function singleElementInASortedArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function singleElementInASortedArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(singleElementInASortedArray(/* example 1 */)); // expected
// console.log(singleElementInASortedArray(/* example 2 */)); // expected
// console.log(singleElementInASortedArray(/* edge case */)); // expected
```
...
- [Single Element in a Sorted Array — LeetCode](https://leetcode.com/problems/single-element-in-a-sorted-array) — problem page
