...
**Visual — Set Intersection Size At Least Two example:**
...
Set Intersection Size At Least Two. ([LeetCode](https://leetcode.com/problems/set-intersection-size-at-least-two))

Difficulty: Hard | Acceptance: 45.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/set-intersection-size-at-least-two) for full constraints
 ...
 */
function setIntersectionSizeAtLeastTwoBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function setIntersectionSizeAtLeastTwo(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(setIntersectionSizeAtLeastTwo(/* example 1 */)); // expected
// console.log(setIntersectionSizeAtLeastTwo(/* example 2 */)); // expected
// console.log(setIntersectionSizeAtLeastTwo(/* edge case */)); // expected
```
...
- [Set Intersection Size At Least Two — LeetCode](https://leetcode.com/problems/set-intersection-size-at-least-two) — problem page
