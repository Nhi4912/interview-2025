...
**Visual — Eliminate Maximum Number of Monsters example:**
...
Eliminate Maximum Number of Monsters. ([LeetCode](https://leetcode.com/problems/eliminate-maximum-number-of-monsters))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/eliminate-maximum-number-of-monsters) for full constraints
 ...
 */
function eliminateMaximumNumberOfMonstersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function eliminateMaximumNumberOfMonsters(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(eliminateMaximumNumberOfMonsters(/* example 1 */)); // expected
// console.log(eliminateMaximumNumberOfMonsters(/* example 2 */)); // expected
// console.log(eliminateMaximumNumberOfMonsters(/* edge case */)); // expected
```
...
- [Eliminate Maximum Number of Monsters — LeetCode](https://leetcode.com/problems/eliminate-maximum-number-of-monsters) — problem page
