...
**Visual — Find K-th Smallest Pair Distance example:**
...
Find K-th Smallest Pair Distance. ([LeetCode](https://leetcode.com/problems/find-k-th-smallest-pair-distance))

Difficulty: Hard | Acceptance: 45.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-k-th-smallest-pair-distance) for full constraints
 ...
 */
function findKThSmallestPairDistanceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findKThSmallestPairDistance(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findKThSmallestPairDistance(/* example 1 */)); // expected
// console.log(findKThSmallestPairDistance(/* example 2 */)); // expected
// console.log(findKThSmallestPairDistance(/* edge case */)); // expected
```
...
- [Find K-th Smallest Pair Distance — LeetCode](https://leetcode.com/problems/find-k-th-smallest-pair-distance) — problem page
