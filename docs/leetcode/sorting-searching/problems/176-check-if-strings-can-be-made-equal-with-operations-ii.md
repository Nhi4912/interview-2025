...
# Check if Strings Can be Made Equal With Operations II / Check if Strings Can be Made Equal With Operations II
...
Check if Strings Can be Made Equal With Operations II. ([LeetCode](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-ii) for full constraints
 ...
 */
function checkIfStringsCanBeMadeEqualWithOperationsIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfStringsCanBeMadeEqualWithOperationsIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfStringsCanBeMadeEqualWithOperationsIi(/* example 1 */)); // expected
// console.log(checkIfStringsCanBeMadeEqualWithOperationsIi(/* example 2 */)); // expected
// console.log(checkIfStringsCanBeMadeEqualWithOperationsIi(/* edge case */)); // expected
```
...
- [Check if Strings Can be Made Equal With Operations II — LeetCode](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-ii) — problem page
