...
**Visual — Minimum Number of Days to Make m Bouquets example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-days-to-make-m-bouquets) for full constraints
 ...
 */
function minimumNumberOfDaysToMakeMBouquetsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfDaysToMakeMBouquets(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfDaysToMakeMBouquets(/* example 1 */)); // expected
// console.log(minimumNumberOfDaysToMakeMBouquets(/* example 2 */)); // expected
// console.log(minimumNumberOfDaysToMakeMBouquets(/* edge case */)); // expected
```
...
- [Minimum Number of Days to Make m Bouquets — LeetCode](https://leetcode.com/problems/minimum-number-of-days-to-make-m-bouquets) — problem page
