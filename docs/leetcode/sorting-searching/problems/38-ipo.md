...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/ipo) for full constraints
 ...
 */
function ipoBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function ipo(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(ipo(/* example 1 */)); // expected
// console.log(ipo(/* example 2 */)); // expected
// console.log(ipo(/* edge case */)); // expected
```
...
- [IPO — LeetCode](https://leetcode.com/problems/ipo) — problem page
