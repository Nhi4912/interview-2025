...
**Visual — Most Beautiful Item for Each Query example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/most-beautiful-item-for-each-query) for full constraints
 ...
 */
function mostBeautifulItemForEachQueryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function mostBeautifulItemForEachQuery(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(mostBeautifulItemForEachQuery(/* example 1 */)); // expected
// console.log(mostBeautifulItemForEachQuery(/* example 2 */)); // expected
// console.log(mostBeautifulItemForEachQuery(/* edge case */)); // expected
```
...
- [Most Beautiful Item for Each Query — LeetCode](https://leetcode.com/problems/most-beautiful-item-for-each-query) — problem page
