...
**Visual — Single-Threaded CPU example:**
...
Single-Threaded CPU. ([LeetCode](https://leetcode.com/problems/single-threaded-cpu))

Difficulty: Medium | Acceptance: 46.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/single-threaded-cpu) for full constraints
 ...
 */
function singleThreadedCpuBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function singleThreadedCpu(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(singleThreadedCpu(/* example 1 */)); // expected
// console.log(singleThreadedCpu(/* example 2 */)); // expected
// console.log(singleThreadedCpu(/* edge case */)); // expected
```
...
- [Single-Threaded CPU — LeetCode](https://leetcode.com/problems/single-threaded-cpu) — problem page
