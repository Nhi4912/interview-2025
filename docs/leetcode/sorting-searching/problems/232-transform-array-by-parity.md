...
# Transform Array by Parity / Transform Array by Parity
...
**Visual — Transform Array by Parity example:**
...
Transform Array by Parity. ([LeetCode](https://leetcode.com/problems/transform-array-by-parity))

Difficulty: Easy | Acceptance: 89.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/transform-array-by-parity) for full constraints
 ...
 */
function transformArrayByParityBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function transformArrayByParity(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(transformArrayByParity(/* example 1 */)); // expected
// console.log(transformArrayByParity(/* example 2 */)); // expected
// console.log(transformArrayByParity(/* edge case */)); // expected
```
...
- [Transform Array by Parity — LeetCode](https://leetcode.com/problems/transform-array-by-parity) — problem page
