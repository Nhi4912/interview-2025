...
**Visual — Lexicographically Minimum String After Removing Stars example:**
...
Lexicographically Minimum String After Removing Stars. ([LeetCode](https://leetcode.com/problems/lexicographically-minimum-string-after-removing-stars))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lexicographically-minimum-string-after-removing-stars) for full constraints
 ...
 */
function lexicographicallyMinimumStringAfterRemovingStarsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lexicographicallyMinimumStringAfterRemovingStars(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lexicographicallyMinimumStringAfterRemovingStars(/* example 1 */)); // expected
// console.log(lexicographicallyMinimumStringAfterRemovingStars(/* example 2 */)); // expected
// console.log(lexicographicallyMinimumStringAfterRemovingStars(/* edge case */)); // expected
```
...
- [Lexicographically Minimum String After Removing Stars — LeetCode](https://leetcode.com/problems/lexicographically-minimum-string-after-removing-stars) — problem page
