...
Pour Water Between Buckets to Make Water Levels Equal. ([LeetCode](https://leetcode.com/problems/pour-water-between-buckets-to-make-water-levels-equal))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/pour-water-between-buckets-to-make-water-levels-equal) for full constraints
 ...
 */
function pourWaterBetweenBucketsToMakeWaterLevelsEqualBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function pourWaterBetweenBucketsToMakeWaterLevelsEqual(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(pourWaterBetweenBucketsToMakeWaterLevelsEqual(/* example 1 */)); // expected
// console.log(pourWaterBetweenBucketsToMakeWaterLevelsEqual(/* example 2 */)); // expected
// console.log(pourWaterBetweenBucketsToMakeWaterLevelsEqual(/* edge case */)); // expected
```
...
- [Pour Water Between Buckets to Make Water Levels Equal — LeetCode](https://leetcode.com/problems/pour-water-between-buckets-to-make-water-levels-equal) — problem page
