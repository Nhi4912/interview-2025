...
**Visual — Minimum Subsequence in Non-Increasing Order example:**
...
Minimum Subsequence in Non-Increasing Order. ([LeetCode](https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order) for full constraints
 ...
 */
function minimumSubsequenceInNonIncreasingOrderBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumSubsequenceInNonIncreasingOrder(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumSubsequenceInNonIncreasingOrder(/* example 1 */)); // expected
// console.log(minimumSubsequenceInNonIncreasingOrder(/* example 2 */)); // expected
// console.log(minimumSubsequenceInNonIncreasingOrder(/* edge case */)); // expected
```
...
- [Minimum Subsequence in Non-Increasing Order — LeetCode](https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order) — problem page
