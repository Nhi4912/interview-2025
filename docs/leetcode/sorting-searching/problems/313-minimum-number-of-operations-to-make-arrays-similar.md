...
leetcode_url: "https://leetcode.com/problems/minimum-number-of-operations-to-make-arrays-similar"
---
...
**Visual — Minimum Number of Operations to Make Arrays Similar example:**
...
Minimum Number of Operations to Make Arrays Similar. ([LeetCode](https://leetcode.com/problems/minimum-number-of-operations-to-make-arrays-similar))

Difficulty: Hard | Acceptance: 60.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-operations-to-make-arrays-similar) for full constraints
 ...
 */
function minimumNumberOfOperationsToMakeArraysSimilarBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfOperationsToMakeArraysSimilar(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfOperationsToMakeArraysSimilar(/* example 1 */)); // expected
// console.log(minimumNumberOfOperationsToMakeArraysSimilar(/* example 2 */)); // expected
// console.log(minimumNumberOfOperationsToMakeArraysSimilar(/* edge case */)); // expected
```
...
- [Minimum Number of Operations to Make Arrays Similar — LeetCode](https://leetcode.com/problems/minimum-number-of-operations-to-make-arrays-similar) — problem page
