...
**Visual — Maximum Side Length of a Square with Sum Less than or Equal to Threshold example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold) for full constraints
 ...
 */
function maximumSideLengthOfASquareWithSumLessThanOrEqualToThresholdBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumSideLengthOfASquareWithSumLessThanOrEqualToThreshold(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumSideLengthOfASquareWithSumLessThanOrEqualToThreshold(/* example 1 */)); // expected
// console.log(maximumSideLengthOfASquareWithSumLessThanOrEqualToThreshold(/* example 2 */)); // expected
// console.log(maximumSideLengthOfASquareWithSumLessThanOrEqualToThreshold(/* edge case */)); // expected
```
...
- [Maximum Side Length of a Square with Sum Less than or Equal to Threshold — LeetCode](https://leetcode.com/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold) — problem page
