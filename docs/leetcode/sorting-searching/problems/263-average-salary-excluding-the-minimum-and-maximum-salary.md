...
# Average Salary Excluding the Minimum and Maximum Salary / Average Salary Excluding the Minimum and Maximum Salary
...
**Visual — Average Salary Excluding the Minimum and Maximum Salary example:**
...
Average Salary Excluding the Minimum and Maximum Salary. ([LeetCode](https://leetcode.com/problems/average-salary-excluding-the-minimum-and-maximum-salary))

Difficulty: Easy | Acceptance: 63.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/average-salary-excluding-the-minimum-and-maximum-salary) for full constraints
 ...
 */
function averageSalaryExcludingTheMinimumAndMaximumSalaryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function averageSalaryExcludingTheMinimumAndMaximumSalary(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(averageSalaryExcludingTheMinimumAndMaximumSalary(/* example 1 */)); // expected
// console.log(averageSalaryExcludingTheMinimumAndMaximumSalary(/* example 2 */)); // expected
// console.log(averageSalaryExcludingTheMinimumAndMaximumSalary(/* edge case */)); // expected
```
...
- [Average Salary Excluding the Minimum and Maximum Salary — LeetCode](https://leetcode.com/problems/average-salary-excluding-the-minimum-and-maximum-salary) — problem page
