...
Maximum Fruits Harvested After at Most K Steps. ([LeetCode](https://leetcode.com/problems/maximum-fruits-harvested-after-at-most-k-steps))

Difficulty: Hard | Acceptance: 36.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-fruits-harvested-after-at-most-k-steps) for full constraints
 ...
 */
function maximumFruitsHarvestedAfterAtMostKStepsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumFruitsHarvestedAfterAtMostKSteps(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumFruitsHarvestedAfterAtMostKSteps(/* example 1 */)); // expected
// console.log(maximumFruitsHarvestedAfterAtMostKSteps(/* example 2 */)); // expected
// console.log(maximumFruitsHarvestedAfterAtMostKSteps(/* edge case */)); // expected
```
...
- [Maximum Fruits Harvested After at Most K Steps — LeetCode](https://leetcode.com/problems/maximum-fruits-harvested-after-at-most-k-steps) — problem page
