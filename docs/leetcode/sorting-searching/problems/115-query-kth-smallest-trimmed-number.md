...
**Visual — Query Kth Smallest Trimmed Number example:**
...
Query Kth Smallest Trimmed Number. ([LeetCode](https://leetcode.com/problems/query-kth-smallest-trimmed-number))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/query-kth-smallest-trimmed-number) for full constraints
 ...
 */
function queryKthSmallestTrimmedNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function queryKthSmallestTrimmedNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(queryKthSmallestTrimmedNumber(/* example 1 */)); // expected
// console.log(queryKthSmallestTrimmedNumber(/* example 2 */)); // expected
// console.log(queryKthSmallestTrimmedNumber(/* edge case */)); // expected
```
...
- [Query Kth Smallest Trimmed Number — LeetCode](https://leetcode.com/problems/query-kth-smallest-trimmed-number) — problem page
