...
**Visual — Find Original Array From Doubled Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-original-array-from-doubled-array) for full constraints
 ...
 */
function findOriginalArrayFromDoubledArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findOriginalArrayFromDoubledArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findOriginalArrayFromDoubledArray(/* example 1 */)); // expected
// console.log(findOriginalArrayFromDoubledArray(/* example 2 */)); // expected
// console.log(findOriginalArrayFromDoubledArray(/* edge case */)); // expected
```
...
- [Find Original Array From Doubled Array — LeetCode](https://leetcode.com/problems/find-original-array-from-doubled-array) — problem page
