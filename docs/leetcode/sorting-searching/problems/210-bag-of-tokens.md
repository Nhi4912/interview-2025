...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bag-of-tokens) for full constraints
 ...
 */
function bagOfTokensBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bagOfTokens(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bagOfTokens(/* example 1 */)); // expected
// console.log(bagOfTokens(/* example 2 */)); // expected
// console.log(bagOfTokens(/* edge case */)); // expected
```
...
- [Bag of Tokens — LeetCode](https://leetcode.com/problems/bag-of-tokens) — problem page
