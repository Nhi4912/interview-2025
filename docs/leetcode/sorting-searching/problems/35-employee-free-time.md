...
**Visual — Employee Free Time example:**
...
Employee Free Time. ([LeetCode](https://leetcode.com/problems/employee-free-time))

Difficulty: Hard | Acceptance: 72.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/employee-free-time) for full constraints
 ...
 */
function employeeFreeTimeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function employeeFreeTime(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(employeeFreeTime(/* example 1 */)); // expected
// console.log(employeeFreeTime(/* example 2 */)); // expected
// console.log(employeeFreeTime(/* edge case */)); // expected
```
...
- [Employee Free Time — LeetCode](https://leetcode.com/problems/employee-free-time) — problem page
