...
**Visual — Two City Scheduling example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/two-city-scheduling) for full constraints
 ...
 */
function twoCitySchedulingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function twoCityScheduling(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(twoCityScheduling(/* example 1 */)); // expected
// console.log(twoCityScheduling(/* example 2 */)); // expected
// console.log(twoCityScheduling(/* edge case */)); // expected
```
...
- [Two City Scheduling — LeetCode](https://leetcode.com/problems/two-city-scheduling) — problem page
