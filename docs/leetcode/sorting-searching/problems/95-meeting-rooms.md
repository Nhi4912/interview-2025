...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/meeting-rooms) for full constraints
 ...
 */
function meetingRoomsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function meetingRooms(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(meetingRooms(/* example 1 */)); // expected
// console.log(meetingRooms(/* example 2 */)); // expected
// console.log(meetingRooms(/* edge case */)); // expected
```
...
- [Meeting Rooms — LeetCode](https://leetcode.com/problems/meeting-rooms) — problem page
