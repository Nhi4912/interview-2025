...
leetcode_url: "https://leetcode.com/problems/maximum-spending-after-buying-items"
---
...
**Visual — Maximum Spending After Buying Items example:**
...
Maximum Spending After Buying Items. ([LeetCode](https://leetcode.com/problems/maximum-spending-after-buying-items))

Difficulty: Hard | Acceptance: 60.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-spending-after-buying-items) for full constraints
 ...
 */
function maximumSpendingAfterBuyingItemsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumSpendingAfterBuyingItems(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumSpendingAfterBuyingItems(/* example 1 */)); // expected
// console.log(maximumSpendingAfterBuyingItems(/* example 2 */)); // expected
// console.log(maximumSpendingAfterBuyingItems(/* edge case */)); // expected
```
...
- [Maximum Spending After Buying Items — LeetCode](https://leetcode.com/problems/maximum-spending-after-buying-items) — problem page
