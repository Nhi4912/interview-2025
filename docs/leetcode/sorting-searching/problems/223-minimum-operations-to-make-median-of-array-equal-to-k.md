...
**Visual — Minimum Operations to Make Median of Array Equal to K example:**
...
Minimum Operations to Make Median of Array Equal to K. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-make-median-of-array-equal-to-k))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-make-median-of-array-equal-to-k) for full constraints
 ...
 */
function minimumOperationsToMakeMedianOfArrayEqualToKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToMakeMedianOfArrayEqualToK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToMakeMedianOfArrayEqualToK(/* example 1 */)); // expected
// console.log(minimumOperationsToMakeMedianOfArrayEqualToK(/* example 2 */)); // expected
// console.log(minimumOperationsToMakeMedianOfArrayEqualToK(/* edge case */)); // expected
```
