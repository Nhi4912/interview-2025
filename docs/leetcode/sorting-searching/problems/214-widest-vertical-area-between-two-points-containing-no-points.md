...
**Visual — Widest Vertical Area Between Two Points Containing No Points example:**
...
Widest Vertical Area Between Two Points Containing No Points. ([LeetCode](https://leetcode.com/problems/widest-vertical-area-between-two-points-containing-no-points))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/widest-vertical-area-between-two-points-containing-no-points) for full constraints
 ...
 */
function widestVerticalAreaBetweenTwoPointsContainingNoPointsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function widestVerticalAreaBetweenTwoPointsContainingNoPoints(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(widestVerticalAreaBetweenTwoPointsContainingNoPoints(/* example 1 */)); // expected
// console.log(widestVerticalAreaBetweenTwoPointsContainingNoPoints(/* example 2 */)); // expected
// console.log(widestVerticalAreaBetweenTwoPointsContainingNoPoints(/* edge case */)); // expected
```
...
- [Widest Vertical Area Between Two Points Containing No Points — LeetCode](https://leetcode.com/problems/widest-vertical-area-between-two-points-containing-no-points) — problem page
