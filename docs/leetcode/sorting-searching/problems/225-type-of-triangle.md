...
Type of Triangle. ([LeetCode](https://leetcode.com/problems/type-of-triangle))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/type-of-triangle) for full constraints
 ...
 */
function typeOfTriangleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function typeOfTriangle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(typeOfTriangle(/* example 1 */)); // expected
// console.log(typeOfTriangle(/* example 2 */)); // expected
// console.log(typeOfTriangle(/* edge case */)); // expected
```
