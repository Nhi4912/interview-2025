...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/binary-search) for full constraints
 ...
 */
function binarySearchBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function binarySearch(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(binarySearch(/* example 1 */)); // expected
// console.log(binarySearch(/* example 2 */)); // expected
// console.log(binarySearch(/* edge case */)); // expected
```
...
- [Binary Search — LeetCode](https://leetcode.com/problems/binary-search) — problem page
