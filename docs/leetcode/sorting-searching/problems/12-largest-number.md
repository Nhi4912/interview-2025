...
> **See also**: [Word Abbreviation](https://leetcode.com/problems/word-abbreviation) | [Maximum Palindromes After Operations](https://leetcode.com/problems/maximum-palindromes-after-operations)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-number) for full constraints
 ...
 */
function largestNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestNumber(/* example 1 */)); // expected
// console.log(largestNumber(/* example 2 */)); // expected
// console.log(largestNumber(/* edge case */)); // expected
```
...
- [Largest Number — LeetCode](https://leetcode.com/problems/largest-number) — problem page
