...
> **See also**: [Reorganize String](https://leetcode.com/problems/reorganize-string) | [Strong Password Checker](https://leetcode.com/problems/strong-password-checker)
...
**Visual — Longest Happy String example:**
...
Longest Happy String. ([LeetCode](https://leetcode.com/problems/longest-happy-string))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-happy-string) for full constraints
 ...
 */
function longestHappyStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestHappyString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestHappyString(/* example 1 */)); // expected
// console.log(longestHappyString(/* example 2 */)); // expected
// console.log(longestHappyString(/* edge case */)); // expected
```
...
- [Strong Password Checker](https://leetcode.com/problems/strong-password-checker) — same pattern: Heap / Priority Queue
