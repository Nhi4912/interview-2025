...
**Visual — Boats to Save People example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/boats-to-save-people) for full constraints
 ...
 */
function boatsToSavePeopleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function boatsToSavePeople(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(boatsToSavePeople(/* example 1 */)); // expected
// console.log(boatsToSavePeople(/* example 2 */)); // expected
// console.log(boatsToSavePeople(/* edge case */)); // expected
```
