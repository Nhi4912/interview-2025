...
**Visual — Subsequence of Size K With the Largest Even Sum example:**
...
Subsequence of Size K With the Largest Even Sum. ([LeetCode](https://leetcode.com/problems/subsequence-of-size-k-with-the-largest-even-sum))

Difficulty: Medium | Acceptance: 35.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/subsequence-of-size-k-with-the-largest-even-sum) for full constraints
 ...
 */
function subsequenceOfSizeKWithTheLargestEvenSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function subsequenceOfSizeKWithTheLargestEvenSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(subsequenceOfSizeKWithTheLargestEvenSum(/* example 1 */)); // expected
// console.log(subsequenceOfSizeKWithTheLargestEvenSum(/* example 2 */)); // expected
// console.log(subsequenceOfSizeKWithTheLargestEvenSum(/* edge case */)); // expected
```
...
- [Subsequence of Size K With the Largest Even Sum — LeetCode](https://leetcode.com/problems/subsequence-of-size-k-with-the-largest-even-sum) — problem page
