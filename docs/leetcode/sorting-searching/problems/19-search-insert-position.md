...
**Visual — Search Insert Position example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/search-insert-position) for full constraints
 ...
 */
function searchInsertPositionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function searchInsertPosition(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(searchInsertPosition(/* example 1 */)); // expected
// console.log(searchInsertPosition(/* example 2 */)); // expected
// console.log(searchInsertPosition(/* edge case */)); // expected
```
...
- [Search Insert Position — LeetCode](https://leetcode.com/problems/search-insert-position) — problem page
