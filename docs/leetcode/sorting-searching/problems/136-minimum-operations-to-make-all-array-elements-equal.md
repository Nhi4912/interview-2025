...
Minimum Operations to Make All Array Elements Equal. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-make-all-array-elements-equal))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-make-all-array-elements-equal) for full constraints
 ...
 */
function minimumOperationsToMakeAllArrayElementsEqualBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToMakeAllArrayElementsEqual(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToMakeAllArrayElementsEqual(/* example 1 */)); // expected
// console.log(minimumOperationsToMakeAllArrayElementsEqual(/* example 2 */)); // expected
// console.log(minimumOperationsToMakeAllArrayElementsEqual(/* edge case */)); // expected
```
...
- [Minimum Operations to Make All Array Elements Equal — LeetCode](https://leetcode.com/problems/minimum-operations-to-make-all-array-elements-equal) — problem page
