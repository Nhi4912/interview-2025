...
**Visual — Split Array into Consecutive Subsequences example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/split-array-into-consecutive-subsequences) for full constraints
 ...
 */
function splitArrayIntoConsecutiveSubsequencesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function splitArrayIntoConsecutiveSubsequences(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(splitArrayIntoConsecutiveSubsequences(/* example 1 */)); // expected
// console.log(splitArrayIntoConsecutiveSubsequences(/* example 2 */)); // expected
// console.log(splitArrayIntoConsecutiveSubsequences(/* edge case */)); // expected
```
...
- [Split Array into Consecutive Subsequences — LeetCode](https://leetcode.com/problems/split-array-into-consecutive-subsequences) — problem page
