...
**Visual — Put Marbles in Bags example:**
...
Put Marbles in Bags. ([LeetCode](https://leetcode.com/problems/put-marbles-in-bags))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/put-marbles-in-bags) for full constraints
 ...
 */
function putMarblesInBagsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function putMarblesInBags(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(putMarblesInBags(/* example 1 */)); // expected
// console.log(putMarblesInBags(/* example 2 */)); // expected
// console.log(putMarblesInBags(/* edge case */)); // expected
```
...
- [Put Marbles in Bags — LeetCode](https://leetcode.com/problems/put-marbles-in-bags) — problem page
