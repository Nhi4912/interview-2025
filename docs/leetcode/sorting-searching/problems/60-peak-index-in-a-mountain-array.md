...
**Visual — Peak Index in a Mountain Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/peak-index-in-a-mountain-array) for full constraints
 ...
 */
function peakIndexInAMountainArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function peakIndexInAMountainArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(peakIndexInAMountainArray(/* example 1 */)); // expected
// console.log(peakIndexInAMountainArray(/* example 2 */)); // expected
// console.log(peakIndexInAMountainArray(/* edge case */)); // expected
```
