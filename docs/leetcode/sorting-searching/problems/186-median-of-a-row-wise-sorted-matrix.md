...
**Visual — Median of a Row Wise Sorted Matrix example:**
...
Median of a Row Wise Sorted Matrix. ([LeetCode](https://leetcode.com/problems/median-of-a-row-wise-sorted-matrix))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/median-of-a-row-wise-sorted-matrix) for full constraints
 ...
 */
function medianOfARowWiseSortedMatrixBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function medianOfARowWiseSortedMatrix(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(medianOfARowWiseSortedMatrix(/* example 1 */)); // expected
// console.log(medianOfARowWiseSortedMatrix(/* example 2 */)); // expected
// console.log(medianOfARowWiseSortedMatrix(/* edge case */)); // expected
```
...
- [Median of a Row Wise Sorted Matrix — LeetCode](https://leetcode.com/problems/median-of-a-row-wise-sorted-matrix) — problem page
