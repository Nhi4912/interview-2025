...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/h-index) for full constraints
 ...
 */
function hIndexBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function hIndex(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(hIndex(/* example 1 */)); // expected
// console.log(hIndex(/* example 2 */)); // expected
// console.log(hIndex(/* edge case */)); // expected
```
...
- [Height Checker](https://leetcode.com/problems/height-checker) — same pattern: Sorting
- [H-Index — LeetCode](https://leetcode.com/problems/h-index) — problem page
