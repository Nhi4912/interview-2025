...
**Visual — Majority Element II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/majority-element-ii) for full constraints
 ...
 */
function majorityElementIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function majorityElementIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(majorityElementIi(/* example 1 */)); // expected
// console.log(majorityElementIi(/* example 2 */)); // expected
// console.log(majorityElementIi(/* edge case */)); // expected
```
