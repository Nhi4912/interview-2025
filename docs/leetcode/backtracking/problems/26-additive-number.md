...
> **See also**: [Word Break II](https://leetcode.com/problems/word-break-ii) | [Word Ladder II](https://leetcode.com/problems/word-ladder-ii)
...
**Visual — Additive Number example:**
...
Additive Number. ([LeetCode](https://leetcode.com/problems/additive-number))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/additive-number) for full constraints
 ...
 */
function additiveNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function additiveNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(additiveNumber(/* example 1 */)); // expected
// console.log(additiveNumber(/* example 2 */)); // expected
// console.log(additiveNumber(/* edge case */)); // expected
```
...
- [Additive Number — LeetCode](https://leetcode.com/problems/additive-number) — problem page
