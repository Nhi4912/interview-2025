...
> **See also**: [Word Break II](https://leetcode.com/problems/word-break-ii) | [Permutations II](https://leetcode.com/problems/permutations-ii)
...
**Visual — Combination Sum II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/combination-sum-ii) for full constraints
 ...
 */
function combinationSumIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function combinationSumIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(combinationSumIi(/* example 1 */)); // expected
// console.log(combinationSumIi(/* example 2 */)); // expected
// console.log(combinationSumIi(/* edge case */)); // expected
```
...
- [Combination Sum II — LeetCode](https://leetcode.com/problems/combination-sum-ii) — problem page
