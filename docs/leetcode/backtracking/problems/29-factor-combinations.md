...
**Visual — Factor Combinations example:**
...
Factor Combinations. ([LeetCode](https://leetcode.com/problems/factor-combinations))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/factor-combinations) for full constraints
 ...
 */
function factorCombinationsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function factorCombinations(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(factorCombinations(/* example 1 */)); // expected
// console.log(factorCombinations(/* example 2 */)); // expected
// console.log(factorCombinations(/* edge case */)); // expected
```
...
- [Factor Combinations — LeetCode](https://leetcode.com/problems/factor-combinations) — problem page
