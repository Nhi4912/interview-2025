...
> **See also**: [Minimum Number of Lines to Cover Points](https://leetcode.com/problems/minimum-number-of-lines-to-cover-points) | [Maximize Score After N Operations](https://leetcode.com/problems/maximize-score-after-n-operations)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/gray-code) for full constraints
 ...
 */
function grayCodeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function grayCode(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(grayCode(/* example 1 */)); // expected
// console.log(grayCode(/* example 2 */)); // expected
// console.log(grayCode(/* edge case */)); // expected
```
...
- [Gray Code — LeetCode](https://leetcode.com/problems/gray-code) — problem page
