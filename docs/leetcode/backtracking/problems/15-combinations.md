...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/combinations) for full constraints
 ...
 */
function combinationsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function combinations(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(combinations(/* example 1 */)); // expected
// console.log(combinations(/* example 2 */)); // expected
// console.log(combinations(/* edge case */)); // expected
```
...
- [Combinations — LeetCode](https://leetcode.com/problems/combinations) — problem page
