...
**Visual — Range Sum Query 2D - Immutable example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/range-sum-query-2d-immutable) for full constraints
 ...
 */
function rangeSumQuery2dImmutableBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rangeSumQuery2dImmutable(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rangeSumQuery2dImmutable(/* example 1 */)); // expected
// console.log(rangeSumQuery2dImmutable(/* example 2 */)); // expected
// console.log(rangeSumQuery2dImmutable(/* edge case */)); // expected
```
...
- [Subrectangle Queries](https://leetcode.com/problems/subrectangle-queries) — same pattern: Design
