...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/map-sum-pairs) for full constraints
 ...
 */
function mapSumPairsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function mapSumPairs(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(mapSumPairs(/* example 1 */)); // expected
// console.log(mapSumPairs(/* example 2 */)); // expected
// console.log(mapSumPairs(/* edge case */)); // expected
```
...
- [Map Sum Pairs — LeetCode](https://leetcode.com/problems/map-sum-pairs) — problem page
