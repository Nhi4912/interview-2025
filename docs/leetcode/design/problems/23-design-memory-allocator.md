...
**Visual — Design Memory Allocator example:**
...
Design Memory Allocator. ([LeetCode](https://leetcode.com/problems/design-memory-allocator))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-memory-allocator) for full constraints
 ...
 */
function designMemoryAllocatorBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designMemoryAllocator(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designMemoryAllocator(/* example 1 */)); // expected
// console.log(designMemoryAllocator(/* example 2 */)); // expected
// console.log(designMemoryAllocator(/* edge case */)); // expected
```
