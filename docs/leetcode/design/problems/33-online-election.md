...
> **See also**: [Snapshot Array](https://leetcode.com/problems/snapshot-array) | [Implement Router](https://leetcode.com/problems/implement-router)
...
**Visual — Online Election example:**
...
Online Election. ([LeetCode](https://leetcode.com/problems/online-election))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/online-election) for full constraints
 ...
 */
function onlineElectionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function onlineElection(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(onlineElection(/* example 1 */)); // expected
// console.log(onlineElection(/* example 2 */)); // expected
// console.log(onlineElection(/* edge case */)); // expected
```
...
- [Online Election — LeetCode](https://leetcode.com/problems/online-election) — problem page
