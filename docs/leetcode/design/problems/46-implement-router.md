...
leetcode_url: "https://leetcode.com/problems/implement-router"
---
...
> **See also**: [Snapshot Array](https://leetcode.com/problems/snapshot-array) | [Number of Flowers in Full Bloom](https://leetcode.com/problems/number-of-flowers-in-full-bloom)
...
**Visual — Implement Router example:**
...
Implement Router. ([LeetCode](https://leetcode.com/problems/implement-router))

Difficulty: Medium | Acceptance: 21.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/implement-router) for full constraints
 ...
 */
function implementRouterBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function implementRouter(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(implementRouter(/* example 1 */)); // expected
// console.log(implementRouter(/* example 2 */)); // expected
// console.log(implementRouter(/* edge case */)); // expected
```
...
- [Implement Router — LeetCode](https://leetcode.com/problems/implement-router) — problem page
