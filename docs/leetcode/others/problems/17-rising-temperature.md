...
**Analogy:** Phân tích bài "Rising Temperature" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Rising Temperature example:**
...
Difficulty: Easy | Acceptance: 50.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rising-temperature) for full constraints
 ...
 */
function risingTemperatureBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function risingTemperature(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(risingTemperature(/* example 1 */)); // expected
// console.log(risingTemperature(/* example 2 */)); // expected
// console.log(risingTemperature(/* edge case */)); // expected
```
...
- [Rising Temperature — LeetCode](https://leetcode.com/problems/rising-temperature) — problem page
