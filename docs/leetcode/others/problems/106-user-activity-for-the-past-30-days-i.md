...
**Analogy:** Phân tích bài "User Activity for the Past 30 Days I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — User Activity for the Past 30 Days I example:**
...
User Activity for the Past 30 Days I. ([LeetCode](https://leetcode.com/problems/user-activity-for-the-past-30-days-i))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/user-activity-for-the-past-30-days-i) for full constraints
 ...
 */
function userActivityForThePast30DaysIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function userActivityForThePast30DaysI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(userActivityForThePast30DaysI(/* example 1 */)); // expected
// console.log(userActivityForThePast30DaysI(/* example 2 */)); // expected
// console.log(userActivityForThePast30DaysI(/* edge case */)); // expected
```
...
- [User Activity for the Past 30 Days I — LeetCode](https://leetcode.com/problems/user-activity-for-the-past-30-days-i) — problem page
