...
**Analogy:** Phân tích bài "Highest Grade For Each Student" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Highest Grade For Each Student example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/highest-grade-for-each-student) for full constraints
 ...
 */
function highestGradeForEachStudentBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function highestGradeForEachStudent(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(highestGradeForEachStudent(/* example 1 */)); // expected
// console.log(highestGradeForEachStudent(/* example 2 */)); // expected
// console.log(highestGradeForEachStudent(/* edge case */)); // expected
```
...
- [Highest Grade For Each Student — LeetCode](https://leetcode.com/problems/highest-grade-for-each-student) — problem page
