...
**Analogy:** Phân tích bài "Immediate Food Delivery I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Immediate Food Delivery I example:**
...
Immediate Food Delivery I. ([LeetCode](https://leetcode.com/problems/immediate-food-delivery-i))

Difficulty: Easy | Acceptance: 80.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/immediate-food-delivery-i) for full constraints
 ...
 */
function immediateFoodDeliveryIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function immediateFoodDeliveryI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(immediateFoodDeliveryI(/* example 1 */)); // expected
// console.log(immediateFoodDeliveryI(/* example 2 */)); // expected
// console.log(immediateFoodDeliveryI(/* edge case */)); // expected
```
...
- [Immediate Food Delivery I — LeetCode](https://leetcode.com/problems/immediate-food-delivery-i) — problem page
