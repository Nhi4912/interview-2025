...
**Analogy:** Phân tích bài "Duplicate Emails" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Duplicate Emails example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/duplicate-emails) for full constraints
 ...
 */
function duplicateEmailsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function duplicateEmails(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(duplicateEmails(/* example 1 */)); // expected
// console.log(duplicateEmails(/* example 2 */)); // expected
// console.log(duplicateEmails(/* edge case */)); // expected
```
...
- [Duplicate Emails — LeetCode](https://leetcode.com/problems/duplicate-emails) — problem page
