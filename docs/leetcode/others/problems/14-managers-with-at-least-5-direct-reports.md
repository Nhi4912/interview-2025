...
**Analogy:** Phân tích bài "Managers with at Least 5 Direct Reports" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Managers with at Least 5 Direct Reports example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/managers-with-at-least-5-direct-reports) for full constraints
 ...
 */
function managersWithAtLeast5DirectReportsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function managersWithAtLeast5DirectReports(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(managersWithAtLeast5DirectReports(/* example 1 */)); // expected
// console.log(managersWithAtLeast5DirectReports(/* example 2 */)); // expected
// console.log(managersWithAtLeast5DirectReports(/* edge case */)); // expected
```
...
- [Managers with at Least 5 Direct Reports — LeetCode](https://leetcode.com/problems/managers-with-at-least-5-direct-reports) — problem page
