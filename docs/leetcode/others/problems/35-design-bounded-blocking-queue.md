...
**Analogy:** Phân tích bài "Design Bounded Blocking Queue" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Design Bounded Blocking Queue example:**
...
Design Bounded Blocking Queue. ([LeetCode](https://leetcode.com/problems/design-bounded-blocking-queue))

Difficulty: Medium | Acceptance: 73.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-bounded-blocking-queue) for full constraints
 ...
 */
function designBoundedBlockingQueueBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designBoundedBlockingQueue(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designBoundedBlockingQueue(/* example 1 */)); // expected
// console.log(designBoundedBlockingQueue(/* example 2 */)); // expected
// console.log(designBoundedBlockingQueue(/* edge case */)); // expected
```
...
- [Design Bounded Blocking Queue — LeetCode](https://leetcode.com/problems/design-bounded-blocking-queue) — problem page
