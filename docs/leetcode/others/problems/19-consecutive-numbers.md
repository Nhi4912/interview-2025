...
**Analogy:** Phân tích bài "Consecutive Numbers" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Consecutive Numbers example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/consecutive-numbers) for full constraints
 ...
 */
function consecutiveNumbersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function consecutiveNumbers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(consecutiveNumbers(/* example 1 */)); // expected
// console.log(consecutiveNumbers(/* example 2 */)); // expected
// console.log(consecutiveNumbers(/* edge case */)); // expected
```
...
- [Consecutive Numbers — LeetCode](https://leetcode.com/problems/consecutive-numbers) — problem page
