...
**Analogy:** Phân tích bài "Tree Node" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Tree Node. ([LeetCode](https://leetcode.com/problems/tree-node))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/tree-node) for full constraints
 ...
 */
function treeNodeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function treeNode(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(treeNode(/* example 1 */)); // expected
// console.log(treeNode(/* example 2 */)); // expected
// console.log(treeNode(/* edge case */)); // expected
```
...
- [Tree Node — LeetCode](https://leetcode.com/problems/tree-node) — problem page
