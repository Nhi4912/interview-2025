...
**Analogy:** Phân tích bài "Percentage of Users Attended a Contest" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Percentage of Users Attended a Contest example:**
...
Difficulty: Easy | Acceptance: 58.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/percentage-of-users-attended-a-contest) for full constraints
 ...
 */
function percentageOfUsersAttendedAContestBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function percentageOfUsersAttendedAContest(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(percentageOfUsersAttendedAContest(/* example 1 */)); // expected
// console.log(percentageOfUsersAttendedAContest(/* example 2 */)); // expected
// console.log(percentageOfUsersAttendedAContest(/* edge case */)); // expected
```
...
- [Percentage of Users Attended a Contest — LeetCode](https://leetcode.com/problems/percentage-of-users-attended-a-contest) — problem page
