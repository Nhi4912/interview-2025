...
**Analogy:** Phân tích bài "Article Views I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Article Views I example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/article-views-i) for full constraints
 ...
 */
function articleViewsIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function articleViewsI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(articleViewsI(/* example 1 */)); // expected
// console.log(articleViewsI(/* example 2 */)); // expected
// console.log(articleViewsI(/* edge case */)); // expected
```
...
- [Article Views I — LeetCode](https://leetcode.com/problems/article-views-i) — problem page
