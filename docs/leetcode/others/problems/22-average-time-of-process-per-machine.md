...
**Analogy:** Phân tích bài "Average Time of Process per Machine" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Average Time of Process per Machine example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/average-time-of-process-per-machine) for full constraints
 ...
 */
function averageTimeOfProcessPerMachineBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function averageTimeOfProcessPerMachine(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(averageTimeOfProcessPerMachine(/* example 1 */)); // expected
// console.log(averageTimeOfProcessPerMachine(/* example 2 */)); // expected
// console.log(averageTimeOfProcessPerMachine(/* edge case */)); // expected
```
...
- [Average Time of Process per Machine — LeetCode](https://leetcode.com/problems/average-time-of-process-per-machine) — problem page
