...
**Analogy:** Phân tích bài "Number of Transactions per Visit" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Number of Transactions per Visit example:**
...
Number of Transactions per Visit. ([LeetCode](https://leetcode.com/problems/number-of-transactions-per-visit))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-transactions-per-visit) for full constraints
 ...
 */
function numberOfTransactionsPerVisitBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfTransactionsPerVisit(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfTransactionsPerVisit(/* example 1 */)); // expected
// console.log(numberOfTransactionsPerVisit(/* example 2 */)); // expected
// console.log(numberOfTransactionsPerVisit(/* edge case */)); // expected
```
...
- [Number of Transactions per Visit — LeetCode](https://leetcode.com/problems/number-of-transactions-per-visit) — problem page
