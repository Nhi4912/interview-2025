...
**Analogy:** Phân tích bài "Find Users With Valid E-Mails" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Users With Valid E-Mails example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-users-with-valid-e-mails) for full constraints
 ...
 */
function findUsersWithValidEMailsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findUsersWithValidEMails(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findUsersWithValidEMails(/* example 1 */)); // expected
// console.log(findUsersWithValidEMails(/* example 2 */)); // expected
// console.log(findUsersWithValidEMails(/* edge case */)); // expected
```
...
- [Find Users With Valid E-Mails — LeetCode](https://leetcode.com/problems/find-users-with-valid-e-mails) — problem page
