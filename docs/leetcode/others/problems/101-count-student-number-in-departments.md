...
**Analogy:** Phân tích bài "Count Student Number in Departments" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Count Student Number in Departments example:**
...
Count Student Number in Departments. ([LeetCode](https://leetcode.com/problems/count-student-number-in-departments))

Difficulty: Medium | Acceptance: 59.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-student-number-in-departments) for full constraints
 ...
 */
function countStudentNumberInDepartmentsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countStudentNumberInDepartments(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countStudentNumberInDepartments(/* example 1 */)); // expected
// console.log(countStudentNumberInDepartments(/* example 2 */)); // expected
// console.log(countStudentNumberInDepartments(/* edge case */)); // expected
```
...
- [Count Student Number in Departments — LeetCode](https://leetcode.com/problems/count-student-number-in-departments) — problem page
