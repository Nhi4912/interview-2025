...
**Analogy:** Phân tích bài "Bank Account Summary" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Bank Account Summary example:**
...
Bank Account Summary. ([LeetCode](https://leetcode.com/problems/bank-account-summary))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bank-account-summary) for full constraints
 ...
 */
function bankAccountSummaryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bankAccountSummary(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bankAccountSummary(/* example 1 */)); // expected
// console.log(bankAccountSummary(/* example 2 */)); // expected
// console.log(bankAccountSummary(/* edge case */)); // expected
```
...
- [Bank Account Summary — LeetCode](https://leetcode.com/problems/bank-account-summary) — problem page
