...
**Analogy:** Phân tích bài "Movie Rating" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/movie-rating) for full constraints
 ...
 */
function movieRatingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function movieRating(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(movieRating(/* example 1 */)); // expected
// console.log(movieRating(/* example 2 */)); // expected
// console.log(movieRating(/* edge case */)); // expected
```
...
- [Movie Rating — LeetCode](https://leetcode.com/problems/movie-rating) — problem page
