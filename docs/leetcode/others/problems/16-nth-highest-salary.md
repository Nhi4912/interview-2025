...
**Analogy:** Phân tích bài "Nth Highest Salary" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Nth Highest Salary example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/nth-highest-salary) for full constraints
 ...
 */
function nthHighestSalaryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function nthHighestSalary(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(nthHighestSalary(/* example 1 */)); // expected
// console.log(nthHighestSalary(/* example 2 */)); // expected
// console.log(nthHighestSalary(/* edge case */)); // expected
```
...
- [Nth Highest Salary — LeetCode](https://leetcode.com/problems/nth-highest-salary) — problem page
