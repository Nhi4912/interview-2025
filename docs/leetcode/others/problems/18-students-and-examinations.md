...
**Analogy:** Phân tích bài "Students and Examinations" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Students and Examinations example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/students-and-examinations) for full constraints
 ...
 */
function studentsAndExaminationsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function studentsAndExaminations(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(studentsAndExaminations(/* example 1 */)); // expected
// console.log(studentsAndExaminations(/* example 2 */)); // expected
// console.log(studentsAndExaminations(/* edge case */)); // expected
```
...
- [Students and Examinations — LeetCode](https://leetcode.com/problems/students-and-examinations) — problem page
