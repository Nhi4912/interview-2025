...
**Analogy:** Phân tích bài "Department Highest Salary" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Department Highest Salary example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/department-highest-salary) for full constraints
 ...
 */
function departmentHighestSalaryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function departmentHighestSalary(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(departmentHighestSalary(/* example 1 */)); // expected
// console.log(departmentHighestSalary(/* example 2 */)); // expected
// console.log(departmentHighestSalary(/* edge case */)); // expected
```
