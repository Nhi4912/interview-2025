...
**Analogy:** Phân tích bài "User Activity for the Past 30 Days II" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — User Activity for the Past 30 Days II example:**
...
User Activity for the Past 30 Days II. ([LeetCode](https://leetcode.com/problems/user-activity-for-the-past-30-days-ii))

Difficulty: Easy | Acceptance: 35.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/user-activity-for-the-past-30-days-ii) for full constraints
 ...
 */
function userActivityForThePast30DaysIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function userActivityForThePast30DaysIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(userActivityForThePast30DaysIi(/* example 1 */)); // expected
// console.log(userActivityForThePast30DaysIi(/* example 2 */)); // expected
// console.log(userActivityForThePast30DaysIi(/* edge case */)); // expected
```
...
- [User Activity for the Past 30 Days II — LeetCode](https://leetcode.com/problems/user-activity-for-the-past-30-days-ii) — problem page
