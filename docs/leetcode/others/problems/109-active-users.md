...
**Analogy:** Phân tích bài "Active Users" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/active-users) for full constraints
 ...
 */
function activeUsersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function activeUsers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(activeUsers(/* example 1 */)); // expected
// console.log(activeUsers(/* example 2 */)); // expected
// console.log(activeUsers(/* edge case */)); // expected
```
...
- [Active Users — LeetCode](https://leetcode.com/problems/active-users) — problem page
