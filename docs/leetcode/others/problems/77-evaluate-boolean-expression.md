...
**Analogy:** Phân tích bài "Evaluate Boolean Expression" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Evaluate Boolean Expression example:**
...
Evaluate Boolean Expression. ([LeetCode](https://leetcode.com/problems/evaluate-boolean-expression))

Difficulty: Medium | Acceptance: 72.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/evaluate-boolean-expression) for full constraints
 ...
 */
function evaluateBooleanExpressionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function evaluateBooleanExpression(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(evaluateBooleanExpression(/* example 1 */)); // expected
// console.log(evaluateBooleanExpression(/* example 2 */)); // expected
// console.log(evaluateBooleanExpression(/* edge case */)); // expected
```
...
- [Evaluate Boolean Expression — LeetCode](https://leetcode.com/problems/evaluate-boolean-expression) — problem page
