...
**Visual — Domino and Tromino Tiling example:**
...
Domino and Tromino Tiling. ([LeetCode](https://leetcode.com/problems/domino-and-tromino-tiling))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/domino-and-tromino-tiling) for full constraints
 ...
 */
function dominoAndTrominoTilingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function dominoAndTrominoTiling(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(dominoAndTrominoTiling(/* example 1 */)); // expected
// console.log(dominoAndTrominoTiling(/* example 2 */)); // expected
// console.log(dominoAndTrominoTiling(/* edge case */)); // expected
```
...
- [Domino and Tromino Tiling — LeetCode](https://leetcode.com/problems/domino-and-tromino-tiling) — problem page
