...
**Visual — Palindrome Partitioning IV example:**
...
Palindrome Partitioning IV. ([LeetCode](https://leetcode.com/problems/palindrome-partitioning-iv))

Difficulty: Hard | Acceptance: 44.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/palindrome-partitioning-iv) for full constraints
 ...
 */
function palindromePartitioningIvBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function palindromePartitioningIv(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(palindromePartitioningIv(/* example 1 */)); // expected
// console.log(palindromePartitioningIv(/* example 2 */)); // expected
// console.log(palindromePartitioningIv(/* edge case */)); // expected
```
...
- [Palindrome Partitioning IV — LeetCode](https://leetcode.com/problems/palindrome-partitioning-iv) — problem page
