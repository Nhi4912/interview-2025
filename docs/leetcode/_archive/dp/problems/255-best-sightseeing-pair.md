...
**Visual — Best Sightseeing Pair example:**
...
Best Sightseeing Pair. ([LeetCode](https://leetcode.com/problems/best-sightseeing-pair))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/best-sightseeing-pair) for full constraints
 ...
 */
function bestSightseeingPairBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bestSightseeingPair(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bestSightseeingPair(/* example 1 */)); // expected
// console.log(bestSightseeingPair(/* example 2 */)); // expected
// console.log(bestSightseeingPair(/* edge case */)); // expected
```
...
- [Best Sightseeing Pair — LeetCode](https://leetcode.com/problems/best-sightseeing-pair) — problem page
