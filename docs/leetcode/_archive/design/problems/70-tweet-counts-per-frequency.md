...
> **See also**: [Number of Flowers in Full Bloom](https://leetcode.com/problems/number-of-flowers-in-full-bloom) | [Implement Router](https://leetcode.com/problems/implement-router)
...
**Visual — Tweet Counts Per Frequency example:**
...
Tweet Counts Per Frequency. ([LeetCode](https://leetcode.com/problems/tweet-counts-per-frequency))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/tweet-counts-per-frequency) for full constraints
 ...
 */
function tweetCountsPerFrequencyBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function tweetCountsPerFrequency(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(tweetCountsPerFrequency(/* example 1 */)); // expected
// console.log(tweetCountsPerFrequency(/* example 2 */)); // expected
// console.log(tweetCountsPerFrequency(/* edge case */)); // expected
```
...
- [Tweet Counts Per Frequency — LeetCode](https://leetcode.com/problems/tweet-counts-per-frequency) — problem page
