...
**Visual — Implement Trie II (Prefix Tree) example:**
...
Implement Trie II (Prefix Tree). ([LeetCode](https://leetcode.com/problems/implement-trie-ii-prefix-tree))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/implement-trie-ii-prefix-tree) for full constraints
 ...
 */
function implementTrieIiPrefixTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function implementTrieIiPrefixTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(implementTrieIiPrefixTree(/* example 1 */)); // expected
// console.log(implementTrieIiPrefixTree(/* example 2 */)); // expected
// console.log(implementTrieIiPrefixTree(/* edge case */)); // expected
```
...
- [Implement Trie II (Prefix Tree) — LeetCode](https://leetcode.com/problems/implement-trie-ii-prefix-tree) — problem page
