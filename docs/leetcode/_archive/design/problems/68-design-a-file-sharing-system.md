...
> **See also**: [Find Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream) | [Stock Price Fluctuation](https://leetcode.com/problems/stock-price-fluctuation)
...
**Visual — Design a File Sharing System example:**
...
Design a File Sharing System. ([LeetCode](https://leetcode.com/problems/design-a-file-sharing-system))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-a-file-sharing-system) for full constraints
 ...
 */
function designAFileSharingSystemBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designAFileSharingSystem(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designAFileSharingSystem(/* example 1 */)); // expected
// console.log(designAFileSharingSystem(/* example 2 */)); // expected
// console.log(designAFileSharingSystem(/* edge case */)); // expected
```
...
- [Design a File Sharing System — LeetCode](https://leetcode.com/problems/design-a-file-sharing-system) — problem page
