...
> **See also**: [Online Majority Element In Subarray](https://leetcode.com/problems/online-majority-element-in-subarray) | [The Skyline Problem](https://leetcode.com/problems/the-skyline-problem)
...
**Visual — Range Sum Query - Mutable example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/range-sum-query-mutable) for full constraints
 ...
 */
function rangeSumQueryMutableBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rangeSumQueryMutable(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rangeSumQueryMutable(/* example 1 */)); // expected
// console.log(rangeSumQueryMutable(/* example 2 */)); // expected
// console.log(rangeSumQueryMutable(/* edge case */)); // expected
```
...
- [Range Sum Query - Mutable — LeetCode](https://leetcode.com/problems/range-sum-query-mutable) — problem page
