...
leetcode_url: "https://leetcode.com/problems/design-a-todo-list"
---

# Design a Todo List / Design a Todo List
...
**Visual — Design a Todo List example:**
...
Design a Todo List. ([LeetCode](https://leetcode.com/problems/design-a-todo-list))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-a-todo-list) for full constraints
 ...
 */
function designATodoListBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designATodoList(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designATodoList(/* example 1 */)); // expected
// console.log(designATodoList(/* example 2 */)); // expected
// console.log(designATodoList(/* edge case */)); // expected
```
...
- [Design a Todo List — LeetCode](https://leetcode.com/problems/design-a-todo-list) — problem page
