...
> **See also**: [Design Search Autocomplete System](https://leetcode.com/problems/design-search-autocomplete-system) | [Encrypt and Decrypt Strings](https://leetcode.com/problems/encrypt-and-decrypt-strings)
...
**Visual — Stream of Characters example:**
...
Stream of Characters. ([LeetCode](https://leetcode.com/problems/stream-of-characters))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/stream-of-characters) for full constraints
 ...
 */
function streamOfCharactersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function streamOfCharacters(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(streamOfCharacters(/* example 1 */)); // expected
// console.log(streamOfCharacters(/* example 2 */)); // expected
// console.log(streamOfCharacters(/* edge case */)); // expected
```
...
- [Stream of Characters — LeetCode](https://leetcode.com/problems/stream-of-characters) — problem page
