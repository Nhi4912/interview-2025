...
leetcode_url: "https://leetcode.com/problems/design-an-atm-machine"
---
...
**Visual — Design an ATM Machine example:**
...
Design an ATM Machine. ([LeetCode](https://leetcode.com/problems/design-an-atm-machine))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-an-atm-machine) for full constraints
 ...
 */
function designAnAtmMachineBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designAnAtmMachine(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designAnAtmMachine(/* example 1 */)); // expected
// console.log(designAnAtmMachine(/* example 2 */)); // expected
// console.log(designAnAtmMachine(/* edge case */)); // expected
```
...
- [Design an ATM Machine — LeetCode](https://leetcode.com/problems/design-an-atm-machine) — problem page
