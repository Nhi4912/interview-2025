...
leetcode_url: "https://leetcode.com/problems/minimum-operations-to-make-array-equal-ii"
---

# Minimum Operations to Make Array Equal II / Minimum Operations to Make Array Equal II
...
**Visual — Minimum Operations to Make Array Equal II example:**
...
Minimum Operations to Make Array Equal II. ([LeetCode](https://leetcode.com/problems/minimum-operations-to-make-array-equal-ii))

Difficulty: Medium | Acceptance: 32.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-operations-to-make-array-equal-ii) for full constraints
 ...
 */
function minimumOperationsToMakeArrayEqualIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumOperationsToMakeArrayEqualIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumOperationsToMakeArrayEqualIi(/* example 1 */)); // expected
// console.log(minimumOperationsToMakeArrayEqualIi(/* example 2 */)); // expected
// console.log(minimumOperationsToMakeArrayEqualIi(/* edge case */)); // expected
```
...
- [Minimum Operations to Make Array Equal II — LeetCode](https://leetcode.com/problems/minimum-operations-to-make-array-equal-ii) — problem page
