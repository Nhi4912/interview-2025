...
leetcode_url: "https://leetcode.com/problems/alternating-groups-ii"
---

# Alternating Groups II / Alternating Groups II
...
**Visual — Alternating Groups II example:**
...
Alternating Groups II. ([LeetCode](https://leetcode.com/problems/alternating-groups-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/alternating-groups-ii) for full constraints
 ...
 */
function alternatingGroupsIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function alternatingGroupsIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(alternatingGroupsIi(/* example 1 */)); // expected
// console.log(alternatingGroupsIi(/* example 2 */)); // expected
// console.log(alternatingGroupsIi(/* edge case */)); // expected
```
...
- [Alternating Groups II — LeetCode](https://leetcode.com/problems/alternating-groups-ii) — problem page
