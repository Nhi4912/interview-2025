...
**Visual — Number of Subarrays with Bounded Maximum example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum) for full constraints
 ...
 */
function numberOfSubarraysWithBoundedMaximumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfSubarraysWithBoundedMaximum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfSubarraysWithBoundedMaximum(/* example 1 */)); // expected
// console.log(numberOfSubarraysWithBoundedMaximum(/* example 2 */)); // expected
// console.log(numberOfSubarraysWithBoundedMaximum(/* edge case */)); // expected
```
...
- [Number of Subarrays with Bounded Maximum — LeetCode](https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum) — problem page
