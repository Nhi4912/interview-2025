...
leetcode_url: "https://leetcode.com/problems/split-the-array"
---
...
**Visual — Split the Array example:**
...
Split the Array. ([LeetCode](https://leetcode.com/problems/split-the-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/split-the-array) for full constraints
 ...
 */
function splitTheArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function splitTheArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(splitTheArray(/* example 1 */)); // expected
// console.log(splitTheArray(/* example 2 */)); // expected
// console.log(splitTheArray(/* edge case */)); // expected
```
...
- [Split the Array — LeetCode](https://leetcode.com/problems/split-the-array) — problem page
