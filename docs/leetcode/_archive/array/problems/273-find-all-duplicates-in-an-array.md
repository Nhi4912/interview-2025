...
**Visual — Find All Duplicates in an Array example:**
...
Difficulty: Medium | Acceptance: 76.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-all-duplicates-in-an-array) for full constraints
 ...
 */
function findAllDuplicatesInAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findAllDuplicatesInAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findAllDuplicatesInAnArray(/* example 1 */)); // expected
// console.log(findAllDuplicatesInAnArray(/* example 2 */)); // expected
// console.log(findAllDuplicatesInAnArray(/* edge case */)); // expected
```
...
- [Find All Duplicates in an Array — LeetCode](https://leetcode.com/problems/find-all-duplicates-in-an-array) — problem page
