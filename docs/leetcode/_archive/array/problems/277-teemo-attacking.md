...
**Analogy:** Phân tích bài "Teemo Attacking" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Teemo Attacking example:**
...
Teemo Attacking. ([LeetCode](https://leetcode.com/problems/teemo-attacking))

Difficulty: Easy | Acceptance: 56.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/teemo-attacking) for full constraints
 ...
 */
function teemoAttackingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function teemoAttacking(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(teemoAttacking(/* example 1 */)); // expected
// console.log(teemoAttacking(/* example 2 */)); // expected
// console.log(teemoAttacking(/* edge case */)); // expected
```
...
- [Teemo Attacking — LeetCode](https://leetcode.com/problems/teemo-attacking) — problem page
