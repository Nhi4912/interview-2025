...
**Analogy:** Phân tích bài "Maximum Profit of Operating a Centennial Wheel" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Maximum Profit of Operating a Centennial Wheel example:**
...
Maximum Profit of Operating a Centennial Wheel. ([LeetCode](https://leetcode.com/problems/maximum-profit-of-operating-a-centennial-wheel))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-profit-of-operating-a-centennial-wheel) for full constraints
 ...
 */
function maximumProfitOfOperatingACentennialWheelBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumProfitOfOperatingACentennialWheel(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumProfitOfOperatingACentennialWheel(/* example 1 */)); // expected
// console.log(maximumProfitOfOperatingACentennialWheel(/* example 2 */)); // expected
// console.log(maximumProfitOfOperatingACentennialWheel(/* edge case */)); // expected
```
...
- [Maximum Profit of Operating a Centennial Wheel — LeetCode](https://leetcode.com/problems/maximum-profit-of-operating-a-centennial-wheel) — problem page
