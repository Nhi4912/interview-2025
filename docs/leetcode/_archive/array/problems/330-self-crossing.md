...
Self Crossing. ([LeetCode](https://leetcode.com/problems/self-crossing))

Difficulty: Hard | Acceptance: 32.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/self-crossing) for full constraints
 ...
 */
function selfCrossingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function selfCrossing(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(selfCrossing(/* example 1 */)); // expected
// console.log(selfCrossing(/* example 2 */)); // expected
// console.log(selfCrossing(/* edge case */)); // expected
```
...
- [Self Crossing — LeetCode](https://leetcode.com/problems/self-crossing) — problem page
