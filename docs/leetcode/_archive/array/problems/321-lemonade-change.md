...
**Visual — Lemonade Change example:**
...
Difficulty: Easy | Acceptance: 58.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/lemonade-change) for full constraints
 ...
 */
function lemonadeChangeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lemonadeChange(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lemonadeChange(/* example 1 */)); // expected
// console.log(lemonadeChange(/* example 2 */)); // expected
// console.log(lemonadeChange(/* edge case */)); // expected
```
...
- [Lemonade Change — LeetCode](https://leetcode.com/problems/lemonade-change) — problem page
