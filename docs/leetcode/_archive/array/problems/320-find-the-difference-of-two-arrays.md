...
leetcode_url: "https://leetcode.com/problems/find-the-difference-of-two-arrays"
---
...
**Visual — Find the Difference of Two Arrays example:**
...
Find the Difference of Two Arrays. ([LeetCode](https://leetcode.com/problems/find-the-difference-of-two-arrays))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-difference-of-two-arrays) for full constraints
 ...
 */
function findTheDifferenceOfTwoArraysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheDifferenceOfTwoArrays(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheDifferenceOfTwoArrays(/* example 1 */)); // expected
// console.log(findTheDifferenceOfTwoArrays(/* example 2 */)); // expected
// console.log(findTheDifferenceOfTwoArrays(/* edge case */)); // expected
```
...
- [Find the Difference of Two Arrays — LeetCode](https://leetcode.com/problems/find-the-difference-of-two-arrays) — problem page
