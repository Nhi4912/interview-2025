...
**Analogy:** Phân tích bài "Create Target Array in the Given Order" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Create Target Array in the Given Order example:**
...
Difficulty: Easy | Acceptance: 86.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/create-target-array-in-the-given-order) for full constraints
 ...
 */
function createTargetArrayInTheGivenOrderBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function createTargetArrayInTheGivenOrder(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(createTargetArrayInTheGivenOrder(/* example 1 */)); // expected
// console.log(createTargetArrayInTheGivenOrder(/* example 2 */)); // expected
// console.log(createTargetArrayInTheGivenOrder(/* edge case */)); // expected
```
...
- [Create Target Array in the Given Order — LeetCode](https://leetcode.com/problems/create-target-array-in-the-given-order) — problem page
