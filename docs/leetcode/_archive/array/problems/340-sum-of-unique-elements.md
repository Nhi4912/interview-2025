...
**Visual — Sum of Unique Elements example:**
...
Sum of Unique Elements. ([LeetCode](https://leetcode.com/problems/sum-of-unique-elements))

Difficulty: Easy | Acceptance: 79.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-of-unique-elements) for full constraints
 ...
 */
function sumOfUniqueElementsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumOfUniqueElements(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumOfUniqueElements(/* example 1 */)); // expected
// console.log(sumOfUniqueElements(/* example 2 */)); // expected
// console.log(sumOfUniqueElements(/* edge case */)); // expected
```
...
- [Sum of Unique Elements — LeetCode](https://leetcode.com/problems/sum-of-unique-elements) — problem page
