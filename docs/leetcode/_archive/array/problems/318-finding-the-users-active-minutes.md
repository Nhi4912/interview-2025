...
**Visual — Finding the Users Active Minutes example:**
...
Finding the Users Active Minutes. ([LeetCode](https://leetcode.com/problems/finding-the-users-active-minutes))

Difficulty: Medium | Acceptance: 80.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/finding-the-users-active-minutes) for full constraints
 ...
 */
function findingTheUsersActiveMinutesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findingTheUsersActiveMinutes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findingTheUsersActiveMinutes(/* example 1 */)); // expected
// console.log(findingTheUsersActiveMinutes(/* example 2 */)); // expected
// console.log(findingTheUsersActiveMinutes(/* edge case */)); // expected
```
...
- [Finding the Users Active Minutes — LeetCode](https://leetcode.com/problems/finding-the-users-active-minutes) — problem page
