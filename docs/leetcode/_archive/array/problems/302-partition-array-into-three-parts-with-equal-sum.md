...
**Visual — Partition Array Into Three Parts With Equal Sum example:**
...
Partition Array Into Three Parts With Equal Sum. ([LeetCode](https://leetcode.com/problems/partition-array-into-three-parts-with-equal-sum))

Difficulty: Easy | Acceptance: 42.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/partition-array-into-three-parts-with-equal-sum) for full constraints
 ...
 */
function partitionArrayIntoThreePartsWithEqualSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function partitionArrayIntoThreePartsWithEqualSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(partitionArrayIntoThreePartsWithEqualSum(/* example 1 */)); // expected
// console.log(partitionArrayIntoThreePartsWithEqualSum(/* example 2 */)); // expected
// console.log(partitionArrayIntoThreePartsWithEqualSum(/* edge case */)); // expected
```
...
- [Partition Array Into Three Parts With Equal Sum — LeetCode](https://leetcode.com/problems/partition-array-into-three-parts-with-equal-sum) — problem page
