...
leetcode_url: "https://leetcode.com/problems/intervals-between-identical-elements"
---
...
**Visual — Intervals Between Identical Elements example:**
...
Intervals Between Identical Elements. ([LeetCode](https://leetcode.com/problems/intervals-between-identical-elements))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/intervals-between-identical-elements) for full constraints
 ...
 */
function intervalsBetweenIdenticalElementsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function intervalsBetweenIdenticalElements(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(intervalsBetweenIdenticalElements(/* example 1 */)); // expected
// console.log(intervalsBetweenIdenticalElements(/* example 2 */)); // expected
// console.log(intervalsBetweenIdenticalElements(/* edge case */)); // expected
```
...
- [Intervals Between Identical Elements — LeetCode](https://leetcode.com/problems/intervals-between-identical-elements) — problem page
