...
leetcode_url: "https://leetcode.com/problems/make-a-positive-array"
---

# Make a Positive Array / Make a Positive Array
...
**Visual — Make a Positive Array example:**
...
Make a Positive Array. ([LeetCode](https://leetcode.com/problems/make-a-positive-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/make-a-positive-array) for full constraints
 ...
 */
function makeAPositiveArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function makeAPositiveArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(makeAPositiveArray(/* example 1 */)); // expected
// console.log(makeAPositiveArray(/* example 2 */)); // expected
// console.log(makeAPositiveArray(/* edge case */)); // expected
```
...
- [Make a Positive Array — LeetCode](https://leetcode.com/problems/make-a-positive-array) — problem page
