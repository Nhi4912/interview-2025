...
Difficulty: Easy | Acceptance: 78.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/baseball-game) for full constraints
 ...
 */
function baseballGameBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function baseballGame(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(baseballGame(/* example 1 */)); // expected
// console.log(baseballGame(/* example 2 */)); // expected
// console.log(baseballGame(/* edge case */)); // expected
```
...
- [Baseball Game — LeetCode](https://leetcode.com/problems/baseball-game) — problem page
