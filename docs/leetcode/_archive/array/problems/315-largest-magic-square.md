...
**Visual — Largest Magic Square example:**
...
Largest Magic Square. ([LeetCode](https://leetcode.com/problems/largest-magic-square))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-magic-square) for full constraints
 ...
 */
function largestMagicSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestMagicSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestMagicSquare(/* example 1 */)); // expected
// console.log(largestMagicSquare(/* example 2 */)); // expected
// console.log(largestMagicSquare(/* edge case */)); // expected
```
...
- [Largest Magic Square — LeetCode](https://leetcode.com/problems/largest-magic-square) — problem page
