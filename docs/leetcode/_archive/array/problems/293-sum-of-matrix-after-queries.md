...
leetcode_url: "https://leetcode.com/problems/sum-of-matrix-after-queries"
---
...
**Visual — Sum of Matrix After Queries example:**
...
Sum of Matrix After Queries. ([LeetCode](https://leetcode.com/problems/sum-of-matrix-after-queries))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-of-matrix-after-queries) for full constraints
 ...
 */
function sumOfMatrixAfterQueriesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumOfMatrixAfterQueries(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumOfMatrixAfterQueries(/* example 1 */)); // expected
// console.log(sumOfMatrixAfterQueries(/* example 2 */)); // expected
// console.log(sumOfMatrixAfterQueries(/* edge case */)); // expected
```
...
- [Sum of Matrix After Queries — LeetCode](https://leetcode.com/problems/sum-of-matrix-after-queries) — problem page
