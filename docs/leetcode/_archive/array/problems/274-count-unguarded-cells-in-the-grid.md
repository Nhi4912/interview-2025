...
**Analogy:** Phân tích bài "Count Unguarded Cells in the Grid" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Count Unguarded Cells in the Grid example:**
...
Count Unguarded Cells in the Grid. ([LeetCode](https://leetcode.com/problems/count-unguarded-cells-in-the-grid))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-unguarded-cells-in-the-grid) for full constraints
 ...
 */
function countUnguardedCellsInTheGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countUnguardedCellsInTheGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countUnguardedCellsInTheGrid(/* example 1 */)); // expected
// console.log(countUnguardedCellsInTheGrid(/* example 2 */)); // expected
// console.log(countUnguardedCellsInTheGrid(/* edge case */)); // expected
```
...
- [Count Unguarded Cells in the Grid — LeetCode](https://leetcode.com/problems/count-unguarded-cells-in-the-grid) — problem page
