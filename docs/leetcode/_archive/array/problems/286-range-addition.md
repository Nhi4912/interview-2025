...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/range-addition) for full constraints
 ...
 */
function rangeAdditionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rangeAddition(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rangeAddition(/* example 1 */)); // expected
// console.log(rangeAddition(/* example 2 */)); // expected
// console.log(rangeAddition(/* edge case */)); // expected
```
...
- [Range Addition — LeetCode](https://leetcode.com/problems/range-addition) — problem page
