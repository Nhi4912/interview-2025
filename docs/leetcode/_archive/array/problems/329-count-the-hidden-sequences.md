...
leetcode_url: "https://leetcode.com/problems/count-the-hidden-sequences"
---
...
**Visual — Count the Hidden Sequences example:**
...
Count the Hidden Sequences. ([LeetCode](https://leetcode.com/problems/count-the-hidden-sequences))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-the-hidden-sequences) for full constraints
 ...
 */
function countTheHiddenSequencesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countTheHiddenSequences(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countTheHiddenSequences(/* example 1 */)); // expected
// console.log(countTheHiddenSequences(/* example 2 */)); // expected
// console.log(countTheHiddenSequences(/* edge case */)); // expected
```
...
- [Count the Hidden Sequences — LeetCode](https://leetcode.com/problems/count-the-hidden-sequences) — problem page
