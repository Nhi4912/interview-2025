...
leetcode_url: "https://leetcode.com/problems/maximum-array-hopping-score-ii"
---

# Maximum Array Hopping Score II / Maximum Array Hopping Score II

> **Track**: Shared | **Difficulty**: 🟡 Medium | **Pattern**: Monotonic Stack
> **Frequency**: 📘 Tier 3 — Gặp ở 1 companies
> **See also**: [Minimum Cost Tree From Leaf Values](https://leetcode.com/problems/minimum-cost-tree-from-leaf-values) | [Create Maximum Number](https://leetcode.com/problems/create-maximum-number)
...
**Visual — Maximum Array Hopping Score II example:**
...
Maximum Array Hopping Score II. ([LeetCode](https://leetcode.com/problems/maximum-array-hopping-score-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-array-hopping-score-ii) for full constraints
 ...
 */
function maximumArrayHoppingScoreIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumArrayHoppingScoreIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumArrayHoppingScoreIi(/* example 1 */)); // expected
// console.log(maximumArrayHoppingScoreIi(/* example 2 */)); // expected
// console.log(maximumArrayHoppingScoreIi(/* edge case */)); // expected
```
...
- [Maximum Array Hopping Score II — LeetCode](https://leetcode.com/problems/maximum-array-hopping-score-ii) — problem page
