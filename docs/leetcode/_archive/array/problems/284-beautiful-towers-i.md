...
leetcode_url: "https://leetcode.com/problems/beautiful-towers-i"
---
...
**Visual — Beautiful Towers I example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/beautiful-towers-i) for full constraints
 ...
 */
function beautifulTowersIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function beautifulTowersI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(beautifulTowersI(/* example 1 */)); // expected
// console.log(beautifulTowersI(/* example 2 */)); // expected
// console.log(beautifulTowersI(/* edge case */)); // expected
```
...
- [Beautiful Towers I — LeetCode](https://leetcode.com/problems/beautiful-towers-i) — problem page
