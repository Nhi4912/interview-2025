...
**Analogy:** Phân tích bài "Shuffle the Array" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Shuffle the Array example:**
...
Difficulty: Easy | Acceptance: 88.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/shuffle-the-array) for full constraints
 ...
 */
function shuffleTheArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function shuffleTheArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(shuffleTheArray(/* example 1 */)); // expected
// console.log(shuffleTheArray(/* example 2 */)); // expected
// console.log(shuffleTheArray(/* edge case */)); // expected
```
...
- [Shuffle the Array — LeetCode](https://leetcode.com/problems/shuffle-the-array) — problem page
