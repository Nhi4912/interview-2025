...
category: Array
tags: [Array]
leetcode_url: "https://leetcode.com/problems/find-closest-number-to-zero"
---
...
**Analogy:** Phân tích bài "Find Closest Number to Zero" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Closest Number to Zero example:**
...
Find Closest Number to Zero. ([LeetCode](https://leetcode.com/problems/find-closest-number-to-zero))

Difficulty: Easy | Acceptance: 47.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-closest-number-to-zero) for full constraints
 ...
 */
function findClosestNumberToZeroBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findClosestNumberToZero(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findClosestNumberToZero(/* example 1 */)); // expected
// console.log(findClosestNumberToZero(/* example 2 */)); // expected
// console.log(findClosestNumberToZero(/* edge case */)); // expected
```
...
- [Find Closest Number to Zero — LeetCode](https://leetcode.com/problems/find-closest-number-to-zero) — problem page
