...
leetcode_url: "https://leetcode.com/problems/beautiful-towers-ii"
---

# Beautiful Towers II / Beautiful Towers II
...
**Visual — Beautiful Towers II example:**
...
Beautiful Towers II. ([LeetCode](https://leetcode.com/problems/beautiful-towers-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/beautiful-towers-ii) for full constraints
 ...
 */
function beautifulTowersIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function beautifulTowersIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(beautifulTowersIi(/* example 1 */)); // expected
// console.log(beautifulTowersIi(/* example 2 */)); // expected
// console.log(beautifulTowersIi(/* edge case */)); // expected
```
...
- [Beautiful Towers II — LeetCode](https://leetcode.com/problems/beautiful-towers-ii) — problem page
