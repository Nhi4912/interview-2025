...
**Visual — Group the People Given the Group Size They Belong To example:**
...
Group the People Given the Group Size They Belong To. ([LeetCode](https://leetcode.com/problems/group-the-people-given-the-group-size-they-belong-to))

Difficulty: Medium | Acceptance: 87.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/group-the-people-given-the-group-size-they-belong-to) for full constraints
 ...
 */
function groupThePeopleGivenTheGroupSizeTheyBelongToBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function groupThePeopleGivenTheGroupSizeTheyBelongTo(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(groupThePeopleGivenTheGroupSizeTheyBelongTo(/* example 1 */)); // expected
// console.log(groupThePeopleGivenTheGroupSizeTheyBelongTo(/* example 2 */)); // expected
// console.log(groupThePeopleGivenTheGroupSizeTheyBelongTo(/* edge case */)); // expected
```
...
- [Group the People Given the Group Size They Belong To — LeetCode](https://leetcode.com/problems/group-the-people-given-the-group-size-they-belong-to) — problem page
