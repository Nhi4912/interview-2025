...
**Analogy:** Phân tích bài "Second Degree Follower" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Second Degree Follower example:**
...
Second Degree Follower. ([LeetCode](https://leetcode.com/problems/second-degree-follower))

Difficulty: Medium | Acceptance: 40.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/second-degree-follower) for full constraints
 ...
 */
function secondDegreeFollowerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function secondDegreeFollower(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(secondDegreeFollower(/* example 1 */)); // expected
// console.log(secondDegreeFollower(/* example 2 */)); // expected
// console.log(secondDegreeFollower(/* edge case */)); // expected
```
...
- [Second Degree Follower — LeetCode](https://leetcode.com/problems/second-degree-follower) — problem page
