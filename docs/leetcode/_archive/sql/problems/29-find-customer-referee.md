...
**Analogy:** Phân tích bài "Find Customer Referee" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Customer Referee example:**
...
Difficulty: Easy | Acceptance: 71.7%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-customer-referee) for full constraints
 ...
 */
function findCustomerRefereeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findCustomerReferee(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findCustomerReferee(/* example 1 */)); // expected
// console.log(findCustomerReferee(/* example 2 */)); // expected
// console.log(findCustomerReferee(/* edge case */)); // expected
```
...
- [Find Customer Referee — LeetCode](https://leetcode.com/problems/find-customer-referee) — problem page
