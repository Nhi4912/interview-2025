...
**Analogy:** Phân tích bài "Monthly Transactions I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Monthly Transactions I example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/monthly-transactions-i) for full constraints
 ...
 */
function monthlyTransactionsIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function monthlyTransactionsI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(monthlyTransactionsI(/* example 1 */)); // expected
// console.log(monthlyTransactionsI(/* example 2 */)); // expected
// console.log(monthlyTransactionsI(/* edge case */)); // expected
```
...
- [Monthly Transactions I — LeetCode](https://leetcode.com/problems/monthly-transactions-i) — problem page
