...
**Analogy:** Phân tích bài "Employee Bonus" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/employee-bonus) for full constraints
 ...
 */
function employeeBonusBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function employeeBonus(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(employeeBonus(/* example 1 */)); // expected
// console.log(employeeBonus(/* example 2 */)); // expected
// console.log(employeeBonus(/* edge case */)); // expected
```
...
- [Employee Bonus — LeetCode](https://leetcode.com/problems/employee-bonus) — problem page
