...
**Analogy:** Phân tích bài "Monthly Transactions II" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Monthly Transactions II example:**
...
Monthly Transactions II. ([LeetCode](https://leetcode.com/problems/monthly-transactions-ii))

Difficulty: Medium | Acceptance: 42.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/monthly-transactions-ii) for full constraints
 ...
 */
function monthlyTransactionsIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function monthlyTransactionsIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(monthlyTransactionsIi(/* example 1 */)); // expected
// console.log(monthlyTransactionsIi(/* example 2 */)); // expected
// console.log(monthlyTransactionsIi(/* edge case */)); // expected
```
...
- [Monthly Transactions II — LeetCode](https://leetcode.com/problems/monthly-transactions-ii) — problem page
