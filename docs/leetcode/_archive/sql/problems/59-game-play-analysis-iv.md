...
**Analogy:** Phân tích bài "Game Play Analysis IV" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Game Play Analysis IV example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/game-play-analysis-iv) for full constraints
 ...
 */
function gamePlayAnalysisIvBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gamePlayAnalysisIv(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gamePlayAnalysisIv(/* example 1 */)); // expected
// console.log(gamePlayAnalysisIv(/* example 2 */)); // expected
// console.log(gamePlayAnalysisIv(/* edge case */)); // expected
```
...
- [Game Play Analysis IV — LeetCode](https://leetcode.com/problems/game-play-analysis-iv) — problem page
