...
**Analogy:** Phân tích bài "Rank Scores" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rank-scores) for full constraints
 ...
 */
function rankScoresBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rankScores(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rankScores(/* example 1 */)); // expected
// console.log(rankScores(/* example 2 */)); // expected
// console.log(rankScores(/* edge case */)); // expected
```
...
- [Rank Scores — LeetCode](https://leetcode.com/problems/rank-scores) — problem page
