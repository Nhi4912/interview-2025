...
**Analogy:** Phân tích bài "Game Play Analysis I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Game Play Analysis I example:**
...
Difficulty: Easy | Acceptance: 75.8%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/game-play-analysis-i) for full constraints
 ...
 */
function gamePlayAnalysisIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gamePlayAnalysisI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gamePlayAnalysisI(/* example 1 */)); // expected
// console.log(gamePlayAnalysisI(/* example 2 */)); // expected
// console.log(gamePlayAnalysisI(/* edge case */)); // expected
```
...
- [Game Play Analysis I — LeetCode](https://leetcode.com/problems/game-play-analysis-i) — problem page
