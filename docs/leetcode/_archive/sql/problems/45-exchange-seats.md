...
**Analogy:** Phân tích bài "Exchange Seats" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/exchange-seats) for full constraints
 ...
 */
function exchangeSeatsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function exchangeSeats(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(exchangeSeats(/* example 1 */)); // expected
// console.log(exchangeSeats(/* example 2 */)); // expected
// console.log(exchangeSeats(/* edge case */)); // expected
```
...
- [Exchange Seats — LeetCode](https://leetcode.com/problems/exchange-seats) — problem page
