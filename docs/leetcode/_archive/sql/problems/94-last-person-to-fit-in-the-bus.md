...
category: Others
tags: [Database]
leetcode_url: "https://leetcode.com/problems/last-person-to-fit-in-the-bus"
---
...
**Analogy:** Phân tích bài "Last Person to Fit in the Bus" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Last Person to Fit in the Bus example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/last-person-to-fit-in-the-bus) for full constraints
 ...
 */
function lastPersonToFitInTheBusBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function lastPersonToFitInTheBus(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(lastPersonToFitInTheBus(/* example 1 */)); // expected
// console.log(lastPersonToFitInTheBus(/* example 2 */)); // expected
// console.log(lastPersonToFitInTheBus(/* edge case */)); // expected
```
...
- [Last Person to Fit in the Bus — LeetCode](https://leetcode.com/problems/last-person-to-fit-in-the-bus) — problem page
