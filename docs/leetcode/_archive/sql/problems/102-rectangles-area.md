...
**Analogy:** Phân tích bài "Rectangles Area" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Rectangles Area example:**
...
Rectangles Area. ([LeetCode](https://leetcode.com/problems/rectangles-area))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rectangles-area) for full constraints
 ...
 */
function rectanglesAreaBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rectanglesArea(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rectanglesArea(/* example 1 */)); // expected
// console.log(rectanglesArea(/* example 2 */)); // expected
// console.log(rectanglesArea(/* edge case */)); // expected
```
...
- [Rectangles Area — LeetCode](https://leetcode.com/problems/rectangles-area) — problem page
