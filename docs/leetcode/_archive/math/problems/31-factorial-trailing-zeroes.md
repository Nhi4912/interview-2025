...
**Visual — Factorial Trailing Zeroes example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/factorial-trailing-zeroes) for full constraints
 ...
 */
function factorialTrailingZeroesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function factorialTrailingZeroes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(factorialTrailingZeroes(/* example 1 */)); // expected
// console.log(factorialTrailingZeroes(/* example 2 */)); // expected
// console.log(factorialTrailingZeroes(/* edge case */)); // expected
```
...
- [Factorial Trailing Zeroes — LeetCode](https://leetcode.com/problems/factorial-trailing-zeroes) — problem page
