...
Difficulty: Easy | Acceptance: 42.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/ugly-number) for full constraints
 ...
 */
function uglyNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function uglyNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(uglyNumber(/* example 1 */)); // expected
// console.log(uglyNumber(/* example 2 */)); // expected
// console.log(uglyNumber(/* edge case */)); // expected
```
...
- [Ugly Number — LeetCode](https://leetcode.com/problems/ugly-number) — problem page
