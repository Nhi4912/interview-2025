...
category: Math
tags: [Math, Geometry]
leetcode_url: "https://leetcode.com/problems/minimum-cuts-to-divide-a-circle"
---

# Minimum Cuts to Divide a Circle / Minimum Cuts to Divide a Circle
...
**Visual — Minimum Cuts to Divide a Circle example:**
...
Minimum Cuts to Divide a Circle. ([LeetCode](https://leetcode.com/problems/minimum-cuts-to-divide-a-circle))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-cuts-to-divide-a-circle) for full constraints
 ...
 */
function minimumCutsToDivideACircleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumCutsToDivideACircle(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumCutsToDivideACircle(/* example 1 */)); // expected
// console.log(minimumCutsToDivideACircle(/* example 2 */)); // expected
// console.log(minimumCutsToDivideACircle(/* edge case */)); // expected
```
...
- [Minimum Cuts to Divide a Circle — LeetCode](https://leetcode.com/problems/minimum-cuts-to-divide-a-circle) — problem page
