...
**Visual — Self Dividing Numbers example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/self-dividing-numbers) for full constraints
 ...
 */
function selfDividingNumbersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function selfDividingNumbers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(selfDividingNumbers(/* example 1 */)); // expected
// console.log(selfDividingNumbers(/* example 2 */)); // expected
// console.log(selfDividingNumbers(/* edge case */)); // expected
```
...
- [Self Dividing Numbers — LeetCode](https://leetcode.com/problems/self-dividing-numbers) — problem page
