...
category: Math
tags: [Math, Greedy]
leetcode_url: "https://leetcode.com/problems/determine-the-minimum-sum-of-a-k-avoiding-array"
---

# Determine the Minimum Sum of a k-avoiding Array / Determine the Minimum Sum of a k-avoiding Array
...
**Visual — Determine the Minimum Sum of a k-avoiding Array example:**
...
Determine the Minimum Sum of a k-avoiding Array. ([LeetCode](https://leetcode.com/problems/determine-the-minimum-sum-of-a-k-avoiding-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/determine-the-minimum-sum-of-a-k-avoiding-array) for full constraints
 ...
 */
function determineTheMinimumSumOfAKAvoidingArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function determineTheMinimumSumOfAKAvoidingArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(determineTheMinimumSumOfAKAvoidingArray(/* example 1 */)); // expected
// console.log(determineTheMinimumSumOfAKAvoidingArray(/* example 2 */)); // expected
// console.log(determineTheMinimumSumOfAKAvoidingArray(/* edge case */)); // expected
```
...
- [Determine the Minimum Sum of a k-avoiding Array — LeetCode](https://leetcode.com/problems/determine-the-minimum-sum-of-a-k-avoiding-array) — problem page
