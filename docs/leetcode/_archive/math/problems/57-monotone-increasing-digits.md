...
**Visual — Monotone Increasing Digits example:**
...
Monotone Increasing Digits. ([LeetCode](https://leetcode.com/problems/monotone-increasing-digits))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/monotone-increasing-digits) for full constraints
 ...
 */
function monotoneIncreasingDigitsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function monotoneIncreasingDigits(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(monotoneIncreasingDigits(/* example 1 */)); // expected
// console.log(monotoneIncreasingDigits(/* example 2 */)); // expected
// console.log(monotoneIncreasingDigits(/* edge case */)); // expected
```
...
- [Monotone Increasing Digits — LeetCode](https://leetcode.com/problems/monotone-increasing-digits) — problem page
