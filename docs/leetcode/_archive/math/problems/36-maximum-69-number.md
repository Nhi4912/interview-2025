...
**Visual — Maximum 69 Number example:**
...
Maximum 69 Number. ([LeetCode](https://leetcode.com/problems/maximum-69-number))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-69-number) for full constraints
 ...
 */
function maximum69NumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximum69Number(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximum69Number(/* example 1 */)); // expected
// console.log(maximum69Number(/* example 2 */)); // expected
// console.log(maximum69Number(/* edge case */)); // expected
```
...
- [Maximum 69 Number — LeetCode](https://leetcode.com/problems/maximum-69-number) — problem page
