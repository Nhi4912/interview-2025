...
**Visual — Bitwise AND of Numbers Range example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bitwise-and-of-numbers-range) for full constraints
 ...
 */
function bitwiseAndOfNumbersRangeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bitwiseAndOfNumbersRange(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bitwiseAndOfNumbersRange(/* example 1 */)); // expected
// console.log(bitwiseAndOfNumbersRange(/* example 2 */)); // expected
// console.log(bitwiseAndOfNumbersRange(/* edge case */)); // expected
```
...
- [Bitwise AND of Numbers Range — LeetCode](https://leetcode.com/problems/bitwise-and-of-numbers-range) — problem page
