...
> **See also**: [Happy Number](https://leetcode.com/problems/happy-number) | [Missing Number](https://leetcode.com/problems/missing-number)
...
**Visual — Count Largest Group example:**
...
Count Largest Group. ([LeetCode](https://leetcode.com/problems/count-largest-group))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-largest-group) for full constraints
 ...
 */
function countLargestGroupBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countLargestGroup(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countLargestGroup(/* example 1 */)); // expected
// console.log(countLargestGroup(/* example 2 */)); // expected
// console.log(countLargestGroup(/* edge case */)); // expected
```
...
- [Count Largest Group — LeetCode](https://leetcode.com/problems/count-largest-group) — problem page
