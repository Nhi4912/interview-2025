...
**Visual — Number Complement example:**
...
Difficulty: Easy | Acceptance: 70.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-complement) for full constraints
 ...
 */
function numberComplementBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberComplement(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberComplement(/* example 1 */)); // expected
// console.log(numberComplement(/* example 2 */)); // expected
// console.log(numberComplement(/* edge case */)); // expected
```
...
- [Number Complement — LeetCode](https://leetcode.com/problems/number-complement) — problem page
