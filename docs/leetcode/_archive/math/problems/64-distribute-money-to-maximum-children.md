...
category: Math
tags: [Math, Greedy]
leetcode_url: "https://leetcode.com/problems/distribute-money-to-maximum-children"
---

# Distribute Money to Maximum Children / Distribute Money to Maximum Children
...
**Visual — Distribute Money to Maximum Children example:**
...
Distribute Money to Maximum Children. ([LeetCode](https://leetcode.com/problems/distribute-money-to-maximum-children))

Difficulty: Easy | Acceptance: 19.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/distribute-money-to-maximum-children) for full constraints
 ...
 */
function distributeMoneyToMaximumChildrenBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function distributeMoneyToMaximumChildren(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(distributeMoneyToMaximumChildren(/* example 1 */)); // expected
// console.log(distributeMoneyToMaximumChildren(/* example 2 */)); // expected
// console.log(distributeMoneyToMaximumChildren(/* edge case */)); // expected
```
...
- [Distribute Money to Maximum Children — LeetCode](https://leetcode.com/problems/distribute-money-to-maximum-children) — problem page
