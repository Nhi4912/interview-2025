...
category: Math
tags: [Math, Greedy]
leetcode_url: "https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful"
---

# Minimum Addition to Make Integer Beautiful / Minimum Addition to Make Integer Beautiful
...
**Visual — Minimum Addition to Make Integer Beautiful example:**
...
Minimum Addition to Make Integer Beautiful. ([LeetCode](https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful))

Difficulty: Medium | Acceptance: 38.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful) for full constraints
 ...
 */
function minimumAdditionToMakeIntegerBeautifulBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumAdditionToMakeIntegerBeautiful(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumAdditionToMakeIntegerBeautiful(/* example 1 */)); // expected
// console.log(minimumAdditionToMakeIntegerBeautiful(/* example 2 */)); // expected
// console.log(minimumAdditionToMakeIntegerBeautiful(/* edge case */)); // expected
```
...
- [Minimum Addition to Make Integer Beautiful — LeetCode](https://leetcode.com/problems/minimum-addition-to-make-integer-beautiful) — problem page
