...
Remove 9. ([LeetCode](https://leetcode.com/problems/remove-9))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/remove-9) for full constraints
 ...
 */
function remove9BruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function remove9(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(remove9(/* example 1 */)); // expected
// console.log(remove9(/* example 2 */)); // expected
// console.log(remove9(/* edge case */)); // expected
```
...
- [Remove 9 — LeetCode](https://leetcode.com/problems/remove-9) — problem page
