...
**Visual — Check if Point Is Reachable example:**
...
Check if Point Is Reachable. ([LeetCode](https://leetcode.com/problems/check-if-point-is-reachable))

Difficulty: Hard | Acceptance: 43.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-point-is-reachable) for full constraints
 ...
 */
function checkIfPointIsReachableBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfPointIsReachable(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfPointIsReachable(/* example 1 */)); // expected
// console.log(checkIfPointIsReachable(/* example 2 */)); // expected
// console.log(checkIfPointIsReachable(/* edge case */)); // expected
```
...
- [The kth Factor of n](https://leetcode.com/problems/the-kth-factor-of-n) — same pattern: Math
...
- [Check if Point Is Reachable — LeetCode](https://leetcode.com/problems/check-if-point-is-reachable) — problem page
