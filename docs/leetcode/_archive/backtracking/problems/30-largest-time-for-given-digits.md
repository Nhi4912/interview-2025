...
> **See also**: [Word Break II](https://leetcode.com/problems/word-break-ii) | [Synonymous Sentences](https://leetcode.com/problems/synonymous-sentences)
...
**Visual — Largest Time for Given Digits example:**
...
Largest Time for Given Digits. ([LeetCode](https://leetcode.com/problems/largest-time-for-given-digits))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-time-for-given-digits) for full constraints
 ...
 */
function largestTimeForGivenDigitsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestTimeForGivenDigits(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestTimeForGivenDigits(/* example 1 */)); // expected
// console.log(largestTimeForGivenDigits(/* example 2 */)); // expected
// console.log(largestTimeForGivenDigits(/* edge case */)); // expected
```
...
- [Largest Time for Given Digits — LeetCode](https://leetcode.com/problems/largest-time-for-given-digits) — problem page
