...
**Visual — Maximum Length of a Concatenated String with Unique Characters example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-length-of-a-concatenated-string-with-unique-characters) for full constraints
 ...
 */
function maximumLengthOfAConcatenatedStringWithUniqueCharactersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumLengthOfAConcatenatedStringWithUniqueCharacters(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumLengthOfAConcatenatedStringWithUniqueCharacters(/* example 1 */)); // expected
// console.log(maximumLengthOfAConcatenatedStringWithUniqueCharacters(/* example 2 */)); // expected
// console.log(maximumLengthOfAConcatenatedStringWithUniqueCharacters(/* edge case */)); // expected
```
...
- [Maximum Length of a Concatenated String with Unique Characters — LeetCode](https://leetcode.com/problems/maximum-length-of-a-concatenated-string-with-unique-characters) — problem page
