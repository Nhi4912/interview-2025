...
**Visual — Find the Minimum and Maximum Number of Nodes Between Critical Points example:**
...
Find the Minimum and Maximum Number of Nodes Between Critical Points. ([LeetCode](https://leetcode.com/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points))

Difficulty: Medium | Acceptance: 69.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points) for full constraints
 ...
 */
function findTheMinimumAndMaximumNumberOfNodesBetweenCriticalPointsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheMinimumAndMaximumNumberOfNodesBetweenCriticalPoints(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheMinimumAndMaximumNumberOfNodesBetweenCriticalPoints(/* example 1 */)); // expected
// console.log(findTheMinimumAndMaximumNumberOfNodesBetweenCriticalPoints(/* example 2 */)); // expected
// console.log(findTheMinimumAndMaximumNumberOfNodesBetweenCriticalPoints(/* edge case */)); // expected
```
...
- [Find the Minimum and Maximum Number of Nodes Between Critical Points — LeetCode](https://leetcode.com/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points) — problem page
