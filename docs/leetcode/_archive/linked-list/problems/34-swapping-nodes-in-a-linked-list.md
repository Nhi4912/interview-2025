...
**Visual — Swapping Nodes in a Linked List example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/swapping-nodes-in-a-linked-list) for full constraints
 ...
 */
function swappingNodesInALinkedListBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function swappingNodesInALinkedList(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(swappingNodesInALinkedList(/* example 1 */)); // expected
// console.log(swappingNodesInALinkedList(/* example 2 */)); // expected
// console.log(swappingNodesInALinkedList(/* edge case */)); // expected
```
...
- [Partition List](https://leetcode.com/problems/partition-list) — same pattern: Two Pointers
- [Sort List](https://leetcode.com/problems/sort-list) — same pattern: Two Pointers
- [Swapping Nodes in a Linked List — LeetCode](https://leetcode.com/problems/swapping-nodes-in-a-linked-list) — problem page
