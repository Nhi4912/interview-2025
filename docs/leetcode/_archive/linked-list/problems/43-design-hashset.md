...
> **See also**: [Design HashMap](https://leetcode.com/problems/design-hashmap) | [LFU Cache](https://leetcode.com/problems/lfu-cache)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-hashset) for full constraints
 ...
 */
function designHashsetBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designHashset(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designHashset(/* example 1 */)); // expected
// console.log(designHashset(/* example 2 */)); // expected
// console.log(designHashset(/* edge case */)); // expected
```
...
- [Design HashSet — LeetCode](https://leetcode.com/problems/design-hashset) — problem page
