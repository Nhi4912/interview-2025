...
leetcode_url: "https://leetcode.com/problems/steps-to-make-array-non-decreasing"
---
...
**Visual — Steps to Make Array Non-decreasing example:**
...
Steps to Make Array Non-decreasing. ([LeetCode](https://leetcode.com/problems/steps-to-make-array-non-decreasing))

Difficulty: Medium | Acceptance: 23.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/steps-to-make-array-non-decreasing) for full constraints
 ...
 */
function stepsToMakeArrayNonDecreasingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function stepsToMakeArrayNonDecreasing(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(stepsToMakeArrayNonDecreasing(/* example 1 */)); // expected
// console.log(stepsToMakeArrayNonDecreasing(/* example 2 */)); // expected
// console.log(stepsToMakeArrayNonDecreasing(/* edge case */)); // expected
```
...
- [Steps to Make Array Non-decreasing — LeetCode](https://leetcode.com/problems/steps-to-make-array-non-decreasing) — problem page
