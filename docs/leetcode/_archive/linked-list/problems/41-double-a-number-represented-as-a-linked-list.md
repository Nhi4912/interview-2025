...
# Double a Number Represented as a Linked List / Double a Number Represented as a Linked List

> **Track**: Shared | **Difficulty**: 🟡 Medium | **Pattern**: Linked List
> **Frequency**: 📘 Tier 3 — Gặp ở 1 companies
> **See also**: [Add Two Numbers II](https://leetcode.com/problems/add-two-numbers-ii) | [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii)
...
**Visual — Double a Number Represented as a Linked List example:**
...
Difficulty: Medium | Acceptance: 61.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/double-a-number-represented-as-a-linked-list) for full constraints
 ...
 */
function doubleANumberRepresentedAsALinkedListBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function doubleANumberRepresentedAsALinkedList(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(doubleANumberRepresentedAsALinkedList(/* example 1 */)); // expected
// console.log(doubleANumberRepresentedAsALinkedList(/* example 2 */)); // expected
// console.log(doubleANumberRepresentedAsALinkedList(/* edge case */)); // expected
```
...
- [Double a Number Represented as a Linked List — LeetCode](https://leetcode.com/problems/double-a-number-represented-as-a-linked-list) — problem page
