...
**Visual — Design Skiplist example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/design-skiplist) for full constraints
 ...
 */
function designSkiplistBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function designSkiplist(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(designSkiplist(/* example 1 */)); // expected
// console.log(designSkiplist(/* example 2 */)); // expected
// console.log(designSkiplist(/* edge case */)); // expected
```
...
- [Design Skiplist — LeetCode](https://leetcode.com/problems/design-skiplist) — problem page
