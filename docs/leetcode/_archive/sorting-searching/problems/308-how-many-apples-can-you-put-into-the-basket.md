...
# How Many Apples Can You Put into the Basket / How Many Apples Can You Put into the Basket
...
**Visual — How Many Apples Can You Put into the Basket example:**
...
How Many Apples Can You Put into the Basket. ([LeetCode](https://leetcode.com/problems/how-many-apples-can-you-put-into-the-basket))

Difficulty: Easy | Acceptance: 67.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/how-many-apples-can-you-put-into-the-basket) for full constraints
 ...
 */
function howManyApplesCanYouPutIntoTheBasketBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function howManyApplesCanYouPutIntoTheBasket(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(howManyApplesCanYouPutIntoTheBasket(/* example 1 */)); // expected
// console.log(howManyApplesCanYouPutIntoTheBasket(/* example 2 */)); // expected
// console.log(howManyApplesCanYouPutIntoTheBasket(/* edge case */)); // expected
```
...
- [How Many Apples Can You Put into the Basket — LeetCode](https://leetcode.com/problems/how-many-apples-can-you-put-into-the-basket) — problem page
