...
**Visual — Find a Peak Element II example:**
...
Find a Peak Element II. ([LeetCode](https://leetcode.com/problems/find-a-peak-element-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-a-peak-element-ii) for full constraints
 ...
 */
function findAPeakElementIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findAPeakElementIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findAPeakElementIi(/* example 1 */)); // expected
// console.log(findAPeakElementIi(/* example 2 */)); // expected
// console.log(findAPeakElementIi(/* edge case */)); // expected
```
...
- [Find a Peak Element II — LeetCode](https://leetcode.com/problems/find-a-peak-element-ii) — problem page
