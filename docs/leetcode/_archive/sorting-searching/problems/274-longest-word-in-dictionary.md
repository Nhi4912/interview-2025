...
**Visual — Longest Word in Dictionary example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-word-in-dictionary) for full constraints
 ...
 */
function longestWordInDictionaryBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestWordInDictionary(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestWordInDictionary(/* example 1 */)); // expected
// console.log(longestWordInDictionary(/* example 2 */)); // expected
// console.log(longestWordInDictionary(/* edge case */)); // expected
```
...
- [Longest Word in Dictionary — LeetCode](https://leetcode.com/problems/longest-word-in-dictionary) — problem page
