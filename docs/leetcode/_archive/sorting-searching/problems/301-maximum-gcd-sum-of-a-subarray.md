...
leetcode_url: "https://leetcode.com/problems/maximum-gcd-sum-of-a-subarray"
---

# Maximum GCD-Sum of a Subarray / Maximum GCD-Sum of a Subarray
...
**Visual — Maximum GCD-Sum of a Subarray example:**
...
Maximum GCD-Sum of a Subarray. ([LeetCode](https://leetcode.com/problems/maximum-gcd-sum-of-a-subarray))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-gcd-sum-of-a-subarray) for full constraints
 ...
 */
function maximumGcdSumOfASubarrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumGcdSumOfASubarray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumGcdSumOfASubarray(/* example 1 */)); // expected
// console.log(maximumGcdSumOfASubarray(/* example 2 */)); // expected
// console.log(maximumGcdSumOfASubarray(/* edge case */)); // expected
```
...
- [Maximum GCD-Sum of a Subarray — LeetCode](https://leetcode.com/problems/maximum-gcd-sum-of-a-subarray) — problem page
