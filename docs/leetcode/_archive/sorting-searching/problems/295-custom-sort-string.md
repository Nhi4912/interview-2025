...
**Visual — Custom Sort String example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/custom-sort-string) for full constraints
 ...
 */
function customSortStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function customSortString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(customSortString(/* example 1 */)); // expected
// console.log(customSortString(/* example 2 */)); // expected
// console.log(customSortString(/* edge case */)); // expected
```
...
- [Custom Sort String — LeetCode](https://leetcode.com/problems/custom-sort-string) — problem page
