...
**Visual — Construct Target Array With Multiple Sums example:**
...
Construct Target Array With Multiple Sums. ([LeetCode](https://leetcode.com/problems/construct-target-array-with-multiple-sums))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/construct-target-array-with-multiple-sums) for full constraints
 ...
 */
function constructTargetArrayWithMultipleSumsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function constructTargetArrayWithMultipleSums(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(constructTargetArrayWithMultipleSums(/* example 1 */)); // expected
// console.log(constructTargetArrayWithMultipleSums(/* example 2 */)); // expected
// console.log(constructTargetArrayWithMultipleSums(/* edge case */)); // expected
```
...
- [Construct Target Array With Multiple Sums — LeetCode](https://leetcode.com/problems/construct-target-array-with-multiple-sums) — problem page
