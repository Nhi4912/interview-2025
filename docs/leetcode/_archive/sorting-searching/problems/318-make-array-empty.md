...
tags: [Array, Binary Search, Greedy, Binary Indexed Tree, Segment Tree]
leetcode_url: "https://leetcode.com/problems/make-array-empty"
---
...
**Visual — Make Array Empty example:**
...
Make Array Empty. ([LeetCode](https://leetcode.com/problems/make-array-empty))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/make-array-empty) for full constraints
 ...
 */
function makeArrayEmptyBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function makeArrayEmpty(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(makeArrayEmpty(/* example 1 */)); // expected
// console.log(makeArrayEmpty(/* example 2 */)); // expected
// console.log(makeArrayEmpty(/* edge case */)); // expected
```
...
- [Make Array Empty — LeetCode](https://leetcode.com/problems/make-array-empty) — problem page
