...
# Check If a Number Is Majority Element in a Sorted Array / Check If a Number Is Majority Element in a Sorted Array
...
**Visual — Check If a Number Is Majority Element in a Sorted Array example:**
...
Check If a Number Is Majority Element in a Sorted Array. ([LeetCode](https://leetcode.com/problems/check-if-a-number-is-majority-element-in-a-sorted-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-a-number-is-majority-element-in-a-sorted-array) for full constraints
 ...
 */
function checkIfANumberIsMajorityElementInASortedArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfANumberIsMajorityElementInASortedArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfANumberIsMajorityElementInASortedArray(/* example 1 */)); // expected
// console.log(checkIfANumberIsMajorityElementInASortedArray(/* example 2 */)); // expected
// console.log(checkIfANumberIsMajorityElementInASortedArray(/* edge case */)); // expected
```
...
- [Check If a Number Is Majority Element in a Sorted Array — LeetCode](https://leetcode.com/problems/check-if-a-number-is-majority-element-in-a-sorted-array) — problem page
