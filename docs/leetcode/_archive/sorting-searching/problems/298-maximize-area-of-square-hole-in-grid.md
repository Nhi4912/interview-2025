...
**Visual — Maximize Area of Square Hole in Grid example:**
...
Maximize Area of Square Hole in Grid. ([LeetCode](https://leetcode.com/problems/maximize-area-of-square-hole-in-grid))

Difficulty: Medium | Acceptance: 37.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximize-area-of-square-hole-in-grid) for full constraints
 ...
 */
function maximizeAreaOfSquareHoleInGridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximizeAreaOfSquareHoleInGrid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximizeAreaOfSquareHoleInGrid(/* example 1 */)); // expected
// console.log(maximizeAreaOfSquareHoleInGrid(/* example 2 */)); // expected
// console.log(maximizeAreaOfSquareHoleInGrid(/* edge case */)); // expected
```
...
- [Maximize Area of Square Hole in Grid — LeetCode](https://leetcode.com/problems/maximize-area-of-square-hole-in-grid) — problem page
