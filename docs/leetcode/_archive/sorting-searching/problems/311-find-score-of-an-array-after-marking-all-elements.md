...
leetcode_url: "https://leetcode.com/problems/find-score-of-an-array-after-marking-all-elements"
---

# Find Score of an Array After Marking All Elements / Find Score of an Array After Marking All Elements
...
**Visual — Find Score of an Array After Marking All Elements example:**
...
Find Score of an Array After Marking All Elements. ([LeetCode](https://leetcode.com/problems/find-score-of-an-array-after-marking-all-elements))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-score-of-an-array-after-marking-all-elements) for full constraints
 ...
 */
function findScoreOfAnArrayAfterMarkingAllElementsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findScoreOfAnArrayAfterMarkingAllElements(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findScoreOfAnArrayAfterMarkingAllElements(/* example 1 */)); // expected
// console.log(findScoreOfAnArrayAfterMarkingAllElements(/* example 2 */)); // expected
// console.log(findScoreOfAnArrayAfterMarkingAllElements(/* edge case */)); // expected
```
...
- [Find Score of an Array After Marking All Elements — LeetCode](https://leetcode.com/problems/find-score-of-an-array-after-marking-all-elements) — problem page
