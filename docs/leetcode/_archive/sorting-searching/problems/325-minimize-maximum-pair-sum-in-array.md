...
**Visual — Minimize Maximum Pair Sum in Array example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimize-maximum-pair-sum-in-array) for full constraints
 ...
 */
function minimizeMaximumPairSumInArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimizeMaximumPairSumInArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimizeMaximumPairSumInArray(/* example 1 */)); // expected
// console.log(minimizeMaximumPairSumInArray(/* example 2 */)); // expected
// console.log(minimizeMaximumPairSumInArray(/* edge case */)); // expected
```
...
- [Minimize Maximum Pair Sum in Array — LeetCode](https://leetcode.com/problems/minimize-maximum-pair-sum-in-array) — problem page
