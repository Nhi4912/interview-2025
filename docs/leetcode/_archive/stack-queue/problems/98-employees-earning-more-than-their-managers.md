...
**Analogy:** Phân tích bài "Employees Earning More Than Their Managers" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Employees Earning More Than Their Managers example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/employees-earning-more-than-their-managers) for full constraints
 ...
 */
function employeesEarningMoreThanTheirManagersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function employeesEarningMoreThanTheirManagers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(employeesEarningMoreThanTheirManagers(/* example 1 */)); // expected
// console.log(employeesEarningMoreThanTheirManagers(/* example 2 */)); // expected
// console.log(employeesEarningMoreThanTheirManagers(/* edge case */)); // expected
```
...
- [Employees Earning More Than Their Managers — LeetCode](https://leetcode.com/problems/employees-earning-more-than-their-managers) — problem page
