...
**Analogy:** Phân tích bài "Activity Participants" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Activity Participants example:**
...
Activity Participants. ([LeetCode](https://leetcode.com/problems/activity-participants))

Difficulty: Medium | Acceptance: 72.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/activity-participants) for full constraints
 ...
 */
function activityParticipantsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function activityParticipants(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(activityParticipants(/* example 1 */)); // expected
// console.log(activityParticipants(/* example 2 */)); // expected
// console.log(activityParticipants(/* edge case */)); // expected
```
...
- [Activity Participants — LeetCode](https://leetcode.com/problems/activity-participants) — problem page
