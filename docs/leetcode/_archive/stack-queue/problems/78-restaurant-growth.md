...
**Analogy:** Phân tích bài "Restaurant Growth" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Restaurant Growth example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/restaurant-growth) for full constraints
 ...
 */
function restaurantGrowthBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function restaurantGrowth(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(restaurantGrowth(/* example 1 */)); // expected
// console.log(restaurantGrowth(/* example 2 */)); // expected
// console.log(restaurantGrowth(/* edge case */)); // expected
```
...
- [Restaurant Growth — LeetCode](https://leetcode.com/problems/restaurant-growth) — problem page
