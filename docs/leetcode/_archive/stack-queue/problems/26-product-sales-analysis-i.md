...
**Analogy:** Phân tích bài "Product Sales Analysis I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Product Sales Analysis I example:**
...
Difficulty: Easy | Acceptance: 84.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/product-sales-analysis-i) for full constraints
 ...
 */
function productSalesAnalysisIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function productSalesAnalysisI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(productSalesAnalysisI(/* example 1 */)); // expected
// console.log(productSalesAnalysisI(/* example 2 */)); // expected
// console.log(productSalesAnalysisI(/* edge case */)); // expected
```
...
- [Product Sales Analysis I — LeetCode](https://leetcode.com/problems/product-sales-analysis-i) — problem page
