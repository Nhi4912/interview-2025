...
**Analogy:** Phân tích bài "Top Travellers" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Top Travellers. ([LeetCode](https://leetcode.com/problems/top-travellers))

Difficulty: Easy | Acceptance: 57.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/top-travellers) for full constraints
 ...
 */
function topTravellersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function topTravellers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(topTravellers(/* example 1 */)); // expected
// console.log(topTravellers(/* example 2 */)); // expected
// console.log(topTravellers(/* edge case */)); // expected
```
...
- [Top Travellers — LeetCode](https://leetcode.com/problems/top-travellers) — problem page
