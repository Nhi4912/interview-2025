...
**Analogy:** Phân tích bài "Big Countries" — xác định pattern phù hợp dựa trên constraints và input/output.
...
Difficulty: Easy | Acceptance: 68.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/big-countries) for full constraints
 ...
 */
function bigCountriesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bigCountries(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bigCountries(/* example 1 */)); // expected
// console.log(bigCountries(/* example 2 */)); // expected
// console.log(bigCountries(/* edge case */)); // expected
```
...
- [Big Countries — LeetCode](https://leetcode.com/problems/big-countries) — problem page
