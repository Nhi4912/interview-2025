...
**Analogy:** Phân tích bài "Team Scores in Football Tournament" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Team Scores in Football Tournament example:**
...
Team Scores in Football Tournament. ([LeetCode](https://leetcode.com/problems/team-scores-in-football-tournament))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/team-scores-in-football-tournament) for full constraints
 ...
 */
function teamScoresInFootballTournamentBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function teamScoresInFootballTournament(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(teamScoresInFootballTournament(/* example 1 */)); // expected
// console.log(teamScoresInFootballTournament(/* example 2 */)); // expected
// console.log(teamScoresInFootballTournament(/* edge case */)); // expected
```
...
- [Team Scores in Football Tournament — LeetCode](https://leetcode.com/problems/team-scores-in-football-tournament) — problem page
