...
**Analogy:** Phân tích bài "Find Followers Count" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Followers Count example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-followers-count) for full constraints
 ...
 */
function findFollowersCountBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findFollowersCount(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findFollowersCount(/* example 1 */)); // expected
// console.log(findFollowersCount(/* example 2 */)); // expected
// console.log(findFollowersCount(/* edge case */)); // expected
```
...
- [Find Followers Count — LeetCode](https://leetcode.com/problems/find-followers-count) — problem page
