...
**Analogy:** Phân tích bài "Tournament Winners" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Tournament Winners example:**
...
Tournament Winners. ([LeetCode](https://leetcode.com/problems/tournament-winners))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/tournament-winners) for full constraints
 ...
 */
function tournamentWinnersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function tournamentWinners(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(tournamentWinners(/* example 1 */)); // expected
// console.log(tournamentWinners(/* example 2 */)); // expected
// console.log(tournamentWinners(/* edge case */)); // expected
```
...
- [Tournament Winners — LeetCode](https://leetcode.com/problems/tournament-winners) — problem page
