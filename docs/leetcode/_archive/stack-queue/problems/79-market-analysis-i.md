...
**Analogy:** Phân tích bài "Market Analysis I" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Market Analysis I example:**
...
Market Analysis I. ([LeetCode](https://leetcode.com/problems/market-analysis-i))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/market-analysis-i) for full constraints
 ...
 */
function marketAnalysisIBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function marketAnalysisI(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(marketAnalysisI(/* example 1 */)); // expected
// console.log(marketAnalysisI(/* example 2 */)); // expected
// console.log(marketAnalysisI(/* edge case */)); // expected
```
...
- [Market Analysis I — LeetCode](https://leetcode.com/problems/market-analysis-i) — problem page
