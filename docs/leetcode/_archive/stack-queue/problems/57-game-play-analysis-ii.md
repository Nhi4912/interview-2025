...
**Analogy:** Phân tích bài "Game Play Analysis II" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Game Play Analysis II example:**
...
Difficulty: Easy | Acceptance: 54.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/game-play-analysis-ii) for full constraints
 ...
 */
function gamePlayAnalysisIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gamePlayAnalysisIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gamePlayAnalysisIi(/* example 1 */)); // expected
// console.log(gamePlayAnalysisIi(/* example 2 */)); // expected
// console.log(gamePlayAnalysisIi(/* edge case */)); // expected
```
...
- [Game Play Analysis II — LeetCode](https://leetcode.com/problems/game-play-analysis-ii) — problem page
