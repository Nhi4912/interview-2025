...
category: Others
tags: [Database]
leetcode_url: "https://leetcode.com/problems/symmetric-coordinates"
---

# Symmetric Coordinates / Symmetric Coordinates
...
**Analogy:** Phân tích bài "Symmetric Coordinates" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Symmetric Coordinates example:**
...
Symmetric Coordinates. ([LeetCode](https://leetcode.com/problems/symmetric-coordinates))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/symmetric-coordinates) for full constraints
 ...
 */
function symmetricCoordinatesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function symmetricCoordinates(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(symmetricCoordinates(/* example 1 */)); // expected
// console.log(symmetricCoordinates(/* example 2 */)); // expected
// console.log(symmetricCoordinates(/* edge case */)); // expected
```
...
- [Symmetric Coordinates — LeetCode](https://leetcode.com/problems/symmetric-coordinates) — problem page
