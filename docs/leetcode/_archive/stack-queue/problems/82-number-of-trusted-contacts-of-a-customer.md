...
**Analogy:** Phân tích bài "Number of Trusted Contacts of a Customer" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Number of Trusted Contacts of a Customer example:**
...
Number of Trusted Contacts of a Customer. ([LeetCode](https://leetcode.com/problems/number-of-trusted-contacts-of-a-customer))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-trusted-contacts-of-a-customer) for full constraints
 ...
 */
function numberOfTrustedContactsOfACustomerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfTrustedContactsOfACustomer(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfTrustedContactsOfACustomer(/* example 1 */)); // expected
// console.log(numberOfTrustedContactsOfACustomer(/* example 2 */)); // expected
// console.log(numberOfTrustedContactsOfACustomer(/* edge case */)); // expected
```
...
- [Number of Trusted Contacts of a Customer — LeetCode](https://leetcode.com/problems/number-of-trusted-contacts-of-a-customer) — problem page
