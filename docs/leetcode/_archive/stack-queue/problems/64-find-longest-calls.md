...
category: Others
tags: [Database]
leetcode_url: "https://leetcode.com/problems/find-longest-calls"
---

# Find Longest Calls / Find Longest Calls
...
**Analogy:** Phân tích bài "Find Longest Calls" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Longest Calls example:**
...
Find Longest Calls. ([LeetCode](https://leetcode.com/problems/find-longest-calls))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-longest-calls) for full constraints
 ...
 */
function findLongestCallsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findLongestCalls(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findLongestCalls(/* example 1 */)); // expected
// console.log(findLongestCalls(/* example 2 */)); // expected
// console.log(findLongestCalls(/* edge case */)); // expected
```
...
- [Find Longest Calls — LeetCode](https://leetcode.com/problems/find-longest-calls) — problem page
