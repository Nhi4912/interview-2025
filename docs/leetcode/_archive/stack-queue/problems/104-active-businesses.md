...
**Analogy:** Phân tích bài "Active Businesses" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Active Businesses example:**
...
Active Businesses. ([LeetCode](https://leetcode.com/problems/active-businesses))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/active-businesses) for full constraints
 ...
 */
function activeBusinessesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function activeBusinesses(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(activeBusinesses(/* example 1 */)); // expected
// console.log(activeBusinesses(/* example 2 */)); // expected
// console.log(activeBusinesses(/* edge case */)); // expected
```
...
- [Active Businesses — LeetCode](https://leetcode.com/problems/active-businesses) — problem page
