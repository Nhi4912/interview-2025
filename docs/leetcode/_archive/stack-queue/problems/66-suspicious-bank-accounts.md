...
**Analogy:** Phân tích bài "Suspicious Bank Accounts" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Suspicious Bank Accounts example:**
...
Suspicious Bank Accounts. ([LeetCode](https://leetcode.com/problems/suspicious-bank-accounts))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/suspicious-bank-accounts) for full constraints
 ...
 */
function suspiciousBankAccountsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function suspiciousBankAccounts(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(suspiciousBankAccounts(/* example 1 */)); // expected
// console.log(suspiciousBankAccounts(/* example 2 */)); // expected
// console.log(suspiciousBankAccounts(/* edge case */)); // expected
```
...
- [Suspicious Bank Accounts — LeetCode](https://leetcode.com/problems/suspicious-bank-accounts) — problem page
