...
# Market Analysis II / Market Analysis II
...
**Analogy:** Phân tích bài "Market Analysis II" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Market Analysis II example:**
...
Market Analysis II. ([LeetCode](https://leetcode.com/problems/market-analysis-ii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/market-analysis-ii) for full constraints
 ...
 */
function marketAnalysisIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function marketAnalysisIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(marketAnalysisIi(/* example 1 */)); // expected
// console.log(marketAnalysisIi(/* example 2 */)); // expected
// console.log(marketAnalysisIi(/* edge case */)); // expected
```
...
- [Market Analysis II — LeetCode](https://leetcode.com/problems/market-analysis-ii) — problem page
