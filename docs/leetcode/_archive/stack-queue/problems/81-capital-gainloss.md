...
**Analogy:** Phân tích bài "Capital Gain/Loss" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Capital Gain/Loss example:**
...
Difficulty: Medium | Acceptance: 84.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/capital-gainloss) for full constraints
 ...
 */
function capitalGainlossBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function capitalGainloss(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(capitalGainloss(/* example 1 */)); // expected
// console.log(capitalGainloss(/* example 2 */)); // expected
// console.log(capitalGainloss(/* edge case */)); // expected
```
...
- [Capital Gain/Loss — LeetCode](https://leetcode.com/problems/capital-gainloss) — problem page
