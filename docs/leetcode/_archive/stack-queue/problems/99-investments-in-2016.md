...
**Analogy:** Phân tích bài "Investments in 2016" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Investments in 2016 example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/investments-in-2016) for full constraints
 ...
 */
function investmentsIn2016BruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function investmentsIn2016(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(investmentsIn2016(/* example 1 */)); // expected
// console.log(investmentsIn2016(/* example 2 */)); // expected
// console.log(investmentsIn2016(/* edge case */)); // expected
```
...
- [Investments in 2016 — LeetCode](https://leetcode.com/problems/investments-in-2016) — problem page
