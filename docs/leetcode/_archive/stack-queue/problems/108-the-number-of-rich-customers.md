...
category: Others
tags: [Database]
leetcode_url: "https://leetcode.com/problems/the-number-of-rich-customers"
---

# The Number of Rich Customers / The Number of Rich Customers
...
**Analogy:** Phân tích bài "The Number of Rich Customers" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — The Number of Rich Customers example:**
...
The Number of Rich Customers. ([LeetCode](https://leetcode.com/problems/the-number-of-rich-customers))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/the-number-of-rich-customers) for full constraints
 ...
 */
function theNumberOfRichCustomersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function theNumberOfRichCustomers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(theNumberOfRichCustomers(/* example 1 */)); // expected
// console.log(theNumberOfRichCustomers(/* example 2 */)); // expected
// console.log(theNumberOfRichCustomers(/* edge case */)); // expected
```
...
- [The Number of Rich Customers — LeetCode](https://leetcode.com/problems/the-number-of-rich-customers) — problem page
