...
category: Others
tags: [Database]
leetcode_url: "https://leetcode.com/problems/find-third-transaction"
---

# Find Third Transaction / Find Third Transaction
...
**Analogy:** Phân tích bài "Find Third Transaction" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Third Transaction example:**
...
Find Third Transaction. ([LeetCode](https://leetcode.com/problems/find-third-transaction))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-third-transaction) for full constraints
 ...
 */
function findThirdTransactionBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findThirdTransaction(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findThirdTransaction(/* example 1 */)); // expected
// console.log(findThirdTransaction(/* example 2 */)); // expected
// console.log(findThirdTransaction(/* edge case */)); // expected
```
...
- [Find Third Transaction — LeetCode](https://leetcode.com/problems/find-third-transaction) — problem page
