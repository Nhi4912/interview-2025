...
**Analogy:** Phân tích bài "Game Play Analysis III" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Game Play Analysis III example:**
...
Difficulty: Medium | Acceptance: 81.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/game-play-analysis-iii) for full constraints
 ...
 */
function gamePlayAnalysisIiiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function gamePlayAnalysisIii(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(gamePlayAnalysisIii(/* example 1 */)); // expected
// console.log(gamePlayAnalysisIii(/* example 2 */)); // expected
// console.log(gamePlayAnalysisIii(/* edge case */)); // expected
```
...
- [Game Play Analysis III — LeetCode](https://leetcode.com/problems/game-play-analysis-iii) — problem page
