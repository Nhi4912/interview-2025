...
**Analogy:** Phân tích bài "Find Median Given Frequency of Numbers" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Find Median Given Frequency of Numbers example:**
...
Find Median Given Frequency of Numbers. ([LeetCode](https://leetcode.com/problems/find-median-given-frequency-of-numbers))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-median-given-frequency-of-numbers) for full constraints
 ...
 */
function findMedianGivenFrequencyOfNumbersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findMedianGivenFrequencyOfNumbers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findMedianGivenFrequencyOfNumbers(/* example 1 */)); // expected
// console.log(findMedianGivenFrequencyOfNumbers(/* example 2 */)); // expected
// console.log(findMedianGivenFrequencyOfNumbers(/* edge case */)); // expected
```
...
- [Find Median Given Frequency of Numbers — LeetCode](https://leetcode.com/problems/find-median-given-frequency-of-numbers) — problem page
