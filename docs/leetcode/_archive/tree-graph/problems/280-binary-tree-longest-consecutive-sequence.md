...
**Visual — Binary Tree Longest Consecutive Sequence example:**
...
Binary Tree Longest Consecutive Sequence. ([LeetCode](https://leetcode.com/problems/binary-tree-longest-consecutive-sequence))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/binary-tree-longest-consecutive-sequence) for full constraints
 ...
 */
function binaryTreeLongestConsecutiveSequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function binaryTreeLongestConsecutiveSequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(binaryTreeLongestConsecutiveSequence(/* example 1 */)); // expected
// console.log(binaryTreeLongestConsecutiveSequence(/* example 2 */)); // expected
// console.log(binaryTreeLongestConsecutiveSequence(/* edge case */)); // expected
```
...
- [Binary Tree Longest Consecutive Sequence — LeetCode](https://leetcode.com/problems/binary-tree-longest-consecutive-sequence) — problem page
