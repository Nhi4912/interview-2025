...
**Visual — Cousins in Binary Tree example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/cousins-in-binary-tree) for full constraints
 ...
 */
function cousinsInBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function cousinsInBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(cousinsInBinaryTree(/* example 1 */)); // expected
// console.log(cousinsInBinaryTree(/* example 2 */)); // expected
// console.log(cousinsInBinaryTree(/* edge case */)); // expected
```
...
- [Cousins in Binary Tree — LeetCode](https://leetcode.com/problems/cousins-in-binary-tree) — problem page
