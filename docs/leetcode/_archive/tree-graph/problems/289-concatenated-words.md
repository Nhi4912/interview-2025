...
**Visual — Concatenated Words example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/concatenated-words) for full constraints
 ...
 */
function concatenatedWordsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function concatenatedWords(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(concatenatedWords(/* example 1 */)); // expected
// console.log(concatenatedWords(/* example 2 */)); // expected
// console.log(concatenatedWords(/* edge case */)); // expected
```
...
- [Concatenated Words — LeetCode](https://leetcode.com/problems/concatenated-words) — problem page
