...
leetcode_url: "https://leetcode.com/problems/find-edges-in-shortest-paths"
---

# Find Edges in Shortest Paths / Find Edges in Shortest Paths
...
**Visual — Find Edges in Shortest Paths example:**
...
Find Edges in Shortest Paths. ([LeetCode](https://leetcode.com/problems/find-edges-in-shortest-paths))

Difficulty: Hard | Acceptance: 45.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-edges-in-shortest-paths) for full constraints
 ...
 */
function findEdgesInShortestPathsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findEdgesInShortestPaths(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findEdgesInShortestPaths(/* example 1 */)); // expected
// console.log(findEdgesInShortestPaths(/* example 2 */)); // expected
// console.log(findEdgesInShortestPaths(/* edge case */)); // expected
```
...
- [Find Edges in Shortest Paths — LeetCode](https://leetcode.com/problems/find-edges-in-shortest-paths) — problem page
