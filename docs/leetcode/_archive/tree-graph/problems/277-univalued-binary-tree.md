...
**Visual — Univalued Binary Tree example:**
...
Difficulty: Easy | Acceptance: 72.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/univalued-binary-tree) for full constraints
 ...
 */
function univaluedBinaryTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function univaluedBinaryTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(univaluedBinaryTree(/* example 1 */)); // expected
// console.log(univaluedBinaryTree(/* example 2 */)); // expected
// console.log(univaluedBinaryTree(/* edge case */)); // expected
```
...
- [Univalued Binary Tree — LeetCode](https://leetcode.com/problems/univalued-binary-tree) — problem page
