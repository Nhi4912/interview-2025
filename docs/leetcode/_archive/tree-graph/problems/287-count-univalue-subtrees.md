...
**Visual — Count Univalue Subtrees example:**
...
Count Univalue Subtrees. ([LeetCode](https://leetcode.com/problems/count-univalue-subtrees))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-univalue-subtrees) for full constraints
 ...
 */
function countUnivalueSubtreesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countUnivalueSubtrees(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countUnivalueSubtrees(/* example 1 */)); // expected
// console.log(countUnivalueSubtrees(/* example 2 */)); // expected
// console.log(countUnivalueSubtrees(/* edge case */)); // expected
```
...
- [Count Univalue Subtrees — LeetCode](https://leetcode.com/problems/count-univalue-subtrees) — problem page
