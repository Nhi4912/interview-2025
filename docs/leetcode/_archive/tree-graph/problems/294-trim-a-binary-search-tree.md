...
**Visual — Trim a Binary Search Tree example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/trim-a-binary-search-tree) for full constraints
 ...
 */
function trimABinarySearchTreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function trimABinarySearchTree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(trimABinarySearchTree(/* example 1 */)); // expected
// console.log(trimABinarySearchTree(/* example 2 */)); // expected
// console.log(trimABinarySearchTree(/* edge case */)); // expected
```
...
- [Trim a Binary Search Tree — LeetCode](https://leetcode.com/problems/trim-a-binary-search-tree) — problem page
