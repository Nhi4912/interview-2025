...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/rotate-list) for full constraints
 ...
 */
function rotateListBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function rotateList(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(rotateList(/* example 1 */)); // expected
// console.log(rotateList(/* example 2 */)); // expected
// console.log(rotateList(/* edge case */)); // expected
```
...
- [Rotate List — LeetCode](https://leetcode.com/problems/rotate-list) — problem page
