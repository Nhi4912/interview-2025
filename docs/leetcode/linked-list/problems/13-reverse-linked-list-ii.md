...
> **Frequency**: 📘 Tier 3 — Gặp ở 16 companies
> **See also**: [Reverse Nodes in k-Group](https://leetcode.com/problems/reverse-nodes-in-k-group) | [LFU Cache](https://leetcode.com/problems/lfu-cache)
...
**Visual — Reverse Linked List II example:**
...
Difficulty: Medium | Acceptance: 49.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reverse-linked-list-ii) for full constraints
 ...
 */
function reverseLinkedListIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reverseLinkedListIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reverseLinkedListIi(/* example 1 */)); // expected
// console.log(reverseLinkedListIi(/* example 2 */)); // expected
// console.log(reverseLinkedListIi(/* edge case */)); // expected
```
...
- [Reverse Linked List II — LeetCode](https://leetcode.com/problems/reverse-linked-list-ii) — problem page
