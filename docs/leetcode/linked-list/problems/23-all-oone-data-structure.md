...
**Visual — All O`one Data Structure example:**
...
All O`one Data Structure. ([LeetCode](https://leetcode.com/problems/all-oone-data-structure))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/all-oone-data-structure) for full constraints
 ...
 */
function allOoneDataStructureBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function allOoneDataStructure(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(allOoneDataStructure(/* example 1 */)); // expected
// console.log(allOoneDataStructure(/* example 2 */)); // expected
// console.log(allOoneDataStructure(/* edge case */)); // expected
```
...
- [All O`one Data Structure — LeetCode](https://leetcode.com/problems/all-oone-data-structure) — problem page
