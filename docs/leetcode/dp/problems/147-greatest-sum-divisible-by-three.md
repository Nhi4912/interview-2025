...
Greatest Sum Divisible by Three. ([LeetCode](https://leetcode.com/problems/greatest-sum-divisible-by-three))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/greatest-sum-divisible-by-three) for full constraints
 ...
 */
function greatestSumDivisibleByThreeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function greatestSumDivisibleByThree(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(greatestSumDivisibleByThree(/* example 1 */)); // expected
// console.log(greatestSumDivisibleByThree(/* example 2 */)); // expected
// console.log(greatestSumDivisibleByThree(/* edge case */)); // expected
```
...
- [Greatest Sum Divisible by Three — LeetCode](https://leetcode.com/problems/greatest-sum-divisible-by-three) — problem page
