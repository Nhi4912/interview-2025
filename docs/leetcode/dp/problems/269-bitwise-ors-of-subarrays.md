...
**Visual — Bitwise ORs of Subarrays example:**
...
Bitwise ORs of Subarrays. ([LeetCode](https://leetcode.com/problems/bitwise-ors-of-subarrays))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/bitwise-ors-of-subarrays) for full constraints
 ...
 */
function bitwiseOrsOfSubarraysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bitwiseOrsOfSubarrays(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bitwiseOrsOfSubarrays(/* example 1 */)); // expected
// console.log(bitwiseOrsOfSubarrays(/* example 2 */)); // expected
// console.log(bitwiseOrsOfSubarrays(/* edge case */)); // expected
```
...
- [Bitwise ORs of Subarrays — LeetCode](https://leetcode.com/problems/bitwise-ors-of-subarrays) — problem page
