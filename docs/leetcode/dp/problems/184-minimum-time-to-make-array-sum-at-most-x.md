...
**Visual — Minimum Time to Make Array Sum At Most x example:**
...
Minimum Time to Make Array Sum At Most x. ([LeetCode](https://leetcode.com/problems/minimum-time-to-make-array-sum-at-most-x))

Difficulty: Hard | Acceptance: 25.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-time-to-make-array-sum-at-most-x) for full constraints
 ...
 */
function minimumTimeToMakeArraySumAtMostXBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumTimeToMakeArraySumAtMostX(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumTimeToMakeArraySumAtMostX(/* example 1 */)); // expected
// console.log(minimumTimeToMakeArraySumAtMostX(/* example 2 */)); // expected
// console.log(minimumTimeToMakeArraySumAtMostX(/* edge case */)); // expected
```
...
- [Minimum Time to Make Array Sum At Most x — LeetCode](https://leetcode.com/problems/minimum-time-to-make-array-sum-at-most-x) — problem page
