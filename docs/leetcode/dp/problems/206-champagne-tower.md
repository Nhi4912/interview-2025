...
**Visual — Champagne Tower example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/champagne-tower) for full constraints
 ...
 */
function champagneTowerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function champagneTower(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(champagneTower(/* example 1 */)); // expected
// console.log(champagneTower(/* example 2 */)); // expected
// console.log(champagneTower(/* edge case */)); // expected
```
...
- [Champagne Tower — LeetCode](https://leetcode.com/problems/champagne-tower) — problem page
