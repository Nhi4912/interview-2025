...
**Analogy:** Phân tích bài "Constrained Subsequence Sum" — xác định pattern phù hợp dựa trên constraints và input/output.
...
**Visual — Constrained Subsequence Sum example:**
...
Constrained Subsequence Sum. ([LeetCode](https://leetcode.com/problems/constrained-subsequence-sum))

Difficulty: Hard | Acceptance: 56.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/constrained-subsequence-sum) for full constraints
 ...
 */
function constrainedSubsequenceSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function constrainedSubsequenceSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(constrainedSubsequenceSum(/* example 1 */)); // expected
// console.log(constrainedSubsequenceSum(/* example 2 */)); // expected
// console.log(constrainedSubsequenceSum(/* edge case */)); // expected
```
...
- [Constrained Subsequence Sum — LeetCode](https://leetcode.com/problems/constrained-subsequence-sum) — problem page
