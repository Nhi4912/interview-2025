...
**Visual — Largest 1-Bordered Square example:**
...
Largest 1-Bordered Square. ([LeetCode](https://leetcode.com/problems/largest-1-bordered-square))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-1-bordered-square) for full constraints
 ...
 */
function largest1BorderedSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largest1BorderedSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largest1BorderedSquare(/* example 1 */)); // expected
// console.log(largest1BorderedSquare(/* example 2 */)); // expected
// console.log(largest1BorderedSquare(/* edge case */)); // expected
```
...
- [Largest 1-Bordered Square — LeetCode](https://leetcode.com/problems/largest-1-bordered-square) — problem page
