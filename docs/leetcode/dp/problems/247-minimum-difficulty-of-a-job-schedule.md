...
Minimum Difficulty of a Job Schedule. ([LeetCode](https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule) for full constraints
 ...
 */
function minimumDifficultyOfAJobScheduleBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumDifficultyOfAJobSchedule(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumDifficultyOfAJobSchedule(/* example 1 */)); // expected
// console.log(minimumDifficultyOfAJobSchedule(/* example 2 */)); // expected
// console.log(minimumDifficultyOfAJobSchedule(/* edge case */)); // expected
```
...
- [Minimum Difficulty of a Job Schedule — LeetCode](https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule) — problem page
