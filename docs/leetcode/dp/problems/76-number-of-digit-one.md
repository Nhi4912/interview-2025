...
**Visual — Number of Digit One example:**
...
Difficulty: Hard | Acceptance: 36.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-digit-one) for full constraints
 ...
 */
function numberOfDigitOneBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfDigitOne(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfDigitOne(/* example 1 */)); // expected
// console.log(numberOfDigitOne(/* example 2 */)); // expected
// console.log(numberOfDigitOne(/* edge case */)); // expected
```
...
- [Number of Digit One — LeetCode](https://leetcode.com/problems/number-of-digit-one) — problem page
