...
Number of Ways to Paint N × 3 Grid. ([LeetCode](https://leetcode.com/problems/number-of-ways-to-paint-n-3-grid))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-ways-to-paint-n-3-grid) for full constraints
 ...
 */
function numberOfWaysToPaintN3GridBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfWaysToPaintN3Grid(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfWaysToPaintN3Grid(/* example 1 */)); // expected
// console.log(numberOfWaysToPaintN3Grid(/* example 2 */)); // expected
// console.log(numberOfWaysToPaintN3Grid(/* edge case */)); // expected
```
...
- [Number of Ways to Paint N × 3 Grid — LeetCode](https://leetcode.com/problems/number-of-ways-to-paint-n-3-grid) — problem page
