...
**Visual — Arithmetic Slices II - Subsequence example:**
...
Arithmetic Slices II - Subsequence. ([LeetCode](https://leetcode.com/problems/arithmetic-slices-ii-subsequence))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/arithmetic-slices-ii-subsequence) for full constraints
 ...
 */
function arithmeticSlicesIiSubsequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function arithmeticSlicesIiSubsequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(arithmeticSlicesIiSubsequence(/* example 1 */)); // expected
// console.log(arithmeticSlicesIiSubsequence(/* example 2 */)); // expected
// console.log(arithmeticSlicesIiSubsequence(/* edge case */)); // expected
```
...
- [Arithmetic Slices II - Subsequence — LeetCode](https://leetcode.com/problems/arithmetic-slices-ii-subsequence) — problem page
