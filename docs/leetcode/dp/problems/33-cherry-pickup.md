...
Cherry Pickup. ([LeetCode](https://leetcode.com/problems/cherry-pickup))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/cherry-pickup) for full constraints
 ...
 */
function cherryPickupBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function cherryPickup(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(cherryPickup(/* example 1 */)); // expected
// console.log(cherryPickup(/* example 2 */)); // expected
// console.log(cherryPickup(/* edge case */)); // expected
```
...
- [Cherry Pickup — LeetCode](https://leetcode.com/problems/cherry-pickup) — problem page
