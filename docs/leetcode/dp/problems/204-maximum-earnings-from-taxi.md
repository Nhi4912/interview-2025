...
**Visual — Maximum Earnings From Taxi example:**
...
Maximum Earnings From Taxi. ([LeetCode](https://leetcode.com/problems/maximum-earnings-from-taxi))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-earnings-from-taxi) for full constraints
 ...
 */
function maximumEarningsFromTaxiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumEarningsFromTaxi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumEarningsFromTaxi(/* example 1 */)); // expected
// console.log(maximumEarningsFromTaxi(/* example 2 */)); // expected
// console.log(maximumEarningsFromTaxi(/* edge case */)); // expected
```
...
- [Maximum Earnings From Taxi — LeetCode](https://leetcode.com/problems/maximum-earnings-from-taxi) — problem page
