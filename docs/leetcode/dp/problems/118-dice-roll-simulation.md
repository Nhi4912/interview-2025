...
**Visual — Dice Roll Simulation example:**
...
Dice Roll Simulation. ([LeetCode](https://leetcode.com/problems/dice-roll-simulation))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/dice-roll-simulation) for full constraints
 ...
 */
function diceRollSimulationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function diceRollSimulation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(diceRollSimulation(/* example 1 */)); // expected
// console.log(diceRollSimulation(/* example 2 */)); // expected
// console.log(diceRollSimulation(/* edge case */)); // expected
```
...
- [Dice Roll Simulation — LeetCode](https://leetcode.com/problems/dice-roll-simulation) — problem page
