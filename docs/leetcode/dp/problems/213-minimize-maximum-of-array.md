...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimize-maximum-of-array) for full constraints
 ...
 */
function minimizeMaximumOfArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimizeMaximumOfArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimizeMaximumOfArray(/* example 1 */)); // expected
// console.log(minimizeMaximumOfArray(/* example 2 */)); // expected
// console.log(minimizeMaximumOfArray(/* edge case */)); // expected
```
...
- [Minimize Maximum of Array — LeetCode](https://leetcode.com/problems/minimize-maximum-of-array) — problem page
