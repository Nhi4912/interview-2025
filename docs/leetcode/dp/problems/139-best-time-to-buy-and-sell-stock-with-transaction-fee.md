...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee) for full constraints
 ...
 */
function bestTimeToBuyAndSellStockWithTransactionFeeBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bestTimeToBuyAndSellStockWithTransactionFee(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bestTimeToBuyAndSellStockWithTransactionFee(/* example 1 */)); // expected
// console.log(bestTimeToBuyAndSellStockWithTransactionFee(/* example 2 */)); // expected
// console.log(bestTimeToBuyAndSellStockWithTransactionFee(/* edge case */)); // expected
```
...
- [Best Time to Buy and Sell Stock with Transaction Fee — LeetCode](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee) — problem page
