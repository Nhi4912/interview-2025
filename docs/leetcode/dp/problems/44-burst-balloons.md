...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/burst-balloons) for full constraints
 ...
 */
function burstBalloonsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function burstBalloons(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(burstBalloons(/* example 1 */)); // expected
// console.log(burstBalloons(/* example 2 */)); // expected
// console.log(burstBalloons(/* edge case */)); // expected
```
...
- [Burst Balloons — LeetCode](https://leetcode.com/problems/burst-balloons) — problem page
