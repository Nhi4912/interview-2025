...
**Visual — Minimum Number of Increments on Subarrays to Form a Target Array example:**
...
Minimum Number of Increments on Subarrays to Form a Target Array. ([LeetCode](https://leetcode.com/problems/minimum-number-of-increments-on-subarrays-to-form-a-target-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-increments-on-subarrays-to-form-a-target-array) for full constraints
 ...
 */
function minimumNumberOfIncrementsOnSubarraysToFormATargetArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfIncrementsOnSubarraysToFormATargetArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfIncrementsOnSubarraysToFormATargetArray(/* example 1 */)); // expected
// console.log(minimumNumberOfIncrementsOnSubarraysToFormATargetArray(/* example 2 */)); // expected
// console.log(minimumNumberOfIncrementsOnSubarraysToFormATargetArray(/* edge case */)); // expected
```
...
- [Minimum Number of Increments on Subarrays to Form a Target Array — LeetCode](https://leetcode.com/problems/minimum-number-of-increments-on-subarrays-to-form-a-target-array) — problem page
