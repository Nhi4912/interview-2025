...
Check if There is a Valid Partition For The Array. ([LeetCode](https://leetcode.com/problems/check-if-there-is-a-valid-partition-for-the-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/check-if-there-is-a-valid-partition-for-the-array) for full constraints
 ...
 */
function checkIfThereIsAValidPartitionForTheArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function checkIfThereIsAValidPartitionForTheArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(checkIfThereIsAValidPartitionForTheArray(/* example 1 */)); // expected
// console.log(checkIfThereIsAValidPartitionForTheArray(/* example 2 */)); // expected
// console.log(checkIfThereIsAValidPartitionForTheArray(/* edge case */)); // expected
```
...
- [Check if There is a Valid Partition For The Array — LeetCode](https://leetcode.com/problems/check-if-there-is-a-valid-partition-for-the-array) — problem page
