...
**Visual — Minimum Falling Path Sum II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-falling-path-sum-ii) for full constraints
 ...
 */
function minimumFallingPathSumIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumFallingPathSumIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumFallingPathSumIi(/* example 1 */)); // expected
// console.log(minimumFallingPathSumIi(/* example 2 */)); // expected
// console.log(minimumFallingPathSumIi(/* edge case */)); // expected
```
