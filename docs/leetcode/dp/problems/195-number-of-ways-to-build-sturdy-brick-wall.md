...
**Visual — Number of Ways to Build Sturdy Brick Wall example:**
...
Number of Ways to Build Sturdy Brick Wall. ([LeetCode](https://leetcode.com/problems/number-of-ways-to-build-sturdy-brick-wall))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-ways-to-build-sturdy-brick-wall) for full constraints
 ...
 */
function numberOfWaysToBuildSturdyBrickWallBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfWaysToBuildSturdyBrickWall(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfWaysToBuildSturdyBrickWall(/* example 1 */)); // expected
// console.log(numberOfWaysToBuildSturdyBrickWall(/* example 2 */)); // expected
// console.log(numberOfWaysToBuildSturdyBrickWall(/* edge case */)); // expected
```
...
- [Number of Ways to Build Sturdy Brick Wall — LeetCode](https://leetcode.com/problems/number-of-ways-to-build-sturdy-brick-wall) — problem page
