...
**Visual — Maximum Students Taking Exam example:**
...
Maximum Students Taking Exam. ([LeetCode](https://leetcode.com/problems/maximum-students-taking-exam))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-students-taking-exam) for full constraints
 ...
 */
function maximumStudentsTakingExamBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumStudentsTakingExam(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumStudentsTakingExam(/* example 1 */)); // expected
// console.log(maximumStudentsTakingExam(/* example 2 */)); // expected
// console.log(maximumStudentsTakingExam(/* edge case */)); // expected
```
...
- [Maximum Students Taking Exam — LeetCode](https://leetcode.com/problems/maximum-students-taking-exam) — problem page
