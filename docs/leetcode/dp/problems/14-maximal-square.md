...
> **See also**: [Unique Paths II](https://leetcode.com/problems/unique-paths-ii) | [Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximal-square) for full constraints
 ...
 */
function maximalSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximalSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximalSquare(/* example 1 */)); // expected
// console.log(maximalSquare(/* example 2 */)); // expected
// console.log(maximalSquare(/* edge case */)); // expected
```
...
- [Maximal Square — LeetCode](https://leetcode.com/problems/maximal-square) — problem page
