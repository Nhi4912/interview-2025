...
**Visual — Numbers With Repeated Digits example:**
...
Numbers With Repeated Digits. ([LeetCode](https://leetcode.com/problems/numbers-with-repeated-digits))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/numbers-with-repeated-digits) for full constraints
 ...
 */
function numbersWithRepeatedDigitsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numbersWithRepeatedDigits(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numbersWithRepeatedDigits(/* example 1 */)); // expected
// console.log(numbersWithRepeatedDigits(/* example 2 */)); // expected
// console.log(numbersWithRepeatedDigits(/* edge case */)); // expected
```
...
- [Numbers With Repeated Digits — LeetCode](https://leetcode.com/problems/numbers-with-repeated-digits) — problem page
