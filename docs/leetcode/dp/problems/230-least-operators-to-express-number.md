...
**Visual — Least Operators to Express Number example:**
...
Least Operators to Express Number. ([LeetCode](https://leetcode.com/problems/least-operators-to-express-number))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/least-operators-to-express-number) for full constraints
 ...
 */
function leastOperatorsToExpressNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function leastOperatorsToExpressNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(leastOperatorsToExpressNumber(/* example 1 */)); // expected
// console.log(leastOperatorsToExpressNumber(/* example 2 */)); // expected
// console.log(leastOperatorsToExpressNumber(/* edge case */)); // expected
```
...
- [Least Operators to Express Number — LeetCode](https://leetcode.com/problems/least-operators-to-express-number) — problem page
