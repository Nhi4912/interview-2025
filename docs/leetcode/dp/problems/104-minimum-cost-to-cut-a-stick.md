...
**Visual — Minimum Cost to Cut a Stick example:**
...
Difficulty: Hard | Acceptance: 62.0%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-cost-to-cut-a-stick) for full constraints
 ...
 */
function minimumCostToCutAStickBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumCostToCutAStick(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumCostToCutAStick(/* example 1 */)); // expected
// console.log(minimumCostToCutAStick(/* example 2 */)); // expected
// console.log(minimumCostToCutAStick(/* edge case */)); // expected
```
...
- [Minimum Cost to Cut a Stick — LeetCode](https://leetcode.com/problems/minimum-cost-to-cut-a-stick) — problem page
