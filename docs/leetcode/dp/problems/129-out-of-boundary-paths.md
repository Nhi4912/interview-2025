...
**Visual — Out of Boundary Paths example:**
...
Difficulty: Medium | Acceptance: 48.1%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/out-of-boundary-paths) for full constraints
 ...
 */
function outOfBoundaryPathsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function outOfBoundaryPaths(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(outOfBoundaryPaths(/* example 1 */)); // expected
// console.log(outOfBoundaryPaths(/* example 2 */)); // expected
// console.log(outOfBoundaryPaths(/* edge case */)); // expected
```
...
- [Out of Boundary Paths — LeetCode](https://leetcode.com/problems/out-of-boundary-paths) — problem page
