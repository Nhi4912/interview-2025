...
**Visual — Maximum Vacation Days example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-vacation-days) for full constraints
 ...
 */
function maximumVacationDaysBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumVacationDays(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumVacationDays(/* example 1 */)); // expected
// console.log(maximumVacationDays(/* example 2 */)); // expected
// console.log(maximumVacationDays(/* edge case */)); // expected
```
...
- [Maximum Vacation Days — LeetCode](https://leetcode.com/problems/maximum-vacation-days) — problem page
