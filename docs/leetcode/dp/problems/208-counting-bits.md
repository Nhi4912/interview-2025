...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/counting-bits) for full constraints
 ...
 */
function countingBitsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countingBits(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countingBits(/* example 1 */)); // expected
// console.log(countingBits(/* example 2 */)); // expected
// console.log(countingBits(/* edge case */)); // expected
```
...
- [Counting Bits — LeetCode](https://leetcode.com/problems/counting-bits) — problem page
