...
**Visual — Find the Sum of Subsequence Powers example:**
...
Find the Sum of Subsequence Powers. ([LeetCode](https://leetcode.com/problems/find-the-sum-of-subsequence-powers))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-sum-of-subsequence-powers) for full constraints
 ...
 */
function findTheSumOfSubsequencePowersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheSumOfSubsequencePowers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheSumOfSubsequencePowers(/* example 1 */)); // expected
// console.log(findTheSumOfSubsequencePowers(/* example 2 */)); // expected
// console.log(findTheSumOfSubsequencePowers(/* edge case */)); // expected
```
