...
**Visual — Matchsticks to Square example:**
...
Matchsticks to Square. ([LeetCode](https://leetcode.com/problems/matchsticks-to-square))

Difficulty: Medium | Acceptance: 40.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/matchsticks-to-square) for full constraints
 ...
 */
function matchsticksToSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function matchsticksToSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(matchsticksToSquare(/* example 1 */)); // expected
// console.log(matchsticksToSquare(/* example 2 */)); // expected
// console.log(matchsticksToSquare(/* edge case */)); // expected
```
...
- [Matchsticks to Square — LeetCode](https://leetcode.com/problems/matchsticks-to-square) — problem page
