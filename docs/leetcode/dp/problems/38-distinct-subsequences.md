...
**Visual — Distinct Subsequences example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/distinct-subsequences) for full constraints
 ...
 */
function distinctSubsequencesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function distinctSubsequences(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(distinctSubsequences(/* example 1 */)); // expected
// console.log(distinctSubsequences(/* example 2 */)); // expected
// console.log(distinctSubsequences(/* edge case */)); // expected
```
...
- [Distinct Subsequences — LeetCode](https://leetcode.com/problems/distinct-subsequences) — problem page
