...
**Visual — Longest Ideal Subsequence example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-ideal-subsequence) for full constraints
 ...
 */
function longestIdealSubsequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestIdealSubsequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestIdealSubsequence(/* example 1 */)); // expected
// console.log(longestIdealSubsequence(/* example 2 */)); // expected
// console.log(longestIdealSubsequence(/* edge case */)); // expected
```
...
- [Longest Ideal Subsequence — LeetCode](https://leetcode.com/problems/longest-ideal-subsequence) — problem page
