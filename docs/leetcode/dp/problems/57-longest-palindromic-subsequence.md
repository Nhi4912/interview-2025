...
**Visual — Longest Palindromic Subsequence example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/longest-palindromic-subsequence) for full constraints
 ...
 */
function longestPalindromicSubsequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function longestPalindromicSubsequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(longestPalindromicSubsequence(/* example 1 */)); // expected
// console.log(longestPalindromicSubsequence(/* example 2 */)); // expected
// console.log(longestPalindromicSubsequence(/* edge case */)); // expected
```
...
- [Longest Palindromic Subsequence — LeetCode](https://leetcode.com/problems/longest-palindromic-subsequence) — problem page
