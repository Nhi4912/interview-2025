...
Stone Game VII. ([LeetCode](https://leetcode.com/problems/stone-game-vii))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/stone-game-vii) for full constraints
 ...
 */
function stoneGameViiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function stoneGameVii(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(stoneGameVii(/* example 1 */)); // expected
// console.log(stoneGameVii(/* example 2 */)); // expected
// console.log(stoneGameVii(/* edge case */)); // expected
```
...
- [Stone Game VII — LeetCode](https://leetcode.com/problems/stone-game-vii) — problem page
