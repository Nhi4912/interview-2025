...
**Visual — House Robber II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/house-robber-ii) for full constraints
 ...
 */
function houseRobberIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function houseRobberIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(houseRobberIi(/* example 1 */)); // expected
// console.log(houseRobberIi(/* example 2 */)); // expected
// console.log(houseRobberIi(/* edge case */)); // expected
```
...
- [House Robber II — LeetCode](https://leetcode.com/problems/house-robber-ii) — problem page
