...
**Visual — Count Number of Ways to Place Houses example:**
...
Count Number of Ways to Place Houses. ([LeetCode](https://leetcode.com/problems/count-number-of-ways-to-place-houses))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-number-of-ways-to-place-houses) for full constraints
 ...
 */
function countNumberOfWaysToPlaceHousesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countNumberOfWaysToPlaceHouses(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countNumberOfWaysToPlaceHouses(/* example 1 */)); // expected
// console.log(countNumberOfWaysToPlaceHouses(/* example 2 */)); // expected
// console.log(countNumberOfWaysToPlaceHouses(/* edge case */)); // expected
```
...
- [Count Number of Ways to Place Houses — LeetCode](https://leetcode.com/problems/count-number-of-ways-to-place-houses) — problem page
