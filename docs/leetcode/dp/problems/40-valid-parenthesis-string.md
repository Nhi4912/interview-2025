...
**Visual — Valid Parenthesis String example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/valid-parenthesis-string) for full constraints
 ...
 */
function validParenthesisStringBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function validParenthesisString(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(validParenthesisString(/* example 1 */)); // expected
// console.log(validParenthesisString(/* example 2 */)); // expected
// console.log(validParenthesisString(/* edge case */)); // expected
```
...
- [Valid Parenthesis String — LeetCode](https://leetcode.com/problems/valid-parenthesis-string) — problem page
