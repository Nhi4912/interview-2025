...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/coin-change-ii) for full constraints
 ...
 */
function coinChangeIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function coinChangeIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(coinChangeIi(/* example 1 */)); // expected
// console.log(coinChangeIi(/* example 2 */)); // expected
// console.log(coinChangeIi(/* edge case */)); // expected
```
...
- [Coin Change II — LeetCode](https://leetcode.com/problems/coin-change-ii) — problem page
