...
**Visual — Number of Ways to Build House of Cards example:**
...
Number of Ways to Build House of Cards. ([LeetCode](https://leetcode.com/problems/number-of-ways-to-build-house-of-cards))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-ways-to-build-house-of-cards) for full constraints
 ...
 */
function numberOfWaysToBuildHouseOfCardsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfWaysToBuildHouseOfCards(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfWaysToBuildHouseOfCards(/* example 1 */)); // expected
// console.log(numberOfWaysToBuildHouseOfCards(/* example 2 */)); // expected
// console.log(numberOfWaysToBuildHouseOfCards(/* edge case */)); // expected
```
...
- [Number of Ways to Build House of Cards — LeetCode](https://leetcode.com/problems/number-of-ways-to-build-house-of-cards) — problem page
