...
**Visual — Count Vowels Permutation example:**
...
Difficulty: Hard | Acceptance: 61.5%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-vowels-permutation) for full constraints
 ...
 */
function countVowelsPermutationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countVowelsPermutation(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countVowelsPermutation(/* example 1 */)); // expected
// console.log(countVowelsPermutation(/* example 2 */)); // expected
// console.log(countVowelsPermutation(/* edge case */)); // expected
```
...
- [Count Vowels Permutation — LeetCode](https://leetcode.com/problems/count-vowels-permutation) — problem page
