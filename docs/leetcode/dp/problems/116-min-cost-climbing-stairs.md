...
**Visual — Min Cost Climbing Stairs example:**
...
Difficulty: Easy | Acceptance: 67.2%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/min-cost-climbing-stairs) for full constraints
 ...
 */
function minCostClimbingStairsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minCostClimbingStairs(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minCostClimbingStairs(/* example 1 */)); // expected
// console.log(minCostClimbingStairs(/* example 2 */)); // expected
// console.log(minCostClimbingStairs(/* edge case */)); // expected
```
...
- [Min Cost Climbing Stairs — LeetCode](https://leetcode.com/problems/min-cost-climbing-stairs) — problem page
