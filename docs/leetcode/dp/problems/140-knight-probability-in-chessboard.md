...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/knight-probability-in-chessboard) for full constraints
 ...
 */
function knightProbabilityInChessboardBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function knightProbabilityInChessboard(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(knightProbabilityInChessboard(/* example 1 */)); // expected
// console.log(knightProbabilityInChessboard(/* example 2 */)); // expected
// console.log(knightProbabilityInChessboard(/* edge case */)); // expected
```
...
- [Knight Probability in Chessboard — LeetCode](https://leetcode.com/problems/knight-probability-in-chessboard) — problem page
