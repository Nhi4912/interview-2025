...
**Visual — Count Palindromic Subsequences example:**
...
Count Palindromic Subsequences. ([LeetCode](https://leetcode.com/problems/count-palindromic-subsequences))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/count-palindromic-subsequences) for full constraints
 ...
 */
function countPalindromicSubsequencesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function countPalindromicSubsequences(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(countPalindromicSubsequences(/* example 1 */)); // expected
// console.log(countPalindromicSubsequences(/* example 2 */)); // expected
// console.log(countPalindromicSubsequences(/* edge case */)); // expected
```
...
- [Count Palindromic Subsequences — LeetCode](https://leetcode.com/problems/count-palindromic-subsequences) — problem page
