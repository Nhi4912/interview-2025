...
**Visual — Minimum Number of Refueling Stops example:**
...
Difficulty: Hard | Acceptance: 40.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-number-of-refueling-stops) for full constraints
 ...
 */
function minimumNumberOfRefuelingStopsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumNumberOfRefuelingStops(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumNumberOfRefuelingStops(/* example 1 */)); // expected
// console.log(minimumNumberOfRefuelingStops(/* example 2 */)); // expected
// console.log(minimumNumberOfRefuelingStops(/* edge case */)); // expected
```
...
- [Minimum Number of Refueling Stops — LeetCode](https://leetcode.com/problems/minimum-number-of-refueling-stops) — problem page
