...
**Visual — Maximum Height by Stacking Cuboids example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-height-by-stacking-cuboids) for full constraints
 ...
 */
function maximumHeightByStackingCuboidsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumHeightByStackingCuboids(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumHeightByStackingCuboids(/* example 1 */)); // expected
// console.log(maximumHeightByStackingCuboids(/* example 2 */)); // expected
// console.log(maximumHeightByStackingCuboids(/* edge case */)); // expected
```
...
- [Maximum Height by Stacking Cuboids — LeetCode](https://leetcode.com/problems/maximum-height-by-stacking-cuboids) — problem page
