...
Number of Music Playlists. ([LeetCode](https://leetcode.com/problems/number-of-music-playlists))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-music-playlists) for full constraints
 ...
 */
function numberOfMusicPlaylistsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfMusicPlaylists(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfMusicPlaylists(/* example 1 */)); // expected
// console.log(numberOfMusicPlaylists(/* example 2 */)); // expected
// console.log(numberOfMusicPlaylists(/* edge case */)); // expected
```
...
- [Number of Music Playlists — LeetCode](https://leetcode.com/problems/number-of-music-playlists) — problem page
