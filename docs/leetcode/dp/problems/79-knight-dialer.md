...
Knight Dialer. ([LeetCode](https://leetcode.com/problems/knight-dialer))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/knight-dialer) for full constraints
 ...
 */
function knightDialerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function knightDialer(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(knightDialer(/* example 1 */)); // expected
// console.log(knightDialer(/* example 2 */)); // expected
// console.log(knightDialer(/* edge case */)); // expected
```
...
- [Knight Dialer — LeetCode](https://leetcode.com/problems/knight-dialer) — problem page
