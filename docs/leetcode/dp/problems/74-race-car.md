...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/race-car) for full constraints
 ...
 */
function raceCarBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function raceCar(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(raceCar(/* example 1 */)); // expected
// console.log(raceCar(/* example 2 */)); // expected
// console.log(raceCar(/* edge case */)); // expected
```
...
- [Race Car — LeetCode](https://leetcode.com/problems/race-car) — problem page
