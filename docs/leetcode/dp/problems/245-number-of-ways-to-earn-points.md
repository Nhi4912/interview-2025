...
Number of Ways to Earn Points. ([LeetCode](https://leetcode.com/problems/number-of-ways-to-earn-points))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/number-of-ways-to-earn-points) for full constraints
 ...
 */
function numberOfWaysToEarnPointsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function numberOfWaysToEarnPoints(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(numberOfWaysToEarnPoints(/* example 1 */)); // expected
// console.log(numberOfWaysToEarnPoints(/* example 2 */)); // expected
// console.log(numberOfWaysToEarnPoints(/* edge case */)); // expected
```
...
- [Number of Ways to Earn Points — LeetCode](https://leetcode.com/problems/number-of-ways-to-earn-points) — problem page
