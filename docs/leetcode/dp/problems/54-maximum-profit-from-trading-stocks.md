...
**Visual — Maximum Profit From Trading Stocks example:**
...
Maximum Profit From Trading Stocks. ([LeetCode](https://leetcode.com/problems/maximum-profit-from-trading-stocks))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-profit-from-trading-stocks) for full constraints
 ...
 */
function maximumProfitFromTradingStocksBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumProfitFromTradingStocks(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumProfitFromTradingStocks(/* example 1 */)); // expected
// console.log(maximumProfitFromTradingStocks(/* example 2 */)); // expected
// console.log(maximumProfitFromTradingStocks(/* edge case */)); // expected
```
...
- [Maximum Profit From Trading Stocks — LeetCode](https://leetcode.com/problems/maximum-profit-from-trading-stocks) — problem page
