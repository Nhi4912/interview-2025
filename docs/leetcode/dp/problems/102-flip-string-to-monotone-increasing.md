...
**Visual — Flip String to Monotone Increasing example:**
...
Flip String to Monotone Increasing. ([LeetCode](https://leetcode.com/problems/flip-string-to-monotone-increasing))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/flip-string-to-monotone-increasing) for full constraints
 ...
 */
function flipStringToMonotoneIncreasingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function flipStringToMonotoneIncreasing(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(flipStringToMonotoneIncreasing(/* example 1 */)); // expected
// console.log(flipStringToMonotoneIncreasing(/* example 2 */)); // expected
// console.log(flipStringToMonotoneIncreasing(/* edge case */)); // expected
```
...
- [Flip String to Monotone Increasing — LeetCode](https://leetcode.com/problems/flip-string-to-monotone-increasing) — problem page
