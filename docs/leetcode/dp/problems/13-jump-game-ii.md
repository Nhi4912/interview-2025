...
> **See also**: [Split Array Largest Sum](https://leetcode.com/problems/split-array-largest-sum) | [Non-overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/jump-game-ii) for full constraints
 ...
 */
function jumpGameIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function jumpGameIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(jumpGameIi(/* example 1 */)); // expected
// console.log(jumpGameIi(/* example 2 */)); // expected
// console.log(jumpGameIi(/* edge case */)); // expected
```
...
- [Jump Game II — LeetCode](https://leetcode.com/problems/jump-game-ii) — problem page
