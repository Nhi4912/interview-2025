...
**Visual — Cherry Pickup II example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/cherry-pickup-ii) for full constraints
 ...
 */
function cherryPickupIiBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function cherryPickupIi(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(cherryPickupIi(/* example 1 */)); // expected
// console.log(cherryPickupIi(/* example 2 */)); // expected
// console.log(cherryPickupIi(/* edge case */)); // expected
```
...
- [Cherry Pickup II — LeetCode](https://leetcode.com/problems/cherry-pickup-ii) — problem page
