...
**Visual — Find the Derangement of An Array example:**
...
Find the Derangement of An Array. ([LeetCode](https://leetcode.com/problems/find-the-derangement-of-an-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-derangement-of-an-array) for full constraints
 ...
 */
function findTheDerangementOfAnArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheDerangementOfAnArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheDerangementOfAnArray(/* example 1 */)); // expected
// console.log(findTheDerangementOfAnArray(/* example 2 */)); // expected
// console.log(findTheDerangementOfAnArray(/* edge case */)); // expected
```
...
- [Find the Derangement of An Array — LeetCode](https://leetcode.com/problems/find-the-derangement-of-an-array) — problem page
