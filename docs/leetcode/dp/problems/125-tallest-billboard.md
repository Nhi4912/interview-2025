...
**Visual — Tallest Billboard example:**
...
Tallest Billboard. ([LeetCode](https://leetcode.com/problems/tallest-billboard))

Difficulty: Hard | Acceptance: 51.9%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/tallest-billboard) for full constraints
 ...
 */
function tallestBillboardBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function tallestBillboard(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(tallestBillboard(/* example 1 */)); // expected
// console.log(tallestBillboard(/* example 2 */)); // expected
// console.log(tallestBillboard(/* edge case */)); // expected
```
...
- [Tallest Billboard — LeetCode](https://leetcode.com/problems/tallest-billboard) — problem page
