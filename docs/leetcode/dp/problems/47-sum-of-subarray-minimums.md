...
> **See also**: [Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle) | [Minimum Number of Visited Cells in a Grid](https://leetcode.com/problems/minimum-number-of-visited-cells-in-a-grid)
...
**Visual — Sum of Subarray Minimums example:**
...
Difficulty: Medium | Acceptance: 37.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/sum-of-subarray-minimums) for full constraints
 ...
 */
function sumOfSubarrayMinimumsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function sumOfSubarrayMinimums(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(sumOfSubarrayMinimums(/* example 1 */)); // expected
// console.log(sumOfSubarrayMinimums(/* example 2 */)); // expected
// console.log(sumOfSubarrayMinimums(/* edge case */)); // expected
```
...
- [Sum of Subarray Minimums — LeetCode](https://leetcode.com/problems/sum-of-subarray-minimums) — problem page
