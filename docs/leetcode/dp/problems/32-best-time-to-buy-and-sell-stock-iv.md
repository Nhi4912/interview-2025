...
**Visual — Best Time to Buy and Sell Stock IV example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv) for full constraints
 ...
 */
function bestTimeToBuyAndSellStockIvBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function bestTimeToBuyAndSellStockIv(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(bestTimeToBuyAndSellStockIv(/* example 1 */)); // expected
// console.log(bestTimeToBuyAndSellStockIv(/* example 2 */)); // expected
// console.log(bestTimeToBuyAndSellStockIv(/* edge case */)); // expected
```
...
- [Best Time to Buy and Sell Stock IV — LeetCode](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv) — problem page
