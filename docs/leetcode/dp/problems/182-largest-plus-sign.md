...
Largest Plus Sign. ([LeetCode](https://leetcode.com/problems/largest-plus-sign))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/largest-plus-sign) for full constraints
 ...
 */
function largestPlusSignBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function largestPlusSign(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(largestPlusSign(/* example 1 */)); // expected
// console.log(largestPlusSign(/* example 2 */)); // expected
// console.log(largestPlusSign(/* edge case */)); // expected
```
...
- [Largest Plus Sign — LeetCode](https://leetcode.com/problems/largest-plus-sign) — problem page
