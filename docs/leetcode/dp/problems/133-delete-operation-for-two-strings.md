...
**Visual — Delete Operation for Two Strings example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/delete-operation-for-two-strings) for full constraints
 ...
 */
function deleteOperationForTwoStringsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function deleteOperationForTwoStrings(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(deleteOperationForTwoStrings(/* example 1 */)); // expected
// console.log(deleteOperationForTwoStrings(/* example 2 */)); // expected
// console.log(deleteOperationForTwoStrings(/* edge case */)); // expected
```
...
- [Delete Operation for Two Strings — LeetCode](https://leetcode.com/problems/delete-operation-for-two-strings) — problem page
