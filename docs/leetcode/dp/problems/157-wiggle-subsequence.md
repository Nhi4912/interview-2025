...
**Visual — Wiggle Subsequence example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/wiggle-subsequence) for full constraints
 ...
 */
function wiggleSubsequenceBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function wiggleSubsequence(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(wiggleSubsequence(/* example 1 */)); // expected
// console.log(wiggleSubsequence(/* example 2 */)); // expected
// console.log(wiggleSubsequence(/* edge case */)); // expected
```
...
- [Wiggle Subsequence — LeetCode](https://leetcode.com/problems/wiggle-subsequence) — problem page
