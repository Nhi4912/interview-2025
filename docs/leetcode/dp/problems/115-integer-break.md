...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/integer-break) for full constraints
 ...
 */
function integerBreakBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function integerBreak(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(integerBreak(/* example 1 */)); // expected
// console.log(integerBreak(/* example 2 */)); // expected
// console.log(integerBreak(/* edge case */)); // expected
```
...
- [Integer Break — LeetCode](https://leetcode.com/problems/integer-break) — problem page
