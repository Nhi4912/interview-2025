...
**Visual — Video Stitching example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/video-stitching) for full constraints
 ...
 */
function videoStitchingBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function videoStitching(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(videoStitching(/* example 1 */)); // expected
// console.log(videoStitching(/* example 2 */)); // expected
// console.log(videoStitching(/* edge case */)); // expected
```
...
- [Video Stitching — LeetCode](https://leetcode.com/problems/video-stitching) — problem page
