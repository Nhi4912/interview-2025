...
Frog Jump. ([LeetCode](https://leetcode.com/problems/frog-jump))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/frog-jump) for full constraints
 ...
 */
function frogJumpBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function frogJump(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(frogJump(/* example 1 */)); // expected
// console.log(frogJump(/* example 2 */)); // expected
// console.log(frogJump(/* edge case */)); // expected
```
...
- [Frog Jump — LeetCode](https://leetcode.com/problems/frog-jump) — problem page
