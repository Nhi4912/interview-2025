...
**Visual — Maximum Score of Non-overlapping Intervals example:**
...
Maximum Score of Non-overlapping Intervals. ([LeetCode](https://leetcode.com/problems/maximum-score-of-non-overlapping-intervals))

Difficulty: Hard | Acceptance: 30.6%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-score-of-non-overlapping-intervals) for full constraints
 ...
 */
function maximumScoreOfNonOverlappingIntervalsBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumScoreOfNonOverlappingIntervals(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumScoreOfNonOverlappingIntervals(/* example 1 */)); // expected
// console.log(maximumScoreOfNonOverlappingIntervals(/* example 2 */)); // expected
// console.log(maximumScoreOfNonOverlappingIntervals(/* edge case */)); // expected
```
...
- [Maximum Score of Non-overlapping Intervals — LeetCode](https://leetcode.com/problems/maximum-score-of-non-overlapping-intervals) — problem page
