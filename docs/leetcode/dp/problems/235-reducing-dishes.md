...
**Visual — Reducing Dishes example:**
...
Reducing Dishes. ([LeetCode](https://leetcode.com/problems/reducing-dishes))

Difficulty: Hard | Acceptance: 76.3%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/reducing-dishes) for full constraints
 ...
 */
function reducingDishesBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function reducingDishes(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(reducingDishes(/* example 1 */)); // expected
// console.log(reducingDishes(/* example 2 */)); // expected
// console.log(reducingDishes(/* edge case */)); // expected
```
...
- [Reducing Dishes — LeetCode](https://leetcode.com/problems/reducing-dishes) — problem page
