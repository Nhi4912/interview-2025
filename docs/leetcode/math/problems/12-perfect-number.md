...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/perfect-number) for full constraints
 ...
 */
function perfectNumberBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function perfectNumber(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(perfectNumber(/* example 1 */)); // expected
// console.log(perfectNumber(/* example 2 */)); // expected
// console.log(perfectNumber(/* edge case */)); // expected
```
