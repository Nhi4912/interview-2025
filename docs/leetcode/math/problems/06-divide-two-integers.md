...
**Visual — Divide Two Integers example:**
...
Difficulty: Medium | Acceptance: 18.4%
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/divide-two-integers) for full constraints
 ...
 */
function divideTwoIntegersBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function divideTwoIntegers(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(divideTwoIntegers(/* example 1 */)); // expected
// console.log(divideTwoIntegers(/* example 2 */)); // expected
// console.log(divideTwoIntegers(/* edge case */)); // expected
```
...
- [Divide Two Integers — LeetCode](https://leetcode.com/problems/divide-two-integers) — problem page
