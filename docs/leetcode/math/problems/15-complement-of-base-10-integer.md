...
**Visual — Complement of Base 10 Integer example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/complement-of-base-10-integer) for full constraints
 ...
 */
function complementOfBase10IntegerBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function complementOfBase10Integer(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(complementOfBase10Integer(/* example 1 */)); // expected
// console.log(complementOfBase10Integer(/* example 2 */)); // expected
// console.log(complementOfBase10Integer(/* edge case */)); // expected
```
