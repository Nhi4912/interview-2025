...
# Apply Operations to Make Sum of Array Greater Than or Equal to k / Apply Operations to Make Sum of Array Greater Than or Equal to k
...
**Visual — Apply Operations to Make Sum of Array Greater Than or Equal to k example:**
...
Apply Operations to Make Sum of Array Greater Than or Equal to k. ([LeetCode](https://leetcode.com/problems/apply-operations-to-make-sum-of-array-greater-than-or-equal-to-k))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/apply-operations-to-make-sum-of-array-greater-than-or-equal-to-k) for full constraints
 ...
 */
function applyOperationsToMakeSumOfArrayGreaterThanOrEqualToKBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function applyOperationsToMakeSumOfArrayGreaterThanOrEqualToK(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(applyOperationsToMakeSumOfArrayGreaterThanOrEqualToK(/* example 1 */)); // expected
// console.log(applyOperationsToMakeSumOfArrayGreaterThanOrEqualToK(/* example 2 */)); // expected
// console.log(applyOperationsToMakeSumOfArrayGreaterThanOrEqualToK(/* edge case */)); // expected
```
...
- [Apply Operations to Make Sum of Array Greater Than or Equal to k — LeetCode](https://leetcode.com/problems/apply-operations-to-make-sum-of-array-greater-than-or-equal-to-k) — problem page
