...
category: Math
tags: [Math, Greedy]
leetcode_url: "https://leetcode.com/problems/find-the-minimum-possible-sum-of-a-beautiful-array"
---

# Find the Minimum Possible Sum of a Beautiful Array / Find the Minimum Possible Sum of a Beautiful Array
...
**Visual — Find the Minimum Possible Sum of a Beautiful Array example:**
...
Find the Minimum Possible Sum of a Beautiful Array. ([LeetCode](https://leetcode.com/problems/find-the-minimum-possible-sum-of-a-beautiful-array))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/find-the-minimum-possible-sum-of-a-beautiful-array) for full constraints
 ...
 */
function findTheMinimumPossibleSumOfABeautifulArrayBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function findTheMinimumPossibleSumOfABeautifulArray(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(findTheMinimumPossibleSumOfABeautifulArray(/* example 1 */)); // expected
// console.log(findTheMinimumPossibleSumOfABeautifulArray(/* example 2 */)); // expected
// console.log(findTheMinimumPossibleSumOfABeautifulArray(/* edge case */)); // expected
```
...
- [Find the Minimum Possible Sum of a Beautiful Array — LeetCode](https://leetcode.com/problems/find-the-minimum-possible-sum-of-a-beautiful-array) — problem page
