...
**Visual — Maximum Number of Balls in a Box example:**
...
Maximum Number of Balls in a Box. ([LeetCode](https://leetcode.com/problems/maximum-number-of-balls-in-a-box))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-number-of-balls-in-a-box) for full constraints
 ...
 */
function maximumNumberOfBallsInABoxBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumNumberOfBallsInABox(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumNumberOfBallsInABox(/* example 1 */)); // expected
// console.log(maximumNumberOfBallsInABox(/* example 2 */)); // expected
// console.log(maximumNumberOfBallsInABox(/* edge case */)); // expected
```
