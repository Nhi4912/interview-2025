...
**Visual — Broken Calculator example:**
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/broken-calculator) for full constraints
 ...
 */
function brokenCalculatorBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function brokenCalculator(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(brokenCalculator(/* example 1 */)); // expected
// console.log(brokenCalculator(/* example 2 */)); // expected
// console.log(brokenCalculator(/* edge case */)); // expected
```
...
- [Broken Calculator — LeetCode](https://leetcode.com/problems/broken-calculator) — problem page
