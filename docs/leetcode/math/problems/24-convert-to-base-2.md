...
**Visual — Convert to Base -2 example:**
...
Convert to Base -2. ([LeetCode](https://leetcode.com/problems/convert-to-base-2))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/convert-to-base-2) for full constraints
 ...
 */
function convertToBase2BruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function convertToBase2(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(convertToBase2(/* example 1 */)); // expected
// console.log(convertToBase2(/* example 2 */)); // expected
// console.log(convertToBase2(/* edge case */)); // expected
```
...
- [Convert to Base -2 — LeetCode](https://leetcode.com/problems/convert-to-base-2) — problem page
