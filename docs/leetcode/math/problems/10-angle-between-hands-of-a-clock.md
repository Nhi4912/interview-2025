...
**Visual — Angle Between Hands of a Clock example:**
...
Angle Between Hands of a Clock. ([LeetCode](https://leetcode.com/problems/angle-between-hands-of-a-clock))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/angle-between-hands-of-a-clock) for full constraints
 ...
 */
function angleBetweenHandsOfAClockBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function angleBetweenHandsOfAClock(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(angleBetweenHandsOfAClock(/* example 1 */)); // expected
// console.log(angleBetweenHandsOfAClock(/* example 2 */)); // expected
// console.log(angleBetweenHandsOfAClock(/* edge case */)); // expected
```
