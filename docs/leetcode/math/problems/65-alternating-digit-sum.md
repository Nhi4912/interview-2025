...
# Alternating Digit Sum / Alternating Digit Sum
...
**Visual — Alternating Digit Sum example:**
...
Alternating Digit Sum. ([LeetCode](https://leetcode.com/problems/alternating-digit-sum))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/alternating-digit-sum) for full constraints
 ...
 */
function alternatingDigitSumBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function alternatingDigitSum(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(alternatingDigitSum(/* example 1 */)); // expected
// console.log(alternatingDigitSum(/* example 2 */)); // expected
// console.log(alternatingDigitSum(/* edge case */)); // expected
```
...
- [Alternating Digit Sum — LeetCode](https://leetcode.com/problems/alternating-digit-sum) — problem page
