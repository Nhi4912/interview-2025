...
**Visual — Minimum Moves to Reach Target Score example:**
...
Minimum Moves to Reach Target Score. ([LeetCode](https://leetcode.com/problems/minimum-moves-to-reach-target-score))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-moves-to-reach-target-score) for full constraints
 ...
 */
function minimumMovesToReachTargetScoreBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumMovesToReachTargetScore(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumMovesToReachTargetScore(/* example 1 */)); // expected
// console.log(minimumMovesToReachTargetScore(/* example 2 */)); // expected
// console.log(minimumMovesToReachTargetScore(/* edge case */)); // expected
```
...
- [Minimum Moves to Reach Target Score — LeetCode](https://leetcode.com/problems/minimum-moves-to-reach-target-score) — problem page
