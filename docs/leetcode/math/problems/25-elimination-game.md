...
> **See also**: [Pow(x, n)](https://leetcode.com/problems/powx-n) | [Integer to English Words](https://leetcode.com/problems/integer-to-english-words)
...
**Visual — Elimination Game example:**
...
Elimination Game. ([LeetCode](https://leetcode.com/problems/elimination-game))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/elimination-game) for full constraints
 ...
 */
function eliminationGameBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function eliminationGame(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(eliminationGame(/* example 1 */)); // expected
// console.log(eliminationGame(/* example 2 */)); // expected
// console.log(eliminationGame(/* edge case */)); // expected
```
...
- [Elimination Game — LeetCode](https://leetcode.com/problems/elimination-game) — problem page
