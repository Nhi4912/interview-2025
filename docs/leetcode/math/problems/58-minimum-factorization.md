...
**Visual — Minimum Factorization example:**
...
Minimum Factorization. ([LeetCode](https://leetcode.com/problems/minimum-factorization))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/minimum-factorization) for full constraints
 ...
 */
function minimumFactorizationBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function minimumFactorization(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(minimumFactorization(/* example 1 */)); // expected
// console.log(minimumFactorization(/* example 2 */)); // expected
// console.log(minimumFactorization(/* edge case */)); // expected
```
...
- [Minimum Factorization — LeetCode](https://leetcode.com/problems/minimum-factorization) — problem page
