...
> **See also**: [Power of Two](https://leetcode.com/problems/power-of-two) | [Pow(x, n)](https://leetcode.com/problems/powx-n)
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/power-of-four) for full constraints
 ...
 */
function powerOfFourBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function powerOfFour(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(powerOfFour(/* example 1 */)); // expected
// console.log(powerOfFour(/* example 2 */)); // expected
// console.log(powerOfFour(/* edge case */)); // expected
```
