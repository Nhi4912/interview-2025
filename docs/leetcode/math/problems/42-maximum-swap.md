...
Maximum Swap. ([LeetCode](https://leetcode.com/problems/maximum-swap))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/maximum-swap) for full constraints
 ...
 */
function maximumSwapBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function maximumSwap(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(maximumSwap(/* example 1 */)); // expected
// console.log(maximumSwap(/* example 2 */)); // expected
// console.log(maximumSwap(/* edge case */)); // expected
```
...
- [Maximum Swap — LeetCode](https://leetcode.com/problems/maximum-swap) — problem page
