...
Valid Square. ([LeetCode](https://leetcode.com/problems/valid-square))
...
Constraints:
- See [LeetCode problem page](https://leetcode.com/problems/valid-square) for full constraints
 ...
 */
function validSquareBruteForce(/* TODO: params */): unknown {
 ...
 * Space: O(?) — TODO: analyze
 */
function validSquare(/* TODO: params */): unknown {
...
// === Test Cases ===
// console.log(validSquare(/* example 1 */)); // expected
// console.log(validSquare(/* example 2 */)); // expected
// console.log(validSquare(/* edge case */)); // expected
```
...
- [Valid Square — LeetCode](https://leetcode.com/problems/valid-square) — problem page
