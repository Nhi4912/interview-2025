...
title:
  en: "TypeScript Basics / Cơ Bản TypeScript"
  vi: "Kiến thức cơ bản TypeScript / Cơ Bản TypeScript"
description:
  en: "Master TypeScript Basics / Cơ Bản TypeScript in TypeScript, including type system, best practices, and interview preparation."
  vi: "Làm chủ TypeScript Basics / Cơ Bản TypeScript trong TypeScript, bao gồm hệ thống kiểu, best practices và chuẩn bị phỏng vấn."
category: typescript
difficulty: beginner
estimatedTime: 50
...
lastUpdated: "2025-11-15T09:52:26.525Z"
version: "1.0.0"
hasQuiz: true
