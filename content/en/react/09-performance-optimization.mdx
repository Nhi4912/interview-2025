...
title:
  en: "React Performance Optimization"
  vi: "React Tối ưu hiệu suất Optimization"
description:
  en: "Master React Performance Optimization in React, including core concepts, best practices, and interview preparation."
  vi: "Làm chủ React Performance Optimization trong React, bao gồm các khái niệm cốt lõi, best practices và chuẩn bị phỏng vấn."
category: react
difficulty: advanced
estimatedTime: 75
...
lastUpdated: "2025-11-13T04:58:29.602Z"
version: "1.0.0"
hasQuiz: true
...
[← Previous: React Patterns Advanced](./08-react-patterns-advanced.md) | 
