...
relatedTopics: ["js-execution-context", "js-memory-management"]
...
<Diagram type="mermaid" title="Scope Chain Visualization">
  ```mermaid graph LR A[inner scope] --> B[middle scope] B --> C[outer scope] C
  --> D[global scope] style A fill:#e1f5ff style B fill:#b3e5fc style C
  fill:#81d4fa style D fill:#4fc3f7 ```
</Diagram>
...
<Quiz id="closures-quiz" />

## Related Topics

- [Scope and Hoisting](./02-scope-hoisting.mdx)
- [Execution Context](../advanced/execution-context.mdx)
- [Memory Management](../advanced/memory-management.mdx)
- [Prototypes and Inheritance](./04-prototypes-inheritance.mdx)
